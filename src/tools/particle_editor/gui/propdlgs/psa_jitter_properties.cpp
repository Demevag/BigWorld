...
void PsaJitterProperties::OnInitialUpdate()
{
    ...
    positionGeneratorCustodian_.setVectorGeneratorSetFn(
      &JitterPSA::setPositionSource);
    positionGeneratorCustodian_.setVectorGeneratorGetFn(
      &JitterPSA::getPositionSource);
    ...
    velocityGeneratorCustodian_.setVectorGeneratorSetFn(
      &JitterPSA::setVelocitySource);
    velocityGeneratorCustodian_.setVectorGeneratorGetFn(
      &JitterPSA::getVelocitySource);
...
ON_BN_CLICKED(IDC_PSA_JITTER_AFFECT_POSITION,
              OnBnClickedPsaJitterAffectPosition)
ON_BN_CLICKED(IDC_PSA_JITTER_AFFECT_VELOCITY,
              OnBnClickedPsaJitterAffectVelocity)
