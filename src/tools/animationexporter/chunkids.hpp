/*
 * These are the chunk id's in the mfx format, all chunks ids are followed by a
 * total size which includes size of the chunk and any sub chunks and is then
 * followed by a size of the chunk, or that is the plan atleast, chunks are
 * good...
 *
 */
