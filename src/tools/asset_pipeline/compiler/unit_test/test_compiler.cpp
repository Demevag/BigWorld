...
{
    return testCompiler.setSourceFileDirectory(
             "tools/asset_pipeline/resources/testfiles/testconverter/") &&
           testCompiler.setOutputFileDirectory(
             "tools/asset_pipeline/resources/testfiles/testconverter/");
}
...
TEST(compiler_test_root_conversion_rule)
{
    ...
    CHECK(testCompiler.testConversionRule(
      "000.testrootasset", "000.testcompiledasset", "TestConverter", ""));
...
TEST(compiler_test_conversion_rule)
{
    ...
    CHECK(testCompiler.testConversionRule(
      "000.testasset", "000.testcompiledasset", "TestConverter", ""));
    CHECK(unloadPlugin(testCompiler));
}
