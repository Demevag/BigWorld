...
const uint64 EffectConverter::s_TypeId =
  Hash64::compute(EffectConverter::getTypeName());
                                         ...
                                         DependencyList&   dependencies)
{
    ...
    for (BW::list<BW::string>::iterator it = includes.begin();
         it != includes.end();
         ++it) {
                              ...
                              BW::vector<BW::string>& outputFiles)
{
    ...
    for (Moo::EffectMacroSetting::MacroSettingVector::iterator it =
           settings.begin();
         it != settings.end();
         ++it) {
