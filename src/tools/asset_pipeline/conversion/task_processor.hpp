...
class TaskProcessor
{
  public:
    ...
    void forceRebuild(bool forceRebuild = true)
    {
  ...
  private:
    ...
    bool retrievePrimaryDependencyListFromCache(
      DependencyContext& dependencyContext,
      ConversionContext& conversionContext);
    ...
    bool checkSecondaryDependenciesUpToDate(
      DependencyContext& dependencyContext);

    bool retrieveSecondaryDependencyListFromCache(
      DependencyContext& dependencyContext,
      ConversionContext& conversionContext);
    ...
    /// Spawn multiple threads to process all conversion tasks in the compilers
    /// queue.
