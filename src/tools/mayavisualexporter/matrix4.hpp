...
class matrix4
{
  public:
    ...
    struct Row
    {
        inline Row(T& v1, T& v2, T& v3, T& v4)
          : v1(v1)
          , v2(v2)
          , v3(v3)
          , v4(v4)
    ...
    inline matrix4(const vector3<T>& a1,
                   const vector3<T>& a2,
                   const vector3<T>& a3);
    ...
    static inline matrix4<T> translation(const T& aTranslateX,
                                         const T& aTranslateY,
                                         const T& aTranslateZ);
    static inline matrix4<T> translation(const vector3<T>& aVector);
    static inline matrix4<T> scaling(const T& aScaleX,
                                     const T& aScaleY,
                                     const T& aScaleZ);
