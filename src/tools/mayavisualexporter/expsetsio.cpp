...
bool ExportSettings::readSettings(const DataSectionPtr& pRoot)
{
    ...
    disableVisualChecker_ =
      pRoot->readBool("disableVisualChecker", disableVisualChecker_);
    ...
    useLegacyOrientation_ =
      pRoot->readBool("useLegacyOrientation", useLegacyOrientation_);
    sceneRootAdded_ = pRoot->readBool("sceneRootAdded", sceneRootAdded_);

    includeMeshes_ = pRoot->readBool("includeMeshes", includeMeshes_);
    includeEnvelopesAndBones_ =
      pRoot->readBool("includeEnvelopesAndBones", includeEnvelopesAndBones_);
    ...
    includeAnimations_ =
      pRoot->readBool("includeAnimations", includeAnimations_);
    ...
    copyExternalTextures_ =
      pRoot->readBool("copyExternalTextures", copyExternalTextures_);
