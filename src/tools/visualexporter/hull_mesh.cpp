...
void HullMesh::save(DataSectionPtr pSection)
{
...
#ifdef _UNICODE
        ::MessageBox(0,
                     L"Unable to create custom hull.  Custom hull most contain "
                     L"at least four "
...
#else
        ::MessageBox(0,
                     "Unable to create custom hull.  Custom hull most contain "
                     "at least four "
    ...
    if (portalsAdded != 0)
        ...
        ::MessageBox(
          0,
          L"One or more portals defined using hull materials will not be "
          L"exported.\n"
                          ...
                          BW::vector<TriIndex>& faces) const
{
    ...
    if (isConcave) {
        if (LogMsg::automatedTest()) {
            LogMsg::logToFile(
              "WARNING: The custom hull is concave "
