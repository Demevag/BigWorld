...
namespace OfflineProcessor {
    ...
    /**
     * Specialised verion of offline processor command with batch processing
     * support Batch processing means a possiblity to pass directory path
     * instead of file path and possibly use -recusive option
     *
    ...
    class BatchCommand : public Command
    {
      ...
      protected:
        ...
        int processFiles(const BW::string& fileName,
