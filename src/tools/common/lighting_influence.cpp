 ...
 */
void LightingInfluence::visitChunks(
  Chunk*           srcChunk,
  ...
  uint32           currentDepth /* = 0*/)
{
    ...
    for (Chunk::piterator pit = srcChunk->pbegin(); pit != srcChunk->pend();
        ...
        // TODO: Check that we can actually see the portal. Only really of value
        // if we get lights going across > 2 chunks.

        visitChunks(pit->pChunk, pVisitor, searchedChunks, currentDepth + 1);
    }
}
