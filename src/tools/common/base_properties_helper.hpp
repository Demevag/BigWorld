 ...
 *  property is an array, a PropertyItem corresponding to an element in the
 * array will contain 2 indices: one is the index of the property and the other
 * is the sub-index of the array item in the array.
 */
class PropertyIndex
{
  public:
