...
/******************************************************************************
    ...
    The relation between name and value is 1:1, i.e. no 2 names will have same
values This is because we will save the result as value and look them up in the
name table when loaded again
******************************************************************************/
