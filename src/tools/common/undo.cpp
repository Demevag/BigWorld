...
//---------------------------------------------------------------------------
bool Undo::addUndoData(unsigned int id,
                       unsigned int opCode,
...
//---------------------------------------------------------------------------
bool Undo::addRedoData(unsigned int id,
                       unsigned int opCode,
                       AnsiString   description,
                       UndoData     data,
                       size_t       size,
...
//---------------------------------------------------------------------------
bool Undo::addData(unsigned int id,
                   unsigned int opCode,
                   AnsiString   description,
                   UndoData     data,
                   size_t       size,
                   ...
                   bool         linkToLast)
{
    ...
    if (undoEnabled_) {
        ...
        if (lastRedo == redo && redoEnabled_) {
            ...
            // the undo stack is always either equal or 1 greater than the redo
            // stack
            if (redo && redoList_.size() == undoList_.size()) {
                // the matching undo data for this redo is missing so ignore the
                // data
