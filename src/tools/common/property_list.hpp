...
class PropertyItem
{
  public:
    ...
    virtual bool hasSameValue(PropertyItem* item)
    {
    ...
    virtual const Name& exposedToScriptName() const
    {
        return exposedToScriptName_;
    }
    virtual void exposedToScriptName(const Name& name)
    {
        exposedToScriptName_ = name;
    }

    virtual void canExposeToScript(bool canExposeToScript)
    {
    ...
    void arrayData(int                  arrayIndex,
                   BWBaseFunctor1<int>* arrayCallback,
                   bool                 arrayReadOnly)
    {
...
{
  public:
    ColourPropertyItem(const Name&    name,
                       const CString& init,
                       int            depth,
                       bool           colour = true);
    ...
    {
        return colour_ ? Type_Colour : Type_Vector;
    }
...
{
  public:
    StringPropertyItem(const Name&    name,
    ...
    virtual ItemType getType() const;
    bool             isHexColor() const
    {
        return stringValue_.GetLength() == 7 && stringValue_[0] == '#';
    }
    bool isVectColor() const
    {
        BW::wstring val = stringValue_;
...
{
  public:
    ComboPropertyItem(const Name&                    name,
...
{
  public:
    ArrayPropertyItem(const Name&    name,
                      const Name&    group,
                      const CString& str,
                      ArrayProxyPtr  proxy);
...
class PropertyList : public CListBox
{
  public:
    ...
    void collapseGroup(GroupPropertyItem* gItem,
                       int                index,
                       bool               reselect = true);
    ...
    void          selectedItem(PropertyItem* newSelectedItem)
    {
