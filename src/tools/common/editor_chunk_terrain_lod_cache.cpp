...
bool EditorChunkTerrainLodCache::readyToCalculate(
...
bool EditorChunkTerrainLodCache::loadChunkForCalculate(
  ChunkProcessorManager* manager)
{
    BW_GUARD;
...
bool EditorChunkTerrainLodCache::recalc(ChunkProcessorManager* mgr,
...
ChunkCache::Instance<EditorChunkTerrainLodCache>
  EditorChunkTerrainLodCache::instance;
