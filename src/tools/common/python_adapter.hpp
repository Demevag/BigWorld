...
class PythonAdapter
{
  public:
    ...
    void onListSelectUpdate(CListBox* listBox, const BW::string& listBoxName);

    void onListItemToggleState(const BW::string& name,
                               unsigned int      index,
                               bool              state);
