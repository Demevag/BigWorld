...
class MaterialUtility
{
  public:
    ...
    static int listTechniques(Moo::EffectMaterialPtr  m,
                              BW::vector<BW::string>& retVector);

    static bool MaterialUtility::isTechniqueValid(Moo::EffectMaterialPtr m,
                                                  int                    index);

    static bool MaterialUtility::viewTechnique(Moo::EffectMaterialPtr m,
                                               int                    index);

    static bool MaterialUtility::viewTechnique(Moo::EffectMaterialPtr m,
                                               const BW::string&      name);

    static int MaterialUtility::techniqueByName(Moo::EffectMaterialPtr material,
                                                const BW::string&      name);
    ...
    static int listProperties(Moo::EffectMaterialPtr  m,
                              BW::vector<BW::string>& retVector);
     ...
     */
    static void save(Moo::EffectMaterialPtr m, DataSectionPtr pSection);
};
