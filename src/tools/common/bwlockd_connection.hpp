...
namespace BWLock {
    ...
    {
        return r1.left_ == r2.left_ && r1.top_ == r2.top_ &&
               r1.right_ == r2.right_ && r1.bottom_ == r2.bottom_;
    }
    ...
    class BWLockDConnection
    {
      public:
        ...
        bool init(const BW::string& hoststr,
        ...
        BW::vector<unsigned char> getLockData(int          minX,
                                              int          minY,
