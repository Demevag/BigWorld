...
class Undo
{
  private:
    ...
    bool
      inProgress_; // flag: user flag that is set when they are do an operation
  ...
  public:
    ...
    // add undo/redo data
    bool addUndoData(unsigned int id,
                     unsigned int opCode,
                     AnsiString   description,
                     UndoData     data,
                     size_t       size,
                     bool         linkToLast = false);
    bool addRedoData(unsigned int id,
                     unsigned int opCode,
                     AnsiString   description,
                     UndoData     data,
                     size_t       size,
                     bool         linkToLast = false);
    // bool			addData( unsigned int id, unsigned int opCode, AnsiString
    // description, UndoData data );
