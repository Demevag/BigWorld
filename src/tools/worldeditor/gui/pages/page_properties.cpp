...
afx_msg LRESULT PageProperties::OnUpdateControls(WPARAM wParam, LPARAM lParam)
{
    ...
    if (!inited_) {
        ...
        Utilities::stretchToBottomRight(
          this, *propertyList(), rect.right, 12, rect.bottom, 12);
...
afx_msg LRESULT PageProperties::OnSelectPropertyItem(WPARAM wParam,
                                                     LPARAM lParam)
{
    BW_GUARD;
...
afx_msg LRESULT PageProperties::OnChangePropertyItem(WPARAM wParam,
                                                     LPARAM lParam)
{
    BW_GUARD;
...
afx_msg LRESULT PageProperties::OnDblClkPropertyItem(WPARAM wParam,
                                                     LPARAM lParam)
{
    BW_GUARD;
