  ...
  , public GUITABS::Content
{
  ...
  public:
    ...
    void currentTexture(const BW::string& filename,
                        const BW::string& bumpFileName,
                        bool              resetProjectionParams = true);
    void currentTexture(const BW::string& filename,
                        const BW::string& bumpFileName,
                        const Vector4&    u,
                        const Vector4&    v,
    ...
    void layersAtPoint(const Vector3&                 point,
                       TerrainTextureUtils::LayerVec& layers);
    bool canEditProjections() const;
    bool editTextureLayer(const TerrainTextureUtils::LayerInfo& info,
    ...
    void selectTextureMaskAtPoint(Vector3 const& point,
                                  size_t         idx,
                                  bool           includeProj,
                                  bool           includeBump);
    void selectTextureMask(const BW::string& texture,
  ...
  protected:
    ...
    void onSampleTexture(bool   mouseUp,
    ...
    bool dominantTexture(size_t*              pIdx,
                         EditorChunkTerrain** pChunkTerrain,
                         Chunk**              pChunk) const;

    size_t replaceDominantTexture();

    void setTextureMaskTexture(const BW::string& textureFile,
    ...
    static Matrix buildMatrix(const Vector4& u, const Vector4& v);
  ...
  private:
    ...
    bool inited_;
    Matrix
      invTexProjection_; // inverse texture projection, translation is gizmo pos
