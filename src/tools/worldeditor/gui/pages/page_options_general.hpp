...
class PageOptionsGeneral
  : public GraphicsSettingsTable
  , public GUITABS::Content
{
    IMPLEMENT_BASIC_CONTENT(
      Localise(L"WORLDEDITOR/GUI/PAGE_OPTIONS_GENERAL/SHORT_NAME"),
      Localise(L"WORLDEDITOR/GUI/PAGE_OPTIONS_GENERAL/LONG_NAME"),
      267,
      405,
      NULL)
