...
/*virtual*/ BOOL PageChunkWatcher::OnInitDialog()
{
    ...
    sizer->addChild(
      new controls::WndSizer(&chunkWatchCtrl_), 1, controls::RowSizer::WEIGHT);
    // Options group:
    ...
    groupSizer1->setChild(
      1, 1, new controls::WndSizer(this, IDC_UNLOADABLE_CB));
    groupSizer1->setChild(
      0, 2, new controls::WndSizer(this, IDC_PROJECTVIEW_CB));
    ...
    setDisplayOption(
      IDC_CHUNKS_CB, CHUNKS_OPTIONS_STR, ChunkWatchControl::DRAW_CHUNKS);
    setDisplayOption(
      IDC_FRUSTUM_CB, FRUSTUM_OPTIONS_STR, ChunkWatchControl::DRAW_FRUSTUM);
    setDisplayOption(
      IDC_GRID_CB, GRID_OPTIONS_STR, ChunkWatchControl::DRAW_GRID);
    setDisplayOption(IDC_UNLOADABLE_CB,
                     UNLOADABLE_OPTIONS_STR,
                     ChunkWatchControl::DRAW_UNLOADABLE);
    setDisplayOption(IDC_PROJECTVIEW_CB,
 ...
 */
/*afx_msg*/ LRESULT
PageChunkWatcher::OnNewSpace(WPARAM /*wparam*/, LPARAM /*lparam*/
)
{
    BW_GUARD;
    ...
    if (mapping != NULL) {
        chunkWatchCtrl_.onNewSpace(mapping->pSpace()->gridSize(),
                                   mapping->minLGridX(),
                                   mapping->minLGridY(),
                                   mapping->maxLGridX() + 1,
                                   mapping->maxLGridY() + 1);
 ...
 */
/*afx_msg*/ LRESULT
PageChunkWatcher::OnChangedChunk(WPARAM wparam, LPARAM lparam)
{
    BW_GUARD;
...
/**
 *	This is called when a chunk is being worked on by WorldEditor for saving or
 ...
 *	@return			0.  Not used.  Here to match a function definition.
 */
/*afx_msg*/ LRESULT PageChunkWatcher::OnNewWorkingChunk(WPARAM /*wparam*/,
                                                        LPARAM /*lparam*/)
{
    BW_GUARD;
 ...
 */
/*afx_msg*/ LRESULT
PageChunkWatcher::OnUpdateControls(WPARAM /*wparam*/, LPARAM /*lparam*/
)
{
    BW_GUARD;
...
void PageChunkWatcher::OnUpdateOptions()
{
    ...
    getDisplayOption(
      IDC_GRID_CB, GRID_OPTIONS_STR, ChunkWatchControl::DRAW_GRID);
    getDisplayOption(IDC_UNLOADABLE_CB,
                     UNLOADABLE_OPTIONS_STR,
                     ChunkWatchControl::DRAW_UNLOADABLE);
    getDisplayOption(IDC_PROJECTVIEW_CB,
                     PROJECTVIEW_OPTIONS_STR,
                     ChunkWatchControl::DRAW_PROJECTVIEW);
    chunkWatchCtrl_.RedrawWindow();
}
 ...
 */
/*afx_msg*/ LRESULT
PageChunkWatcher::OnMouseMoveChunkWatchControl(WPARAM /*wparam*/,
                                               LPARAM /*lparam*/
)
{
    BW_GUARD;
    ...
    BW::string mouseText =
      LocaliseUTF8(L"WORLDEDITOR/GUI/PAGE_CHUNK_WATCHER/POSITION");
    BW::string chunkText =
      LocaliseUTF8(L"WORLDEDITOR/GUI/PAGE_CHUNK_WATCHER/CHUNK");
    BW::string mouseInfo;
    BW::string chunkInfo;
    CPoint     point;
    ::GetCursorPos(&point);
 ...
 *						option.
 */
void PageChunkWatcher::setDisplayOption(UINT              id,
 ...
 *						option.
 */
void PageChunkWatcher::getDisplayOption(UINT              id,
                                        BW::string const& optionText,
                                        uint32            value)
{
    BW_GUARD;
