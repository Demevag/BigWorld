...
class PageTerrainFilter
  : public PageTerrainBase
  , public GUITABS::Content
{
    IMPLEMENT_BASIC_CONTENT(
      Localise(L"WORLDEDITOR/GUI/PAGE_TERRAIN_FILTER/SHORT_NAME"),
      Localise(L"WORLDEDITOR/GUI/PAGE_TERRAIN_FILTER/LONG_NAME"),
      290,
      280,
      NULL)
