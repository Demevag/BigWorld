...
class PageChunkTexture
  : public CFormView
  , public GUITABS::Content
{
    IMPLEMENT_BASIC_CONTENT(
      Localise(L"WORLDEDITOR/GUI/PAGE_CHUNK_TEXTURE/SHORT_NAME"),
      Localise(L"WORLDEDITOR/GUI/PAGE_CHUNK_TEXTURE/LONG_NAME"),
      290,
      460,
      NULL)
