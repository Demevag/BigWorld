 ...
 */
StationLinkOperation::StationLinkOperation(EditorChunkStationNodePtr a,
...
/*virtual*/ void StationLinkOperation::undo()
{
    ...
    UndoRedo::instance().add(
      new StationLinkOperation(a_, b_, a_->getLinkDirection(&*b_)));
  ...
  const UndoRedo::Operation& oth) const
{
    ...
    return o.idA == idA && o.idB == idB && o.idGraphA == idGraphA &&
           o.idGraphB == idGraphB;
}
