...
class LinkerUndoChangeLinkOperation : public UndoRedo::Operation
{
  ...
  private:
    ...
    LinkerUndoChangeLinkOperation& operator=(
      LinkerUndoChangeLinkOperation const&);
...
class LinkerUndoDeleteLinkOperation : public UndoRedo::Operation
{
  ...
  private:
    ...
    LinkerUndoDeleteLinkOperation& operator=(
      LinkerUndoDeleteLinkOperation const&);
...
{
  public:
    explicit LinkerUpdateLinkOperation(const EditorChunkItemLinkable* startEcil,
                                       BW::string                     targetUID,
