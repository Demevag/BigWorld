...
/*static*/ void OptionsGameObjects::tick()
{
    ...
    s_entitiesVisible_ = s_visible_ && !!Options::getOptionInt(
                                         "render/gameObjects/drawEntities", 1);
    s_udosVisible_ =
      s_visible_ &&
...
/*static*/ void OptionsLightProxies::tick()
{
    ...
    s_dynamicVisible_ =
      !!Options::getOptionInt("render/proxys/dynamicLightProxys", 1);
    s_dynamicLargeVisible_ =
      !!Options::getOptionInt("render/proxys/dynamicLightProxyLarge", 1);
    s_ambientVisible_ =
      !!Options::getOptionInt("render/proxys/ambientLightProxys", 1);
    s_ambientLargeVisible_ =
      !!Options::getOptionInt("render/proxys/ambientLightProxyLarge", 1);
    s_pulseVisible_ =
      !!Options::getOptionInt("render/proxys/pulseLightProxys", 1);
    s_pulseLargeVisible_ =
      !!Options::getOptionInt("render/proxys/pulseLightProxyLarge", 1);
    s_flareVisible_ = !!Options::getOptionInt("render/proxys/flareProxys", 1);
    s_flareLargeVisible_ =
      !!Options::getOptionInt("render/proxys/flareProxyLarge", 1);
    s_spotVisible_ =
      !!Options::getOptionInt("render/proxys/spotLightProxys", 1);
    s_spotLargeVisible_ =
      !!Options::getOptionInt("render/proxys/spotLightProxyLarge", 1);
}
...
/*static*/ void OptionsParticleProxies::tick()
{
    ...
    s_particlesLargeVisible_ =
      !!Options::getOptionInt("render/proxys/particleProxyLarge", 1);
}
...
/*static*/ void OptionsMisc::tick()
{
    ...
    s_frozenVisible_ =
      !!Options::getOptionInt("render/misc/shadeFrozenObjects", 1);
...
/*static*/ void OptionsTerrain::tick()
{
    ...
    s_numLayersWarning_ =
      Options::getOptionInt("chunkTexture/numLayerWarning", 0);
    s_numLayersWarningVisible_ =
      !!Options::getOptionInt("chunkTexture/numLayerWarningShow", 0);
    s_terrainOverlayMode_ =
      Options::getOptionInt("render/terrain/terrainOverlayMode", 0);
    s_lodLocksOverlayVisible_ =
      Options::getOptionInt("render/terrain/LODLocks", 0) == 1;
}
...
/*static*/ void OptionsScenery::tick()
{
    ...
    s_shellsVisible_ =
      s_visible_ && !!Options::getOptionInt("render/scenery/shells", 1);
    s_waterVisible_ =
      s_visible_ && !!Options::getOptionInt("render/scenery/drawWater", 1);
    s_particlesVisible_ =
      s_visible_ && !!Options::getOptionInt("render/scenery/particle", 1);
    s_flaresVisible_ =
      s_visible_ &&
