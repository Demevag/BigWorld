...
void SingleTaskProgressBar::startProgress(const BW::string& sMsg,
                                          float             steps,
                                          bool              escapable)
{
    BW_GUARD;
...
void SingleTaskProgressBar::createTask(const BW::string& sMsg,
                                       float             steps,
                                       bool              escapable)
{
    BW_GUARD;
...
void MultiTaskProgressBar::startProgress(const BW::string& sMsg,
                                         float             steps,
                                         bool              escapable)
{
    if (!inited_ && progressDlg_ == NULL) {
...
ProgressBarTask::ProgressBarTask(const BW::string& sMsg,
                                 float             steps,
                                 bool              escapable)
  : stepped_(false)
  , progressbar_(NULL)
{
    ...
    // if there is no progress bar in using at the moment, we create a
    // singleProgressBar as default
...
ScopedProgressBar::~ScopedProgressBar()
{
    if (progressbar_) {
        if (taskCnt_ > 1) {
            MultiTaskProgressBar* progressbar =
              (MultiTaskProgressBar*)progressbar_;
