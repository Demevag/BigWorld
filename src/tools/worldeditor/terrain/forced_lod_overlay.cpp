  ...
  : terrain_(terrain)
{
    ...
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_0.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_1.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_2.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_3.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_4.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_5.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_6.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_7.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_8.bmp"));
    textures_.push_back(Moo::TextureManager::instance()->get(
      "resources/maps/gizmo/lod_lock_level_9.bmp"));
}
...
void ForcedLodOverlay::render()
{
    ...
    const int forcedLod =
      min(terrain_->getForcedLod(), static_cast<int>(textures_.size()));
    if (forcedLod < 0) {
        return;
    }
