...
class EditorChunkTerrain : public EditorChunkTerrainBase
{
  ...
  public:
    ...
    EditorChunkTerrain* neighbour(Neighbour       n,
                                  bool            forceLoad = false,
                                  bool            writable  = true,
                                  NeighbourError* isValid   = NULL) const;

    static Terrain::EditorBaseTerrainBlockPtr loadBlock(
    ...
    static size_t findChunksWithinBox(BoundingBox const&      bb,
  ...
  private:
    ...
    void copyHeights(int32  chunkDx,
                     int32  chunkDz,
                     uint32 srcX,
                     uint32 srcZ,
                     uint32 srcW,
