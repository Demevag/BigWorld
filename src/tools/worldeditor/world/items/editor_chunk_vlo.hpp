...
class EditorChunkVLO
  : public EditorChunkSubstance<ChunkVLO>
...
#endif // BIGWORLD_CLIENT_ONLY
{
  ...
  public:
    ...
    virtual Name edDescription()
    {
        ...
        if (pObject_)
            return LocaliseUTF8(
              L"WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_VLO/ED_DESCRIPTION",
              pObject_->edClassName().c_str());
        return LocaliseUTF8(
          L"WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_VLO/VLO_REFENRENCE");
    }
    ...
    virtual bool          legacyLoad(DataSectionPtr pSection,
                                     Chunk*         pChunk,
                                     BW::string&    type);
#ifndef BIGWORLD_CLIENT_ONLY
    ...
    {
        return pObject_ ? pObject_->edAssetName() : "VLO";
    }
  ...
  private:
    ...
    {
        return pOwnSect()->readString("type") != "water";
    }
