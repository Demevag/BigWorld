...
class EditorStaticChunkDecal : public EditorChunkSubstance<StaticChunkDecal>
{
  ...
  public:
    ...
    virtual void edGetTexturesAndVertices(BW::map<void*, int>& texturesInfo,
    ...
    bool setApplyTo(const bool& flag)
    {
        return setGenericApplyTo(static_cast<uint>(Type), flag);
    }

    template <DecalsManager::Decal::EInfluenceType Type>
    bool getApplyTo() const
    {
        return getGenericApplyTo(static_cast<uint>(Type));
    }
