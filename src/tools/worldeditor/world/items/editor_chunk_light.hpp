...
class EditorChunkLight : public EditorChunkSubstance<BaseLight>
{
  public:
    ...
    virtual void markInfluencedChunks() { BW_GUARD; }

    virtual void markDynamicInfluencedChunks() { BW_GUARD; }

    virtual void markStaticInfluencedChunks() { BW_GUARD; }
...
class EditorChunkPhysicalMooLight : public EditorChunkMooLight<BaseLight>
{
  public:
    virtual void markInfluencedChunks()
    {
        BW_GUARD;
        if (pChunk_) {
            LightingInfluence::DynamicLightMarkChunksVisitor<BaseLight*>
              visitor(this);
 ...
 *	This class is the editor version of a chunk omni light
 */
class EditorChunkPulseLight
  : public EditorChunkPhysicalMooLight<ChunkPulseLight>
{
...
class EditorChunkAmbientLight : public EditorChunkLight<ChunkAmbientLight>
{
