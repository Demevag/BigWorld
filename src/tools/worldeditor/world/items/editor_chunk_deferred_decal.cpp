...
static AutoConfigString s_chunkDeferredDecalNotFoundModel(
...
void EditorStaticChunkDecal::draw(Moo::DrawContext& drawContext)
{
    ...
    bool drawOverdraw =
      (Options::getOptionInt("render/decals/showOverdraw", 0) != 0);
    bool showTextureAtlas =
      (Options::getOptionInt("render/decals/showTextureAtlas", 0) != 0);

    //--
    if (drawOverdraw)
        DecalsManager::instance().enableDebugDraw(
          DecalsManager::DEBUG_OVERDRAW);
    else
...
bool EditorStaticChunkDecal::load(DataSectionPtr iData)
{
    ...
    if (!EditorChunkSubstance<StaticChunkDecal>::load(iData)) {
        ...
        bool mapsNotProvided = m_decalDesc.m_materialType ==
                                   DecalsManager::Decal::MATERIAL_DIFFUSE &&
                                 map1IsBlank ||
                               map1IsBlank && map2IsBlank;
        ...
        if (mapsNotProvided) {
            ...
            BW::string maps = m_decalDesc.m_materialType ==
                                  DecalsManager::Decal::MATERIAL_DIFFUSE
                                ? map1
                                : map1 + ", " + map2;
            WorldManager::instance().addError(this->chunk(),
                                              this,
                                              "[DECAL] Decal not loaded: %s",
                                              maps.c_str());
        }
    }
...
bool EditorStaticChunkDecal::reload()
{
    ...
    if (isLoaded() && map1Changed) {
        ...
        float aspectRatio =
          DecalsManager::instance().getMap1AspectRatio(m_decal);
...
//--------------------------------------------------------------------------------------------------
bool EditorStaticChunkDecal::edTransform(const Matrix& transform,
                                         bool          transient)
{
    BW_GUARD;
    ...
    //-- and move ourselves into the right chunk. we have to do this even if
    // it's the same chunk so
...
bool EditorStaticChunkDecal::edEdit(GeneralEditor& editor)
{
    ...
    editor.addProperty(new ChunkItemPositionProperty(
      LocaliseStaticUTF8(
        L"WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_DECAL/POSITION"),
      pMP,
      this));
    editor.addProperty(new GenRotationProperty(
      LocaliseStaticUTF8(
        L"WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_DECAL/ROTATION"),
      pMP));
    editor.addProperty(new GenScaleProperty(
      LocaliseStaticUTF8(
        L"WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_DECAL/SCALE"),
      pMP));
    ...
    //------------------------------------------------------------------------------------------
    {
        editor.addProperty(new GenBoolProperty(
          ...
          new AccessorDataProxy<EditorStaticChunkDecal, BoolProxy>(
            this,
            "apply to terrain",
            &EditorStaticChunkDecal::getApplyTo<
              DecalsManager::Decal::APPLY_TO_TERRAIN>,
            &EditorStaticChunkDecal::setApplyTo<
              DecalsManager::Decal::APPLY_TO_TERRAIN>)));
        ...
        editor.addProperty(new GenBoolProperty(
          ...
          new AccessorDataProxy<EditorStaticChunkDecal, BoolProxy>(
            ...
            "apply to tree",
            &EditorStaticChunkDecal::getApplyTo<
              DecalsManager::Decal::APPLY_TO_TREE>,
            &EditorStaticChunkDecal::setApplyTo<
              DecalsManager::Decal::APPLY_TO_TREE>)));
        ...
        editor.addProperty(new GenBoolProperty(
          ...
          new AccessorDataProxy<EditorStaticChunkDecal, BoolProxy>(
            ...
            "apply to dynamic",
            &EditorStaticChunkDecal::getApplyTo<
              DecalsManager::Decal::APPLY_TO_DYNAMIC>,
            &EditorStaticChunkDecal::setApplyTo<
              DecalsManager::Decal::APPLY_TO_DYNAMIC>)));
        ...
        editor.addProperty(new GenBoolProperty(
          ...
          new AccessorDataProxy<EditorStaticChunkDecal, BoolProxy>(
            ...
            "apply to static",
            &EditorStaticChunkDecal::getApplyTo<
              DecalsManager::Decal::APPLY_TO_STATIC>,
            &EditorStaticChunkDecal::setApplyTo<
              DecalsManager::Decal::APPLY_TO_STATIC>)));
        ...
        editor.addProperty(new GenBoolProperty(
          ...
          new AccessorDataProxy<EditorStaticChunkDecal, BoolProxy>(
            ...
            "apply to flora",
            &EditorStaticChunkDecal::getApplyTo<
              DecalsManager::Decal::APPLY_TO_FLORA>,
            &EditorStaticChunkDecal::setApplyTo<
              DecalsManager::Decal::APPLY_TO_FLORA>)));
    }
...
bool EditorStaticChunkDecal::setGenericApplyTo(uint type, bool enable)
{
    ...
    if (enable)
        m_decalDesc.m_influenceType |= type;
    else
        m_decalDesc.m_influenceType &= ~type;
...
//--------------------------------------------------------------------------------------------------
void EditorStaticChunkDecal::edGetTexturesAndVertices(
  BW::map<void*, int>& texturesInfo,
  BW::map<void*, int>& verticesInfo)
{
    BW_GUARD;
                ...
                float&         prevMaxDist)
{
    ...
    Vector3 groundPos = Snap::toGround(pos, dir, 20000.f);
...
void EditorStaticChunkDecal::minimizeBoxSize()
{
    ...
    // pos = pos + dir * ((minDownDist - g_defaultDecalSize + maxDownDist) *
    // 0.5f);
