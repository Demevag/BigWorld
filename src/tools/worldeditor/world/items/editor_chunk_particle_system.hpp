...
class EditorChunkParticleSystem : public EditorChunkSubstance<ChunkParticles>
{
    ...
    static BW::map<BW::string, BW::set<EditorChunkParticleSystem*>>
                editorChunkParticleSystem_;
  ...
  public:
    ...
    {
        return BWResource::getFilename(resourceName_).to_string();
    }
  ...
  private:
    ...
    virtual const char* drawFlag() const { return "render/scenery/particle"; }
