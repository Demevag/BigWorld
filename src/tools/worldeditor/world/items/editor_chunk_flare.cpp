...
#if UMBRA_ENABLE
    this->wantFlags_ =
      WantFlags(this->wantFlags_ | WANTS_TICK | WANTS_UPDATE | WANTS_DRAW);
#else
 ...
 */
bool EditorChunkFlare::load(DataSectionPtr pSection,
                            Chunk*         pChunk,
...
bool EditorChunkFlare::edSave(DataSectionPtr pSection)
{
    ...
    if (colourApplied_)
        pSection->writeVector3("colour", colour_);
...
class FlareColourWrapper : public UndoableDataProxy<ColourProxy>
{
  public:
    ...
    virtual BW::string opName()
    {
        ...
        return LocaliseUTF8(
          L"WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_FLARE/SET_COLOUR",
...
bool EditorChunkFlare::edEdit(class GeneralEditor& editor)
{
    ...
    STATIC_LOCALISE_NAME(
      s_flare, "WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_FLARE/FLARE");
    STATIC_LOCALISE_NAME(
      s_position, "WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_FLARE/POSITION");
    STATIC_LOCALISE_NAME(
      s_colour, "WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_FLARE/COLOUR");
    STATIC_LOCALISE_NAME(
      s_maxDistance,
      "WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_FLARE/MAXDISTANCE");
    STATIC_LOCALISE_NAME(
      s_area, "WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_FLARE/AREA");
    STATIC_LOCALISE_NAME(
      s_fadeSpeed,
      "WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_FLARE/FADESPEED");
    ...
    editor.addProperty(
      new ColourProperty(s_colour, new FlareColourWrapper(this)));
...
{
    Vector4 v4col = colourApplied_ ? Vector4(colour_ / 255.f, 1.f)
