...
class ItemInfoDB : public Singleton<ItemInfoDB>
{
  public:
    ...
    class ComparerHelper : public ReferenceCount
    {
      public:
        ...
        virtual int compare(const ItemPtr& a, const ItemPtr& b) const = 0;
    };
    ...
    class Comparer : public ReferenceCount
    {
      public:
        ...
        {
            intptr cmp =
              (ascending_ ? pHelper_->compare(a, b) : pHelper_->compare(b, a));
            if (cmp == 0) {
    ...
    class Item : public SafeReferenceCount
    {
      public:
        ...
        void startProperties() const { iterator_ = Type::TYPEID_ASSETNAME; }
        ...
        const PropertyPair nextProperty() const
        {
            ...
            if (iterator < Type::TYPEID_CUSTOMPROPERTY) {
                ...
                property.first =
                  ItemInfoDB::Type::builtinType((Type::BuiltinTypeId)iterator);
    ...
    typedef BW::map<ChunkItem*, ChunkItemList::iterator>
                                                    PendingChunkItemItersMap;
    ...
    void toss(ChunkItem* pChunkItem,
              bool       tossingIn,
  ...
  private:
    ...
    void updateType(const Type& type, int usageAdd, const BW::string& owner);
};
