...
class EntityPropertyTypeParser : public ReferenceCount
{
  public:
     ...
     */
    virtual GeneralProperty* plainProperty(BasePropertiesHelper* props,
                                           int                   propIndex,
                                           const Name&           name,
     ...
     */
    virtual GeneralProperty* enumProperty(BasePropertiesHelper* props,
                                          int                   propIndex,
                                          const Name&           name,
     ...
     *	@return				The plain property of the parser
     */
    virtual GeneralProperty* radiusProperty(BasePropertiesHelper* props,
                                            int                   propIndex,
                                            const Name&           name,
                                            DataTypePtr           dataType,
                                            MatrixProxy*          pMP,
    ...
    {
      public:
        virtual EntityPropertyTypeParserPtr create(const Name& name,
                                                   DataTypePtr dataType) = 0;
    };

    static void                        registerFactory(Factory* factory);
    static EntityPropertyTypeParserPtr create(const Name& name,
                                              DataTypePtr dataType);
