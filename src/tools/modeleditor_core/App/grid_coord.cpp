...
GridCoord::GridCoord(int xc, int yc)
  : x(xc)
  , y(yc)
{
}

GridCoord::GridCoord(Vector2 v)
  : x((int)floorf(v.x))
  , y((int)floorf(v.y))
{
}
...
GridRect::GridRect(GridCoord bl, GridCoord tr)
  : bottomLeft(bl)
  , topRight(tr)
{
}
...
{
    return GridRect(GridCoord(min(a.x, b.x), min(a.y, b.y)),
