...
{
    Py_Header(EntityDirProvider, MatrixProvider) public
...
{
    Py_Header(DiffDirProvider, MatrixProvider) public
      : DiffDirProvider(MatrixProviderPtr pSource,
...
{
    Py_Header(ScanDirProvider, MatrixProvider) public
