 ...
 *
 * Controls the frequency of dynamic update. Staggered (true) provides more
 *consistent performance while un-staggered (false) gives more consistent
 *quality.
 *
 *	@type	Integer as boolean
 */
...
{
    BW_GUARD;
    if (!cameras_.size() || ChunkManager::instance().cameraSpace() == NULL)
        return;
