...
namespace {
    BW::string getVersionString()
    {
        return BWVersion::versionString();
    }
}
...
bool DebugApp::init()
{
    ...
    MF_WATCH("System/Network/Host",
             hostName_,
             Watcher::WT_READ_WRITE,
             "Server hostname");

    MF_WATCH("System/Operating System/Version",
             *pVersionInfo_,
             &VersionInfo::OSName,
             "Name of Operating System");
    MF_WATCH("System/Operating System/Major",
             *pVersionInfo_,
             &VersionInfo::OSMajor,
             "Major version number of Operating System");
    MF_WATCH("System/Operating System/Minor",
             *pVersionInfo_,
             &VersionInfo::OSMinor,
             "Minor version number of Operating System");
    MF_WATCH("System/Operating System/Pack",
             *pVersionInfo_,
             &VersionInfo::OSServicePack,
             "Installed service pack");

    MF_WATCH("System/DirectX/Version",
             *pVersionInfo_,
             &VersionInfo::DXName,
             "Version of installed DirectX");
    MF_WATCH("System/DirectX/Major",
             *pVersionInfo_,
             &VersionInfo::DXMajor,
             "Major version number of installed DirectX");
    MF_WATCH("System/DirectX/Minor",
             *pVersionInfo_,
             &VersionInfo::DXMinor,
             "Minor version number of installed DirectX");
    MF_WATCH("System/DirectX/Device",
             deviceName_,
             Watcher::WT_READ_WRITE,
             "DirectX device name");
    MF_WATCH("System/DirectX/Driver Name",
             driverName_,
             Watcher::WT_READ_WRITE,
             "DirectX driver name");
    MF_WATCH("System/DirectX/Driver Desc",
             driverDesc_,
             Watcher::WT_READ_WRITE,
             "DirectX driver description");
    MF_WATCH("System/Video Adapter/Driver",
             *pVersionInfo_,
             &VersionInfo::adapterDriver,
             "Name of video adapter driver");
    MF_WATCH("System/Video Adapter/Desc",
             *pVersionInfo_,
             &VersionInfo::adapterDesc,
             "Description of video adapter driver");
    MF_WATCH("System/Video Adapter/Major Version",
             *pVersionInfo_,
             &VersionInfo::adapterDriverMajorVer,
             "Major version number of video adapter");
    MF_WATCH("System/Video Adapter/Minor Version",
             *pVersionInfo_,
             &VersionInfo::adapterDriverMinorVer,
             "Minor version number of video adapter");

    MF_WATCH("System/Global Memory/Total Physical(K)",
             *pVersionInfo_,
             &VersionInfo::totalPhysicalMemory,
             "Total physical memory");
    MF_WATCH("System/Global Memory/Avail Physical(K)",
             *pVersionInfo_,
             &VersionInfo::availablePhysicalMemory,
             "Available physical memory");
    MF_WATCH("System/Global Memory/Total Virtual(K)",
             *pVersionInfo_,
             &VersionInfo::totalVirtualMemory,
             "Total virtual memory");
    MF_WATCH("System/Global Memory/Avail Virtual(K)",
             *pVersionInfo_,
             &VersionInfo::availableVirtualMemory,
             "Available virtual memory");
    MF_WATCH("System/Global Memory/Total Page File(K)",
             *pVersionInfo_,
             &VersionInfo::totalPagingFile,
             "Total page file memory");
    MF_WATCH("System/Global Memory/Avail Page File(K)",
             *pVersionInfo_,
             &VersionInfo::availablePagingFile,
             "Available page file memory");

    MF_WATCH("System/Process Memory/Page Faults",
             *pVersionInfo_,
             &VersionInfo::pageFaults,
             "Memory page faults");
    MF_WATCH("System/Process Memory/Peak Working Set",
             *pVersionInfo_,
             &VersionInfo::peakWorkingSet,
             "Peak working set size");
    MF_WATCH("System/Process Memory/Working Set",
             *pVersionInfo_,
             &VersionInfo::workingSet,
             "Current working set size");
    MF_WATCH("System/Process Memory/Quota Peaked Page Pool Usage",
             *pVersionInfo_,
             &VersionInfo::quotaPeakedPagePoolUsage,
             "Quota peak amount of paged pool usage");
    MF_WATCH("System/Process Memory/Quota Page Pool Usage",
             *pVersionInfo_,
             &VersionInfo::quotaPagePoolUsage,
             "Current quota amount of paged pool usage");
    MF_WATCH("System/Process Memory/Quota Peaked Nonpage Pool Usage",
             *pVersionInfo_,
             &VersionInfo::quotaPeakedNonPagePoolUsage,
             "Quota peak amount of non-paged pool usage");
    MF_WATCH("System/Process Memory/Quota Nonpage Pool Usage",
             *pVersionInfo_,
             &VersionInfo::quotaNonPagePoolUsage,
             "Current quota amount of non-paged pool usage");
    MF_WATCH("System/Process Memory/Peak Page File Usage",
             *pVersionInfo_,
             &VersionInfo::peakPageFileUsage,
             "Peak amount of page file space used");
    MF_WATCH("System/Process Memory/Page File Usage",
             *pVersionInfo_,
             &VersionInfo::pageFileUsage,
             "Current amount of page file space used");
...
#if ENABLE_WATCHERS
    //
    MF_WATCH<int32>("Memory/UnclaimedSize",
                    &memoryUnclaimed,
                    NULL,
                    "Amount of unclaimed memory");

    //  MF_WATCH( "Memory/Tale KB", &memoryAccountedFor );
    MF_WATCH<uint32>(
      "Memory/Used KB", &memUsed, NULL, "Amount of memory in use");
#endif

    MF_WATCH("Memory/TextureManagerReckoning",
             *Moo::TextureManager::instance(),
             &Moo::TextureManager::textureMemoryUsed,
             "Amount of texture being used by textures (total)");
    MF_WATCH("Memory/TextureManagerReckoningFrame",
             Moo::ManagedTexture::totalFrameTexmem_,
             Watcher::WT_READ_ONLY,
             "Amount of texture being used by textures (frame)");
    ...
    MF_WATCH("Build/Config",
             const_cast<char*&>(configString),
             Watcher::WT_READ_ONLY,
    ...
    MF_WATCH("Debug/Python Server",
             *this,
             ...
             "If enabled the Python and keyboard servers will run on ports "
             "50001 and 50002 respectively");

    pPythonServer_ = new PythonServer();
    enableServers(
      configSection->readBool("debug/enableServers", enableServers_));
#endif

    // 5. Critical message callback (move much earlier?)
    shouldBreakOnCritical_ =
      configSection->readBool("breakOnCritical", shouldBreakOnCritical_);
    shouldAddTimePrefix_ =
      configSection->readBool("addTimePrefix", shouldAddTimePrefix_);
    DebugFilter::instance().hasDevelopmentAssertions(configSection->readBool(
    ...
    DataSectionPtr pWatcherSection =
      configSection->openSection("watcherValues");
    if (pWatcherSection) {
...
void DebugApp::tick(float /* dGameTime */, float dRenderTime)
{
    ...
    if (first && ((pVersionInfo_->memoryLoad() >= 99 &&
                   pVersionInfo_->pageFileUsage() >
                     (pVersionInfo_->totalPhysicalMemory() * 0.7)) ||
...
void DebugApp::draw()
{
    ...
    WorldTriangle camTri(camPos - Moo::rc().invView().applyToUnitAxisVector(0),
    ...
    if (drawSpecialConsole_) {
        XConsole* specialConsole = ConsoleManager::instance().find("Special");
