...
PyObject* ServerCaller::pyCall(PyObject* args)
{
    ...
    if (!BWEntities::isLocalEntity(pEntity->entityID())) {
        ...
        BinaryOStream* pStream =
          pConnection->addServerMessage(pEntity->entityID(),
        ...
        if (!pStream) {
            ...
            PyErr_Format(PyExc_ValueError,
                         "Could not get stream to call %s.%s",
    ...
    if (pDescription == NULL) {
        ...
        if (!result) {
            ...
            PyErr_Format(PyExc_AttributeError,
                         ...
                         type,
                         attr,
                         isProxyCaller_ ? "BaseMethods" : "CellMethods",
                         type);
            return ScriptObject();
        }
        return result;
