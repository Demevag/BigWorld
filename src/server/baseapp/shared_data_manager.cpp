...
namespace {
     ...
     *
     *	This function sets a data value that is accessible from all CellApps.
     ...
     *	components try to set the same value, the last one to reach the
     *CellAppMgr will be the one that is kept.
     *
     *	Note: Care should be taken using this functionality. It does not scale
