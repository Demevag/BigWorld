 ...
 */
PyReplayDataFileReader::PyReplayDataFileReader(const BW::string& verifyingKey,
  ...
  BW::string&           errorString)
{
    ...
    if (!returnValue.exists()) {
        return false;
    } else if (returnValue.exists() && !returnValue.isNone() &&
  ...
  BW::string&           errorString)
{
    ...
    BW::string tickData(static_cast<const char*>(stream.retrieve(streamSize)),
                        streamSize);
  ...
  const BW::string&     errorDescription)
{
    this->callListenerCallback("onReplayDataFileReaderError",
                               ScriptArgs::create(this, errorDescription),
                               /* pErrorString */ NULL);
}
  ...
  BW::string*       pErrorString)
{
    ...
    ScriptObject returnValue =
      pListener_.callMethod(methodName,
                            args,
                            ScriptErrorRetain(),
