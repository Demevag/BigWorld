...
class Cluster
{
  ...
  protected:
    ...
    // Timeout handler for birth messages.  Basically, when we are born people
    // will start replying to us telling us how many other machines are on the
    // network. We must become aware of this many machines within a reasonable
    // timeframe or we will send out the request again
