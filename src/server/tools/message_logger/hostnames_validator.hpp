...
class HostnamesValidator
{
  public:
    ...
    HostnamesValidateResult validateOneHostname(MessageLogger::IPAddress addr,
...
class HostnameCopier : public HostnameVisitor
{
  public:
    ...
    {
        pHostnamesValidator_->addValidateHostname(
          ipAddress, hostname, BW_HOSTNAME_STATUS_NOT_VALIDATED);
        return true;
    }
