 ...
 *	Constructor.
 */
ScriptBotEntity::ScriptBotEntity(const ClientApp&  clientApp,
 ...
 */
void ScriptBotEntity::onProperty(int            propertyID,
                                 BinaryIStream& data,
                                 bool           isInitialising)
{
    SimpleClientEntity::propertyEvent(pPyEntity_,
                                      ...
                                      propertyID,
                                      data,
                                      /* callSetForTopLevel */ !isInitialising);
}
 ...
 *	the server.
 */
void ScriptBotEntity::onNestedProperty(BinaryIStream& data,
                                       bool           isSlice,
                                       bool           isInitialising)
{
...
{
    pPyEntity_.callMethod("onBecomePlayer",
                          ScriptErrorPrint(),
...
{
    pPyEntity_.callMethod("onBecomeNonPlayer",
                          ScriptErrorPrint(),
                          /* allowNullMethod */ true);
}
