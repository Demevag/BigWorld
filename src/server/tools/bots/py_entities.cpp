...
namespace {
    /**
     *	This function is used py_keys. It creates an object that goes into the
     *keys list based on an element in the Entities map.
     */
    ...
    static PyObject* getItem(const BWEntities::const_iterator& iEntity)
    {
        ...
        ScriptObject entityID(getEntityID(iEntity),
                              ScriptObject::FROM_NEW_REFERENCE);
        ScriptObject entityRef(getEntityReference(iEntity),
                               ScriptObject::FROM_NEW_REFERENCE);
