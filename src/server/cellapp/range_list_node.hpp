...
/**
 * This class is the base of all range nodes. Range Nodes are used to keep track
 * of the order of entities and triggers relative to the x axis or the z axis.
...
class RangeListNode
{
  public:
    ...
    // oldZ is used to make the shuffle think entity is moving in orthogonal
    // directions only
    ...
    {
        return getNext ? (getZ ? pNextZ_ : pNextX_)
    ...
    virtual void crossedX(RangeListNode* /*node*/,
                          bool /*positiveCrossing*/,
                          float /*oldOthX*/,
                          float /*oldOthZ*/)
    {
    }
    virtual void crossedZ(RangeListNode* /*node*/,
                          bool /*positiveCrossing*/,
                          float /*oldOthX*/,
                          float /*oldOthZ*/)
    {
...
class RangeListTerminator : public RangeListNode
{
  public:
    RangeListTerminator(bool isHead)
      : RangeListNode(RangeListFlags(0),
                      RangeListFlags(0),
