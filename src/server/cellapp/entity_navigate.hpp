...
class EntityNavigate : public EntityExtra
{
    Py_EntityExtraHeader(EntityNavigate)
      ...
      public : EntityNavigate(Entity& e);
    ~EntityNavigate();
    ...
    PY_AUTO_METHOD_DECLARE(
      ...
      ARG(Vector3,
          ARG(float,
              OPTARG(int, 0, OPTARG(bool, true, OPTARG(bool, false, END))))))
    ...
    PY_AUTO_METHOD_DECLARE(
      ...
      ARG(Position3D,
          ARG(float,
              ARG(float,
                  OPTARG(int, 1, OPTARG(bool, false, OPTARG(int, 0, END)))))));
    ...
    PY_AUTO_METHOD_DECLARE(
      ...
      ARG(BW::vector<Position3D>,
          ARG(float, ARG(float, OPTARG(int, 1, OPTARG(int, 0, END))))));
    ...
    PyObject* navigate(const Vector3& dstPosition,
                       float          velocity,
                       bool           faceMovement = true,
    ...
    PyObject* navigateStep(const Vector3& dstPosition,
                           float          velocity,
                           float          maxMoveDistance,
                           float          maxSearchDistance = -1.f,
                           bool           faceMovement      = true,
                           float          girth             = 0.5f,
                           int            userArg           = 0);
                          ...
                          OPTARG(float,
                                 ...
                                 OPTARG(bool,
                                        ...
                                        OPTARG(float,
                                               0.5f,
                                               OPTARG(int, 0, END))))))))))
    PyObject* navigateFollow(PyObjectPtr pEntity,
                             float       angle,
                             float       offset,
                             float       velocity,
                             float       maxMoveDistance,
