 ...
 */
class BaseAccelerationController
  : public Controller
  , public Updatable
{
  public:
  ...
  protected:
    static Vector3 calculateDesiredVelocity(const Position3D& currentPosition,
                                            const Position3D& desiredPosition,
                                            float             acceleration,
                                            float             maxSpeed,
                                            bool stopAtDestination);

    static Vector3 calculateAccelerationVector(const Vector3& currentVelocity,
