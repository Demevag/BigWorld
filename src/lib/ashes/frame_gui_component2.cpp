 ...
 */
FrameGUIComponent2::FrameGUIComponent2(const BW::string& textureName,
                                       PyTypeObject*     pType)
 ...
 */
GUIVertex* FrameGUIComponent2::setQuad(GUIVertex* pFirstVert,
                                       float      x1,
                                       float      y1,
                                       float      x2,
                                       float      y2,
 ...
 */
void FrameGUIComponent2::update(float dTime,
...
/**
 *	This methods updates the positions of the existing set of vertices, to match
 *the current width and height of the component.  See the content creation
 *manual to fully understand the required layout of the source texture.
 */
void FrameGUIComponent2::updateVertices(GUIVertex* v,
                                        ...
                                        float      relativeParentHeight)
{
    ...
    // setQuad takes (left,top) (right,top), (right,bottom), (left,bottom),
    // texture atlas part index

    // center area
    // if these are the first four vertices, then some other GUI functionality
    // like hittests work.
