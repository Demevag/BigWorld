  ...
  , public Singleton<SimpleGUI>
{
  public:
    ...
    bool hasResolutionChanged(void) { return resolutionHasChanged_; }
  ...
  private:
    ...
    WeakPyPtr<SimpleGUIComponent> detectEnterLeaveEvents(
      MouseCursor&                  mcursor,
    ...
    // PC client needs this because the clip stack is implemented using
    // viewports and view matrices
