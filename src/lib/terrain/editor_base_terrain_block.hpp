...
namespace Terrain {
    ...
    class EditorBaseTerrainBlock : public BaseTerrainBlock
    {
      public:
         ...
         *  @returns                True if the save was successful, false if
         * the save failed.
         */
         ...
         *							otherwise.
         */
        virtual size_t insertTextureLayer(uint32 blendWidth  = 0,
                                          uint32 blendHeight = 0) = 0;
        ...
        /**
         * This function refreshes all data that would be affected by a height
         * map change.
         */
         ...
         */
        virtual void rebuildNormalMap(NormalMapQuality normalMapQuality,
                                      uint32           newSize = 0) = 0;
         ...
         *						otherwise.
         */
        virtual bool rebuildLodTexture(const Matrix& transform,
                                       uint32        newSize = 0) = 0;
         ...
         */
        size_t findLayer(BW::string const& texture,
         ...
         *							INVALID_LAYER if no such layer exists.
         */
        size_t findLayer(TerrainTextureLayer const& layer,
                         float                      epsilon,
                         size_t                     startIdx = 0) const;
         ...
         */
        void setSelectionKey(DWORD key) { selectionKey_ = key; }
         ...
         */
        static void drawSelection(bool draw) { s_drawSelection_ = draw; }
