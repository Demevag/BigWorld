...
namespace Moo {
    ...
    template <>
    inline Terrain::MaterialIndex Image<Terrain::MaterialIndex>::getBicubic(
      float x,
      float y) const
    {
    ...
    template <>
    inline double Image<Terrain::MaterialIndex>::getBicubic(double x,
                                                            double y) const
    {
...
namespace Terrain {
...
#ifndef MF_SERVER
        const BW::vector<BW::string>& textureNamesNoExt() const
        {
            return textureNamesNoExt_;
        }
#endif
    ...
    /**
     *  A DominantTextureMapHolder can be used to lock/unlock a
     * DominantTextureMap.
     */
