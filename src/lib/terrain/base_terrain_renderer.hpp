...
namespace Terrain {
    ...
    class BaseTerrainRenderer : public SafeReferenceCount
    {
      public:
        /**
         *  This method sets the current terrain renderer instance. At the
         * moment, TerrainRenderers call this method when they are inited to set
         * themselves as the current renderer.
         *
         ...
         *	@param transform		The transformation matrix to apply when
         *drawing.
         */
         ...
         */
        virtual void drawAll(Moo::ERenderingPassType passType,
         ...
         */
        virtual void drawSingle(Moo::ERenderingPassType passType,
                                BaseRenderTerrainBlock* pBlock,
                                const Matrix&           transform,
                                Moo::EffectMaterialPtr  altMat = NULL) = 0;
         ...
         *
         *  @return          true if the terrain should be drawn, false
         * otherwise.
         */
         ...
         *
         *  @param          true to use specular in the terrain, false
         * otherwise.
         */
         ...
         *  highlights or not. This method is used by the chunk photographer
         * class in WE.
         *
         *  @return          true if using specular in the terrain, false
         * otherwise.
         */
        ...
        /**
         *	This method reads a flag that indicates whether or not hole map is
         *used during terrain texture rendering.
         */
