...
namespace Terrain {
    ...
    /**
     *	This class is the main entry point for the Terrain Library, holding
     *library objects such as the terrain renderers. It also keeps track of the
     *current active renderer, and a reference to the terrain2 defaults
     *DataSection.
     *
     ...
     *
     *  NOTE: We shouldn't be adding new global objects here, we should instead
     *try to keep objects independent of each other and avoid singletons
     *altogether.
     */
    class Manager : public Singleton<Manager>
    {
      public:
        ...
        const BasicTerrainLodController& lodController() const
        {
            return lodController_;
        }
        BasicTerrainLodController& lodController() { return lodController_; }

        const TerrainGraphicsOptions& graphicsOptions() const
        {
            return graphicsOptions_;
        }
