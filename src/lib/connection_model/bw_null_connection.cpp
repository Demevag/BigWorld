 ...
 */
EntityID BWNullConnection::createNewPlayerBaseEntity(
  ...
  BinaryIStream& basePlayerData)
{
    ...
    this->serverMessageHandler().onBasePlayerCreate(
      playerID_, entityTypeID, basePlayerData);
                                                  ...
                                                  BinaryIStream& cellPlayerData)
{
    ...
    if (hasCell_) {
        ERROR_MSG(
          "BWNullConnection::giveCellToPlayerBaseEntity: "
    ...
    this->serverMessageHandler().onCellPlayerCreate(playerID_,
                                                    spaceID_,
                                                    NULL_ENTITY_ID,
                                                    position,
                                                    direction.yaw,
 ...
 */
void BWNullConnection::spaceData(SpaceID           spaceID,
 ...
 */
void BWNullConnection::enqueueLocalMove(
  EntityID           entityID,
  SpaceID            spaceID,
  EntityID           vehicleID,
 ...
 */
BinaryOStream* BWNullConnection::startServerMessage(
  EntityID entityID,
  int      methodID,
