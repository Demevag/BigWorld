  ...
  , public BWEntitiesListener
{
  public:
    ...
    bool setReplaySignaturePublicKeyString(const BW::string& publicKeyString);

    bool setReplaySignaturePublicKeyPath(const BW::string& publicKeyPath);

    bool startReplayFromFile(
    ...
    bool startReplayFromStreamData(
      TaskManager&      taskManager,
      SpaceID           spaceID,
  ...
  private:
    ...
    BinaryOStream* startServerMessage(EntityID entityID,
                                      int      methodID,
    ...
    void onBasePlayerCreate(EntityID       id,
                            EntityTypeID   type,
                            BinaryIStream& data) /* override */;
    void onCellPlayerCreate(EntityID          id,
                            SpaceID           spaceID,
                            EntityID          vehicleID,
    ...
    void onEntityLeave(EntityID id, const CacheStamps& stamps) /* override */;
    ...
    void onEntityMethod(EntityID id, int methodID, BinaryIStream& data)
      /* override */;
    void onEntityProperty(EntityID       id,
                          int            propertyID,
                          BinaryIStream& data) /* override */;
    void onNestedEntityProperty(EntityID       id,
                                BinaryIStream& data,
    ...
    int  getEntityPropertyStreamSize(EntityID id,
                                     int      propertyID,
                                     bool isFailAllowed) const /* override */;
    void onEntityMoveWithError(EntityID          id,
                               SpaceID           spaceID,
                               EntityID          vehicleID,
                               const Position3D& pos,
