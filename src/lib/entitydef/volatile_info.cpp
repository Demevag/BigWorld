 ...
 *	Constructor.
 */
VolatileInfo::VolatileInfo(float positionPriority,
                           float yawPriority,
                           float pitchPriority,
                           float rollPriority)
...
{
    return positionPriority_ < info.positionPriority_ ||
...
{
    return yawPriority_ >= pitchPriority_ && pitchPriority_ >= rollPriority_;
}
