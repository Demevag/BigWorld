...
// FloatDataType
TEST_FP(DataTypeFixture,
        DataTypeFixture("<type> FLOAT32 </type>"),
        FloatDataType_float)
{
...
TEST_FP(DataTypeFixture,
        DataTypeFixture("<type> FLOAT64 </type>"),
...
#define TEST_INTEGER_TYPE(type, xmlType)                                       \
    TEST_FP(DataTypeFixture,                                                   \
...
#define TEST_LONGINTEGER_TYPE(type, xmlType)                                   \
    TEST_FP(DataTypeFixture,                                                   \
            DataTypeFixture("<type> " #xmlType " </type>"),                    \
...
// VectorDataType
#define TEST_VECTOR_TYPE(length)                                               \
    TEST_FP(VectorDataTypeFixture,                                             \
...
// relevant module.
TEST_FP(DictionaryDataTypeFixture,
        DictionaryDataTypeFixture(
...
TEST_FP(SequenceDataTypeFixture,
        SequenceDataTypeFixture(
...
TEST_FP(
  DataDescriptionFixture,
  DataDescriptionFixture("<visibleList>"
 ...
 */
TEST_FP(MethodArgsFixture,
        MethodArgsFixture("<Args>"
                          "	<arg1>			INT8	</arg1>"
                          "	<arg2>			INT8	</arg2>"
                          "	<arg3>			INT8	</arg3>"
                          "	<arg4>			INT8	</arg4>"
...
TEST_ARGS_VARIABLE_STREAMSIZE_NAMED("<Args>"
                                    "	<arg1>			STRING	</arg1>"
                                    "	<arg2>			STRING	</arg2>"
                                    "	<arg3>			STRING	</arg3>"
                                    "	<arg4>			STRING	</arg4>"
...
TEST_FP(MethodDescriptionFixture,
        MethodDescriptionFixture(
          "<scanForTargets>"
          "	<Args>"
...
TEST_FP(
  MethodDescriptionFixture,
  MethodDescriptionFixture("<tryToTeleport>"
                           "	<Exposed/>"
                           "	<Args>"
...
TEST_FP(MethodDescriptionFixture,
        MethodDescriptionFixture("<commerceCancelRequest>"
                                 "	<Exposed/>"
...
TEST_FP(MethodDescriptionFixture,
        MethodDescriptionFixture("<summonEntity>"
                                 "	<Exposed/>"
                                 "	<Args>"
...
TEST_FP(PropertyChangeFixture,
        PropertyChangeFixture("<int32>"
                              "	<Type>			INT32				</Type>"
