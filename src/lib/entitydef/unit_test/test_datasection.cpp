...
namespace {
    ...
    class CheckDSConversion
    {
      public:
         ...
         *the input object.
         *	@param	dataSectionStr		An XML string of the DataSection format
         *we expect.
         */
        ...
        TEST_SUB_FUNCTOR_OPERATOR
        {
            ...
            CHECK(pDataType_->createFromSection(pResultDS_, resultSink));
...
{
    TEST_SUB_FUNCTOR_NAMED(CheckDSConversion("<Type> BLOB </Type>",
                                             "'\\0\\1\\2'",
                                             // Base64 encoding of 0x0 0x1 0x2
                                             "<value> AAEC </value>"),
                           "BLOB_1");

    TEST_SUB_FUNCTOR_NAMED(CheckDSConversion("<Type> FLOAT32 </Type>",
                                             "56.75",
                                             "<value> 56.750000 </value>"),
                           "FLOAT32_1");

    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> FLOAT64 </Type>",
                        "123456.75",
                        "<value> 123456.75000000000000000 </value>"),
      "FLOAT64_1");

    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> INT8 </Type>", "127", "<value> 127 </value>"),
      "INT8_1");

    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> INT8 </Type>", "-128", "<value> -128 </value>"),
      "INT8_2");

    TEST_SUB_FUNCTOR_NAMED(CheckDSConversion("<Type> INT16 </Type>",
                                             "32767",
                                             "<value> 32767 </value>"),
                           "INT16_1");
    ...
    TEST_SUB_FUNCTOR_NAMED(CheckDSConversion("<Type> INT32 </Type>",
                                             "2147483647",
    ...
    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> INT64 </Type>",
    ...
    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> PYTHON </Type>",
                        "[ 3, 'a', 4.5 ]",
                        "<value> gAJdcQEoSwNVAWFHQBIAAAAAAABlLg== </value>"),
      "PYTHON_4");
    ...
    TEST_SUB_FUNCTOR_NAMED(CheckDSConversion("<Type> STRING </Type>",
                                             "'hello!'",
                                             "<value> hello! </value>"),
                           "STRING_1");

    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> UINT8 </Type>", "255", "<value> 255 </value>"),
      "UINT8_1");

    TEST_SUB_FUNCTOR_NAMED(CheckDSConversion("<Type> UINT16 </Type>",
                                             "65535",
                                             "<value> 65535 </value>"),
                           "UINT16_1");

    TEST_SUB_FUNCTOR_NAMED(CheckDSConversion("<Type> UINT32 </Type>",
                                             "4294967295",
    ...
    TEST_SUB_FUNCTOR_NAMED(CheckDSConversion("<Type> UNICODE_STRING </Type>",
                                             "u'hello!'",
                                             "<value> hello! </value>"),
                           "UNICODE_STRING_1");
...
{
    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> ARRAY <of> UINT32 </of> </Type>",
                        "[ 8, 16, 400 ]",
                        "<value> "
                        "<item> 8 </item> "
                        "<item> 16 </item> "
...
{
    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> TUPLE <of> UINT32 </of> </Type>",
                        "( 8, 16, 400 )",
                        "<value> "
                        "<item> 8 </item> "
                        "<item> 16 </item> "
...
{
    TEST_SUB_FUNCTOR_NAMED(
      CheckDSConversion("<Type> FIXED_DICT <Properties> "
