...
namespace BW {
    ...
    /**
     *	This class is a PyEntityMailBox concrete implementation that cannot
     *really be used, but can be streamed around as needed for entitydef unit
     *tests.
     */
    class UnittestMailBox : public PyEntityMailBox
    {
        Py_Header(UnittestMailBox, PyEntityMailBox) public
          : UnittestMailBox()
