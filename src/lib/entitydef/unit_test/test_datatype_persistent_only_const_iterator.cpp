...
namespace {
    ...
    class IteratorCheck
    {
      public:
        IteratorCheck(DataType::const_iterator& iter,
                      DataTypePtr               pType,
                      const BW::string&         metaDataTypeName,
    ...
    {
      public:
        SingleElementCheck(const BW::string& typeStr, int expectedStreamSize)
          : typeStr_(typeStr)
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_basic_fixed_size_types)
{
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_USER_TYPE_1)
{
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_implementedBy_1)
{
    const BW::string userTypeStr(
      "<Type> FIXED_DICT "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_1)
{
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_2)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_3)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<int8Field1>		<Type>	INT8	</Type>	</int8Field1> "
    ...
    DataType::const_iterator it = pType->beginPersistent();
    TEST_SUB_FUNCTOR_LINENO(IteratorCheck(it,
                                          pType,
                                          "FIXED_DICT",
                                          "TestFD_PO3",
                                          3,
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_4)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<fixedDictField1> <Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_5)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<int8Field1>		<Type>	INT8	</Type>	</int8Field1> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_6)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<fixedDictField1> <Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_7)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<fixedDictField1> <Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_nonPersistentint_1)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_nonPersistentint_2)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<fixedDictField1> <Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_nonPersistentint_3)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<int8Field1>		<Type>	INT8	</Type>	"
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_nonPersistentint_4)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<fixedDictField1> <Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_nonPersistentint_5)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<int8Field1>		<Type>	INT8	</Type>	"
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_nonPersistentint_6)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<fixedDictField1> <Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_nonPersistentint_7)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
      "<fixedDictField1> <Type> FIXED_DICT <Properties> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_fixed_ARRAY_1)
{
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_fixed_ARRAY_2)
{
    const BW::string arrayStr("<Type> ARRAY <of> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_ARRAY_1)
{
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_ARRAY_2)
{
    const BW::string arrayStr("<Type> ARRAY <of> INT8 </of> </Type>");
    DataTypePtr      pType = getDT(arrayStr);
    RETURN_ON_FAIL_CHECK(pType);
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_ARRAY_3)
{
    const BW::string arrayStr("<Type> ARRAY <of> "
                              "ARRAY <of> INT8 </of> "
                              "</of> </Type>");
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_fixed_ARRAY_persistAsBlob_1)
{
    const BW::string arrayStr(
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_fixed_ARRAY_persistAsBlob_2)
{
    const BW::string arrayStr(
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_ARRAY_persistAsBlob_1)
{
    const BW::string arrayStr("<Type> ARRAY <of> INT8 </of> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_ARRAY_persistAsBlob_2)
{
    const BW::string arrayStr("<Type> ARRAY <of> INT8 </of> "
                              "<persistAsBlob> true </persistAsBlob> </Type>");
    DataTypePtr      pType = getDT(arrayStr);
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_ARRAY_persistAsBlob_3)
{
    const BW::string arrayStr("<Type> ARRAY <of> ARRAY <of> INT8 </of> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_fixed_TUPLE_1)
{
    const BW::string arrayStr(
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_fixed_TUPLE_2)
{
    const BW::string arrayStr("<Type> TUPLE <of> "
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_TUPLE_1)
{
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_TUPLE_2)
{
    const BW::string arrayStr("<Type> TUPLE <of> INT8 </of> </Type>");
    DataTypePtr      pType = getDT(arrayStr);
    RETURN_ON_FAIL_CHECK(pType);
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_TUPLE_3)
{
    const BW::string arrayStr("<Type> TUPLE <of> "
                              "TUPLE <of> INT8 </of> "
                              "</of> </Type>");
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_fixed_TUPLE_persistAsBlob_1)
{
    const BW::string arrayStr(
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_fixed_TUPLE_persistAsBlob_2)
{
    const BW::string arrayStr(
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_TUPLE_persistAsBlob_1)
{
    const BW::string arrayStr("<Type> TUPLE <of> INT8 </of> "
                              "<persistAsBlob> true </persistAsBlob> </Type>");
    DataTypePtr      pType = getDT(arrayStr);
    RETURN_ON_FAIL_CHECK(pType);
    CHECK_EQUAL(-1, pType->streamSize());
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_TUPLE_persistAsBlob_2)
{
    const BW::string arrayStr("<Type> TUPLE <of> INT8 </of> "
                              "<persistAsBlob> true </persistAsBlob> </Type>");
    DataTypePtr      pType = getDT(arrayStr);
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_variable_TUPLE_persistAsBlob_3)
{
    const BW::string arrayStr("<Type> TUPLE <of> TUPLE <of> INT8 </of> "
                              "<persistAsBlob> true </persistAsBlob> </of> "
                              "<persistAsBlob> true </persistAsBlob> </Type>");
    DataTypePtr      pType = getDT(arrayStr);
    RETURN_ON_FAIL_CHECK(pType);
...
TEST_F(EntityDefUnitTestHarness,
       DataType_persistent_only_const_iterator_FIXED_DICT_and_ARRAY_1)
{
    const BW::string fixedDictStr(
      "<Type> FIXED_DICT <Properties> "
