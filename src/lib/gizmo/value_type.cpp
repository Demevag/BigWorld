...
namespace {
    ...
    {
      public:
        virtual ValueTypeDesc::Desc desc() const
        {
            return ValueTypeDesc::UNKNOWN;
        }
    ...
    class VectorValueType : public BaseValueType
    {
      public:
        ...
        virtual bool toString(const Vector3& v, BW::string& ret) const
        {
            ...
            char buffer[STRBUFSIZE];
            bw_snprintf(buffer, STRBUFSIZE, "%.2f, %.2f, %.2f", v.x, v.y, v.z);
            ret = buffer;
            return true;
        }
        ...
        virtual bool toString(const Vector4& v, BW::string& ret) const
        {
            ...
            char buffer[STRBUFSIZE];
            bw_snprintf(
              buffer, STRBUFSIZE, "%.2f, %.2f, %.2f, %.2f", v.x, v.y, v.z, v.w);
            ret = buffer;
            return true;
        }
    ...
    class DateStringValueType : public StringValueType
    {
      public:
        virtual ValueTypeDesc::Desc desc() const
        {
            return ValueTypeDesc::DATE_STRING;
        }
