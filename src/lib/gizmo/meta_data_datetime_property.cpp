...
namespace {
    ...
    class DateTimeProxy : public StringProxy
    {
      ...
      public:
        DateTimeProxy(const BW::string&   name,
                      MetaData::MetaData& metaData,
                      bool                useFullDateFormat)
          : name_(name)
          , metaData_(metaData)
          , useFullDateFormat_(useFullDateFormat)
        {
        }
        virtual BW::string get() const
        {
            ...
            DateTimeUtils::format(formattedTime,
                                  (time_t)metaData_[name_]->get(),
                                  useFullDateFormat_);
    ...
    class DateTimeProperty : public MetaData::Property
    {
      ...
      public:
        DateTimeProperty(const MetaData::PropertyDesc& desc,
                         MetaData::MetaData&           metaData)
        ...
        virtual MetaData::Any get() const { return time_; }
      ...
      public:
                                             ...
                                             DataSectionPtr      ds) const
        {
            ...
            MetaData::PropertyPtr property =
              new DateTimeProperty(desc, metaData);
