...
namespace PostProcessing {
    ...
    void FilterQuadFactory::registerType(const BW::string& label,
                                         FilterQuadCreator creator)
    {
    ...
    /*static*/ FilterQuad* FilterQuadFactory::loadItem(DataSectionPtr pSection)
    {
        ...
        FilterQuadCreators::iterator found =
          FilterQuadCreators::instance().find(pSection->sectionName());
