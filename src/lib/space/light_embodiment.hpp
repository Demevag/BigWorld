...
namespace BW {
    ...
    class ILightEmbodiment : private SafeReferenceCount
    {
      public:
        ...
        bool intersectAndAddToLightContainer(
        ...
        // In the case of ILightEmbodiments used in Py*Lights, all inc/decRefs
        // need to be forwarded on to the python side due to the rigid ownership
        // of its ref count. Ideally all ref counts would be centered at the
        // LightEmbodiment but for now this cannot be helped.
      ...
      protected:
        virtual bool doIntersectAndAddToLightContainer(
          const ConvexHull&    hull,
