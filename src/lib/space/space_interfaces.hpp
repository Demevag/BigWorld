...
namespace BW {
    ...
    /*
        ...
        in the space refactor. These interfaces break away parts of algorithms
       from the space types and implementations.
    */
    ...
    namespace SpaceInterfaces {
        ...
        class IPortalSceneViewProvider
        {
          public:
            ...
            virtual bool setClosestPortalState(
              const Vector3& point,
              bool           isPermissive,
              CollisionFlags collisionFlags) = 0;
        };

        class PortalSceneView : public SceneView<IPortalSceneViewProvider>
        {
          public:
