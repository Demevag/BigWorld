...
namespace BW {
    ...
    //-----------------------------------------------------------------------------
    size_t EnviroMinderSceneProvider::intersect(
    ...
    // ----------------------------------------------------------------------------
    void EnviroMinderSceneProvider::loadEnvironment(
      const DataSectionPtr& pSpaceSettings)
    {
        ...
        sunLight_ = new Moo::DirectionalLight(
          Moo::Colour(0.8f, 0.5f, 0.1f, 1.f), Vector3(0, 1, 0));
    ...
    {
        // TODO: factor out of ChunkSpaceAdapter and this class - duplicate
        // code.
