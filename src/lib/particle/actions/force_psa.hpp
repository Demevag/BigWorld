 ...
 *	PyForcePSA is a PyParticleSystemAction that applies a constant acceleration
 *to particles in a particular direction.
 *
...
{
    Py_Header(PyForcePSA, PyParticleSystemAction) public
