...
class SourcePSA : public ParticleSystemAction
{
  ...
  private:
    ...
    Vector2 randomInitialRotation_;   ///< for mesh systems, initial pitch/yaw
                                      ///< randomisation
    Vector4 initialColour_; ///< primarily for mesh systems, initial rotation
    bool
      randomSpin_;  ///< primarily for mesh systems, randomise angular velocity
    float minSpin_; ///< minimum random angular velocity, in MESH_MAX_SPIN
                    ///< radians/second
    float maxSpin_; ///< maximum random angular velocity, in MESH_MAX_SPIN
                    ///< radians/second
    bool ignoreRotation_;   ///< strips out the rotation of the world transform
                            ///< before ejecting particles
    float inheritVelocity_; ///< inherit how much velocity from particle system
                            ///< when spawning particles? (pct)
...
{
    Py_Header(PySourcePSA, PyParticleSystemAction) public
    ...
    PY_RW_ACCESSOR_ATTRIBUTE_DECLARE(Vector2,
