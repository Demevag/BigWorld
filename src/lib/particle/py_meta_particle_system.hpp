...
{
    Py_Header(PyMetaParticleSystem, PyAttachment) public
      : PyMetaParticleSystem(MetaParticleSystemPtr pSystem,
                             PyTypeObject*         pType = &s_type_);

    /// @name create - this method creates either Meta or standard Particle
    /// systems,
    ...
    PY_AUTO_MODULE_STATIC_METHOD_DECLARE(RETOWN,
                                         createBG,
