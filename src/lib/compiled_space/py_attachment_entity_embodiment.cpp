...
namespace BW { namespace CompiledSpace {
    ...
    // ----------------------------------------------------------------------------
    // ----------------------------------------------------------------------------
    class PyAttachmentDrawHandler : public IDrawOperationTypeHandler
    {
      public:
    ...
    void PyAttachmentEntityEmbodiment::registerHandlers(Scene& scene)
    {
        ...
        pDrawOp
          ->addHandler<PyAttachmentEntityEmbodiment, PyAttachmentDrawHandler>();
        ...
        pScriptObjectOp
          ->addHandler<PyAttachmentEntityEmbodiment,
    ...
    void PyAttachmentEntityEmbodiment::syncTransform()
    {
        if (pEnteredSpace_) {
            ...
            pEnteredSpace_->dynamicScene().updateObject(
              dynamicObjectHandle_, worldXform, collisionBB, visibilityBB);
        }
    }
                                                    ...
                                                    bool           transient)
    {
        ...
        dynamicObjectHandle_ = pEnteredSpace_->dynamicScene().addObject(
          sceneObject_, worldXform, collisionBB, visibilityBB);
