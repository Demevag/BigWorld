...
namespace BW { namespace CompiledSpace {
                                       ...
                                       size_t               maxObjects)
    {
        ...
        pStream_ =
          binFile.findAndOpenSection(StaticSceneDecalTypes::FORMAT_MAGIC,
    ...
    // ----------------------------------------------------------------------------
    bool StaticSceneDecalHandler::loadDecal(StaticSceneDecalTypes::Decal& def,
                                            const StringTable& strings,
                                            Instance&          instance,
                                            size_t             index)
    {
    ...
    // ----------------------------------------------------------------------------
    // ----------------------------------------------------------------------------
    class StaticSceneDecalHandler::DrawHandler
