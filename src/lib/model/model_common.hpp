...
namespace Moo {
    ...
    // __kyl__ (20/10/2006) This method doesn't really save any code - in fact
    // it might even increase the amount of code due to the need to implement
    // FACTORY. But it creates a link between the client and server code so it
    // makes people think twice before modifying this code.
