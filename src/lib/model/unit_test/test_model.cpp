...
{
    CHECK(TestModel::reconvertModelAnimations("characters/npc/rat/models/rat"));
    CHECK(TestModel::reconvertModelAnimations("characters/npc/crab/crab"));
    CHECK(
      TestModel::reconvertModelAnimations("characters/npc/chicken/chicken"));
};
