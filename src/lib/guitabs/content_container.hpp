...
namespace GUITABS {
     ...
     *	Implements a panel that contains other Content-inheriting classes,
     *useful in making switching between different contents modal. It basically
     *behaves as a single tab that changes its content dynamically.
     */
