...
namespace Mercury {
    ...
    /**
     * 	This method adds an interface element (Mercury method) to the interface
     *minder.
     *  @param name             Name of the interface element.
     * 	@param lengthStyle		Specifies whether the message is fixed or
     *variable.
                                           ...
                                           InputMessageHandler* pHandler)
    {
        ...
        InterfaceElement element(name, id, lengthStyle, lengthParam, pHandler);
    ...
    /**
     * 	This method registers all the minded interface elements with an
     * interface.
     *
      ...
      NetworkInterface& networkInterface)
    {
        for (uint i = 0; i < elements_.size(); ++i) {
            ...
            networkInterface.interfaceTable().serve(element,
                                                    element.pHandler());
        }
    }
