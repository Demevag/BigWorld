...
class EmptyMessageHandler : public Mercury::InputMessageHandler
{
  public:
     ...
     *	Constructor.
     */
    EmptyMessageHandler(Handler handler)
      : handler_(handler)
    {
    }
...
class EmptyMessageHandlerEx : public Mercury::InputMessageHandler
{
  public:
     ...
     *	Constructor.
     */
    EmptyMessageHandlerEx(Handler handler)
      : handler_(handler)
    {
    }
...
class StructMessageHandler : public Mercury::InputMessageHandler
{
  public:
     ...
     *	Constructor.
     */
    StructMessageHandler(Handler handler)
      : handler_(handler)
    {
    }
...
class StructMessageHandlerEx : public Mercury::InputMessageHandler
{
  public:
     ...
     *	Constructor.
     */
    StructMessageHandlerEx(Handler handler)
      : handler_(handler)
    {
    }
...
class StreamMessageHandler : public Mercury::InputMessageHandler
{
  public:
     ...
     *	Constructor.
     */
    StreamMessageHandler(Handler handler)
      : handler_(handler)
    {
    }
...
class StreamMessageHandlerEx : public Mercury::InputMessageHandler
{
  public:
     ...
     *	Constructor.
     */
    StreamMessageHandlerEx(Handler handler)
      : handler_(handler)
    {
    }
