...
namespace Mercury {
    ...
    /**
     *	@internal
     *	This constant defines the default header size for variable size
     *messages.
     */
    ...
    {
      public:
        InterfaceElement(const char*          name        = "",
                         MessageID            id          = 0,
                         int8                 lengthStyle = INVALID_MESSAGE,
                         int                  lengthParam = 0,
        ...
        {
            return (lengthStyle_ == VARIABLE_LENGTH_MESSAGE) ? -lengthParam_
                                                             : lengthParam_;
        }
      ...
      private:
        void* specialCompressLength(void*   data,
                                    int     length,
                                    Packet* pPacket,
                                    bool    isRequest) const;
        int   specialExpandLength(void*   header,
                                  Packet* pPacket,
                                  bool    isRequest) const;
    ...
    class InterfaceElementWithStats : public InterfaceElement
    {
      public:
        ...
        /**
         *	Return the maximum number of bytes ever received for a single
         *message for this interface element.
         */
...
#if ENABLE_WATCHERS
        /**
         *	Return a watcher for monitoring the counts and averages for
         *interface elements.
         */
      ...
      private:
        ...
        /**
         *	Notification method when a message has been received for this
         *interface element.
         *
        ...
        /**
         *	The per-second exponentially weighted moving average for bytes
     ...
     *  however since we changed to implementing piggybacking with footers
     * instead of messages, we don't need it anymore.  A lot of the entitydef
     * code works on the assumption that there are 2 message IDs reserved for
     * Mercury, i.e. you can only have 62 unique properties/methods on an entity
     * before 2 byte identifiers kick in.  We didn't alter entitydef to use
     *  REPLY_PIGGY_BACK_IDENTIFIER when we took it out as there is a lot of
     *  hardcoding in there, and it was a small optimisation for a relatively
     * high chance of breaking something just prior to 1.8.1 being released.
     */
