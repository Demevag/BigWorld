...
namespace Mercury {
    ...
    class TCPConnectionOpenerListener
    {
      public:
         ...
         *
         *	@param opener	The TCPConnectionOpener object that was attempting
    ...
    /**
     *	This class establishes a connection to a TCP server asynchronously,
     *calling back on the TCPConnectionOpenerListener interface.
     */
    class TCPConnectionOpener
