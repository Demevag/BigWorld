...
#define MERCURY_HANDLED_EMPTY_MESSAGE(NAME, HANDLERTYPE, HANDLERARG)           \
...
#define MERCURY_HANDLED_PREFIXED_EMPTY_MESSAGE(                                \
  NAME, PREFIXTYPE, HANDLERTYPE, HANDLERARG)                                   \
    HANDLER_STATEMENT(NAME, HANDLERTYPE, HANDLERARG)                           \
    MERCURY_PREFIXED_EMPTY_MESSAGE(NAME, PREFIXTYPE, HANDLER_ARGUMENT(NAME))

#define MERCURY_PREFIXED_EMPTY_MESSAGE(NAME, PREFIXTYPE, HANDLER)              \
    MERCURY_MESSAGE(NAME, FIXED_LENGTH_MESSAGE, sizeof(PREFIXTYPE), HANDLER)
...
#define MERCURY_HANDLED_PREFIXED_MESSAGE(                                      \
  NAME, PREFIXTYPE, HANDLERTYPE, HANDLERARG)                                   \
    HANDLER_STATEMENT(NAME, HANDLERTYPE, HANDLERARG)                           \
    MERCURY_PREFIXED_MESSAGE(NAME, PREFIXTYPE, HANDLER_ARGUMENT(NAME))

#define MERCURY_HANDLED_VARIABLE_MESSAGE(NAME, PARAM, HANDLERTYPE, HANDLERARG) \
    HANDLER_STATEMENT(NAME, HANDLERTYPE, HANDLERARG)                           \
    MERCURY_VARIABLE_MESSAGE(NAME, PARAM, HANDLER_ARGUMENT(NAME))

#define MERCURY_HANDLED_CALLBACK_MESSAGE(NAME, HANDLERTYPE, HANDLERARG)        \
    HANDLER_STATEMENT(NAME, HANDLERTYPE, HANDLERARG)                           \
...
#define MERCURY_STRUCT_GOODIES(NAME)                                             \
    ...
    {                                                                            \
        return *(NAME##Args*)b.startStructRequest(                               \
          NAME, handler, arg, timeout, reliable);                                \
    }                                                                            \
...
#define BEGIN_MERCURY_INTERFACE(INAME)                                         \
    namespace INAME {                                                          \
        ...
        Mercury::Reason registerWithMachined(                                  \
          ...
          int                        id)                                       \
        {                                                                      \
            return gMinder.registerWithMachined(networkInterface.address(),    \
                                                id);                           \
        }                                                                      \
                                                                               \
        Mercury::Reason registerWithMachinedAs(                                \
          ...
          int                        id)                                       \
        {                                                                      \
            return gMinder.registerWithMachinedAs(                             \
              name, networkInterface.address(), id);                           \
        }
...
#define MERCURY_STRUCT_MESSAGE(NAME, HANDLER)                                  \
    MERCURY_MESSAGE(                                                           \
      NAME, FIXED_LENGTH_MESSAGE, sizeof(struct NAME##Args), HANDLER)          \
...
#define MERCURY_PREFIXED_MESSAGE(NAME, PREFIXTYPE, HANDLER)                    \
    ...
    Mercury::Bundle& operator<<(                                               \
      Mercury::Bundle& b, const std::pair<PREFIXTYPE, struct NAME##Args>& p)   \
    {                                                                          \
        b.startMessage(NAME);                                                  \
        b << p.first;                                                          \
        b << p.second;                                                         \
...
#define MERCURY_METHOD_RANGE_MSG(NAME, RANGE_PORTION)                          \
    namespace Range {                                                          \
        ExposedMethodMessageRange NAME##Range(                                 \
          NAME.id(),                                                           \
...
#define MERCURY_PROPERTY_RANGE_MSG(NAME, RANGE_PORTION)                        \
    namespace Range {                                                          \
        ExposedPropertyMessageRange NAME##Range(                               \
          NAME.id(),                                                           \
          gMinder.addRange(NAME, RANGE_PORTION));                              \
    }
 ...
 *
 *  Note that these macros assume the object being streamed is called 'x', and
