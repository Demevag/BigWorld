...
namespace Mercury {
    ...
    class HTTPMessage
    {
      public:
        ...
        const BW::string& startLine() const { return startLine_; }
    ...
    class HTTPRequest : public HTTPMessage
    {
      public:
        ...
        const BW::string& method() const { return method_; }

        const BW::string& uri() const { return uri_; }

        const BW::string& httpVersionString() const { return httpVersion_; }
    ...
    class HTTPResponse : public HTTPMessage
    {
      public:
        ...
        const BW::string& httpVersion() const { return httpVersion_; }

        const BW::string& statusCode() const { return statusCode_; }

        const BW::string& reasonPhrase() const { return reasonPhrase_; }
