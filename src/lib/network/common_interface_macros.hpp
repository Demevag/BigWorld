...
#define BW_EMPTY_MSG(TYPE, NAME)                                               \
    MERCURY_HANDLED_EMPTY_MESSAGE(NAME, EmptyMessageHandler<TYPE>, &TYPE::NAME)

#undef BW_EMPTY_MSG_EX
#define BW_EMPTY_MSG_EX(TYPE, NAME)                                            \
    MERCURY_HANDLED_EMPTY_MESSAGE(                                             \
      NAME, EmptyMessageHandlerEx<TYPE>, &TYPE::NAME)
...
#define BW_BEGIN_STRUCT_MSG(TYPE, NAME)                                        \
    ...
    BEGIN_HANDLED_STRUCT_MESSAGE(                                              \
      NAME, USE_TYPEDEF_WORKAROUND(TYPE, NAME), &TYPE::NAME)
...
#define BW_STREAM_MSG(TYPE, NAME)                                              \
    MERCURY_HANDLED_VARIABLE_MESSAGE(                                          \
      NAME, 2, StreamMessageHandler<TYPE>, &TYPE::NAME)

#undef BW_STREAM_MSG_EX
#define BW_STREAM_MSG_EX(TYPE, NAME)                                           \
    MERCURY_HANDLED_VARIABLE_MESSAGE(                                          \
      NAME, 2, StreamMessageHandlerEx<TYPE>, &TYPE::NAME)

#undef BW_BIG_STREAM_MSG
#define BW_BIG_STREAM_MSG(TYPE, NAME)                                          \
    MERCURY_HANDLED_VARIABLE_MESSAGE(                                          \
      NAME, 4, StreamMessageHandler<TYPE>, &TYPE::NAME)

#undef BW_BIG_STREAM_MSG_EX
#define BW_BIG_STREAM_MSG_EX(TYPE, NAME)                                       \
    MERCURY_HANDLED_VARIABLE_MESSAGE(                                          \
      NAME, 4, StreamMessageHandlerEx<TYPE>, &TYPE::NAME)
