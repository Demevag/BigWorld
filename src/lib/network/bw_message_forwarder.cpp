  ...
  , pForwarder_(NULL)
{
    ...
    networkInterface.setIrregularChannelsResendPeriod(BWConfig::get(
      (path + "/irregularResendPeriod").c_str(),
    ...
    float maxSocketProcessingTime = BWConfig::get<float>(
      (path + "/maxInternalSocketProcessingTime").c_str(),
    ...
    pForwarder_.reset(new LoggerMessageForwarder(componentName,
                                                 this->watcherNub().udpSocket(),
                                                 dispatcher,
                                                 BWConfig::get("loggerID", ""),
                                                 isForwarding,
                                                 spamFilterEnabled,
                                                 spamFilterSummariesEnabled,
                                                 spamFilterThreshold));
