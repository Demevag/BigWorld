...
namespace Mercury {
    ...
    /**
     *	This method performs a send on the given channel if that channel has
     *been registered as a delayed channel. After sending the channel is removed
     *from the collection of delayed channels.
     */
