...
namespace Mercury {
    ...
    void SendingStats::init(EventDispatcher& dispatcher)
    {
        ...
        timerHandle_ = dispatcher.addTimer(
          int(1000000 * SAMPLE_RATE), this, NULL, "SendingStats");
    }
    ...
    WatcherPtr SendingStats::pWatcher()
    {
        ...
        StatWatcherCreator::addWatchers(
          pWatcher, "bytesSent", pNull->numBytesSent_);
        StatWatcherCreator::addWatchers(
          pWatcher, "bytesResent", pNull->numBytesResent_);
        StatWatcherCreator::addWatchers(
          pWatcher, "reliableBytesPiggybacked", pNull->numBytesPiggybacked_);
        StatWatcherCreator::addWatchers(
          pWatcher, "unreliableBytesDiscarded", pNull->numBytesNotPiggybacked_);
        StatWatcherCreator::addWatchers(
          pWatcher, "packetsSent", pNull->numPacketsSent_);
        StatWatcherCreator::addWatchers(
          pWatcher, "packetsResent", pNull->numPacketsResent_);
        StatWatcherCreator::addWatchers(
          pWatcher, "packetsPiggybacked", pNull->numPiggybacks_);
        StatWatcherCreator::addWatchers(
          pWatcher, "packetsSentOffChannel", pNull->numPacketsSentOffChannel_);
        StatWatcherCreator::addWatchers(
          pWatcher, "bundlesSent", pNull->numBundlesSent_);
        StatWatcherCreator::addWatchers(
          pWatcher, "messagesSent", pNull->numMessagesSent_);
        StatWatcherCreator::addWatchers(
          pWatcher, "reliableMessagesSent", pNull->numReliableMessagesSent_);
        StatWatcherCreator::addWatchers(
          pWatcher, "failedPacketSends", pNull->numFailedPacketSend_);
        StatWatcherCreator::addWatchers(
          pWatcher, "failedBundleSends", pNull->numFailedBundleSend_);
