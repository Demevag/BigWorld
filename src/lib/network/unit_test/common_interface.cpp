 ...
 */
template <class ARGS>
class CommonStructMessageHandler : public Mercury::InputMessageHandler
{
  public:
    typedef void (CommonHandler::*Handler)(const Mercury::Address& srcAddr,
                                           const ARGS&             args);
 ...
 */
class CommonStreamMessageHandler : public Mercury::InputMessageHandler
{
  public:
    typedef void (CommonHandler::*Handler)(const Mercury::Address& srcAddr,
                                           BinaryIStream&          data);
