...
namespace Mercury {
     ...
     *	Dispatcher per thread. To support more than one, this class can be used
    ...
    class DispatcherCoupling : public FrequentTask
    {
      public:
        ...
        ~DispatcherCoupling() { mainDispatcher_.cancelFrequentTask(this); }

      private:
        void doTask() { childDispatcher_.processOnce(); }
