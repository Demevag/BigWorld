...
ChunkModelVLORef::ChunkModelVLORef(WantFlags wantFlags /*= WANTS_DRAW */)
  : ChunkVLO(wantFlags)
 ...
 */
ChunkItemFactory::Result ChunkModelVLORef::create(Chunk*         pChunk,
...
ChunkItemFactory ChunkModelVLORef::factory_(ChunkModelVLORef::getSectionName(),
                                            0,
                                            ChunkModelVLORef::create);
