...
namespace ScaleformBW {
    ...
    inline void convertFromMatrix2x4(const SF::Render::Matrix2x4<float>& m,
                                     Matrix&                             ret)
    {
        ret._11 = m.M[0][0];
        ret._12 = m.M[0][1];
    ...
    inline SF::Render::Matrix2x4<float> convertToMatrix2x4(const Matrix& m)
    {
        return SF::Render::Matrix2x4<float>(
          m._11, m._12, 0.0f, m._41, m._21, m._22, 0.0f, m._42);
    }

    inline void convertFromMatrix3x4(const SF::Render::Matrix3x4<float>& m,
                                     Matrix&                             ret)
    {
        ret._11 = m.M[0][0];
        ret._12 = m.M[0][1];
    ...
    {
        return SF::Render::Matrix3x4<float>(m._11,
                                            m._12,
                                            m._13,
                                            m._41,
                                            m._21,
    ...
    PyGFxDisplayObject::PyGFxDisplayObject(PyTypePlus* pType)
      : PyGFxValue(pType)
    {
    }
