...
namespace ScaleformBW {
    ...
    void PyExternalInterface::Callback(GFx::Movie*       pmovie,
                                       const char*       command,
                                       ...
                                       UInt              argCount)
    {
        ...
        ret = Script::ask(pCallback_.getObject(),
                          pyArgs,
                          "PyExternalInterface::Callback",
                          false);
    ...
    void PyExternalInterfaceHandler::handleCallback(
      const FxDelegateArgs& pparams,
      const char*           methodName)
    {
        BW_GUARD;
        PyExternalInterfaceHandler* handler =
          (PyExternalInterfaceHandler*)pparams.GetHandler();
        PyObject* ret;
        ...
        ret = Script::ask(handler->pCallback_.getObject(),
                          pyArgs,
                          "PyExternalInterfaceHandler::Callback",
                          false);
