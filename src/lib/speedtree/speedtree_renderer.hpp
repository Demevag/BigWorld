...
namespace speedtree {
    ...
    //-- Single instance of a speedtree in the world. Each tree chunk item in
    //the space will own an
    //-- instance of SpeedTreeRenderer. SpeedTreeRenderer on its turn, will
    //point to a shared TSpeedTreeType
    ...
    class SpeedTreeRenderer
    {
      ...
      public:
        ...
        //-- These three method is all what you need to draw speedtree models.
        //Before scene traversing
        //-- we set once beginFrame and at the end of traversing we call
        //endFrame to inform speedtree
        //-- sub-system that it can perform drawing.
        //-- Notice: We can also invoke flush method to make speedtree perform
        //drawing immediately.
        //--		 But be careful with this method because it breaks common
        //speedtree's rendering
        //--	     optimization like material sorting and instancing.
        //-- lodCamera here means camera based on which speedtree calculates
        //tree's lods.
        static void beginFrame(EnviroMinder*           envMinder,
        ...
        void getTexturesAndVertices(BW::map<void*, int>& textures,
