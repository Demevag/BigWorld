...
typedef BW::map<ChunkWaypointSetPtr, ChunkBoundary::Portal*> ChunkWaypointConns;
...
typedef BW::unordered_map<EdgeIndex, EdgeLabel> ChunkWaypointEdgeLabels;
  ...
  , public ChunkWaypointVertexProvider
{
  ...
  public:
     ...
     */
    WaypointIndex find(const WaypointSpaceVector3& point,
     ...
     */
    float girth() const { return pSetData_->girth(); }
     ...
     */
    ChunkWaypointConns::iterator connectionsEnd() { return connections_.end(); }
  ...
  private:
    ...
    void connect(ChunkWaypointSetPtr    pWaypointSet,
