...
bool BigworldInputDevice::down(const bool* keyDownTable, const BW::string& key)
{
    ...
    return left.empty()
             ? (nameMap_.find(key) != nameMap_.end() &&
                keyDownTable[nameMap_[key]])
  ...
  : keyDownTable_(keyDownTable)
{
    ...
    if (keyMap_.empty()) {
        keyMap_['0'] = KeyCode::KEY_0, keyMap_['1'] = KeyCode::KEY_1,
        keyMap_['2'] = KeyCode::KEY_2, keyMap_['3'] = KeyCode::KEY_3,
        keyMap_['4'] = KeyCode::KEY_4, keyMap_['5'] = KeyCode::KEY_5,
        keyMap_['6'] = KeyCode::KEY_6, keyMap_['7'] = KeyCode::KEY_7,
        keyMap_['8'] = KeyCode::KEY_8, keyMap_['9'] = KeyCode::KEY_9;

        keyMap_['A'] = KeyCode::KEY_A, keyMap_['B'] = KeyCode::KEY_B,
        keyMap_['C'] = KeyCode::KEY_C, keyMap_['D'] = KeyCode::KEY_D,
        keyMap_['E'] = KeyCode::KEY_E, keyMap_['F'] = KeyCode::KEY_F,
        keyMap_['G'] = KeyCode::KEY_G, keyMap_['H'] = KeyCode::KEY_H,
        keyMap_['I'] = KeyCode::KEY_I, keyMap_['J'] = KeyCode::KEY_J,
        keyMap_['K'] = KeyCode::KEY_K, keyMap_['L'] = KeyCode::KEY_L,
        keyMap_['M'] = KeyCode::KEY_M, keyMap_['N'] = KeyCode::KEY_N,
        keyMap_['O'] = KeyCode::KEY_O, keyMap_['P'] = KeyCode::KEY_P,
        keyMap_['Q'] = KeyCode::KEY_Q, keyMap_['R'] = KeyCode::KEY_R,
        keyMap_['S'] = KeyCode::KEY_S, keyMap_['T'] = KeyCode::KEY_T,
        keyMap_['U'] = KeyCode::KEY_U, keyMap_['V'] = KeyCode::KEY_V,
        keyMap_['W'] = KeyCode::KEY_W, keyMap_['X'] = KeyCode::KEY_X,
        keyMap_['Y'] = KeyCode::KEY_Y, keyMap_['Z'] = KeyCode::KEY_Z;

        keyMap_[','] = KeyCode::KEY_COMMA, keyMap_['.'] = KeyCode::KEY_PERIOD,
        keyMap_['/']  = KeyCode::KEY_SLASH,
        keyMap_[';']  = KeyCode::KEY_SEMICOLON,
        keyMap_['\''] = KeyCode::KEY_APOSTROPHE,
        keyMap_['[']  = KeyCode::KEY_LBRACKET,
        keyMap_[']'] = KeyCode::KEY_RBRACKET, keyMap_['`'] = KeyCode::KEY_GRAVE,
        keyMap_['-'] = KeyCode::KEY_MINUS, keyMap_['='] = KeyCode::KEY_EQUALS,
        keyMap_['\\'] = KeyCode::KEY_BACKSLASH;

        keyMap_[' '] = KeyCode::KEY_SPACE;

        nameMap_["LSHIFT"] = KeyCode::KEY_LSHIFT,
        nameMap_["RSHIFT"] = KeyCode::KEY_RSHIFT;
        nameMap_["LCTRL"]  = KeyCode::KEY_LCONTROL,
        nameMap_["RCTRL"]  = KeyCode::KEY_RCONTROL;
        nameMap_["LALT"]   = KeyCode::KEY_LALT,
        nameMap_["RALT"]   = KeyCode::KEY_RALT;
        nameMap_["LWIN"]   = KeyCode::KEY_LWIN,
        nameMap_["RWIN"]   = KeyCode::KEY_RWIN;
        ...
        nameMap_["NUM0"] = KeyCode::KEY_NUMPAD0,
        nameMap_["NUM1"] = KeyCode::KEY_NUMPAD1,
        nameMap_["NUM2"] = KeyCode::KEY_NUMPAD2,
        nameMap_["NUM3"] = KeyCode::KEY_NUMPAD3,
        nameMap_["NUM4"] = KeyCode::KEY_NUMPAD4,
        nameMap_["NUM5"] = KeyCode::KEY_NUMPAD5,
        nameMap_["NUM6"] = KeyCode::KEY_NUMPAD6,
        nameMap_["NUM7"] = KeyCode::KEY_NUMPAD7,
        nameMap_["NUM8"] = KeyCode::KEY_NUMPAD8,
        nameMap_["NUM9"] = KeyCode::KEY_NUMPAD9;

        nameMap_["NUMMINUS"]  = KeyCode::KEY_NUMPADMINUS,
        nameMap_["NUMPERIOD"] = KeyCode::KEY_NUMPADPERIOD,
        nameMap_["NUMADD"]    = KeyCode::KEY_ADD,
        nameMap_["NUMSTAR"]   = KeyCode::KEY_NUMPADSTAR,
        nameMap_["NUMENTER"]  = KeyCode::KEY_NUMPADENTER,
        nameMap_["NUMSLASH"]  = KeyCode::KEY_NUMPADSLASH,
        nameMap_["NUMRETURN"] = KeyCode::KEY_NUMPADENTER;

        nameMap_["RETURN"] = KeyCode::KEY_RETURN,
        nameMap_["ENTER"]  = KeyCode::KEY_RETURN,
        nameMap_["TAB"]    = KeyCode::KEY_TAB,
        nameMap_["ESCAPE"] = KeyCode::KEY_ESCAPE;
        ...
        nameMap_["UP"]    = KeyCode::KEY_UPARROW,
        nameMap_["DOWN"]  = KeyCode::KEY_DOWNARROW,
        nameMap_["LEFT"]  = KeyCode::KEY_LEFTARROW,
        nameMap_["RIGHT"] = KeyCode::KEY_RIGHTARROW;

        nameMap_["INSERT"]    = KeyCode::KEY_INSERT,
        nameMap_["HOME"]      = KeyCode::KEY_HOME,
        nameMap_["PAGEUP"]    = KeyCode::KEY_PGUP,
        nameMap_["PAGEDOWN"]  = KeyCode::KEY_PGDN;
        nameMap_["DELETE"]    = KeyCode::KEY_DELETE,
        nameMap_["END"]       = KeyCode::KEY_END,
...
bool BigworldInputDevice::isKeyDown(const BW::string& key)
{
    ...
    NUM0, NUM1, ..., NUM9, NUMMINUS, NUMPERIOD, NUMADD, NUMSTAR, NUMENTER,
    NUMSLASH, RETURN, ENTER, TAB, ESCAPE, F1, F2, F3, F4, ..., F12, UP, DOWN,
    LEFT, RIGHT, INSERT, HOME, PAGEUP, PAGEDOWN, DELETE, END, BACKSPACE
    ***********************************************************************/
    ...
    if (keyname.size() && shortcut.size()) {
        ...
        if (!lastKeydown && keyname.size() == 1 &&
            down(lastKeyDown, keyname[0]))
            lastKeydown = true;
        if (keydown && !lastKeydown) {
            size_t totalKeyNum = std::count(
              keyDownTable_, keyDownTable_ + KeyCode::KEY_MAXIMUM_KEY, true);
...
bool Win32InputDevice::isKeyDown(const BW::string& key)
{
    ...
    if (shortcut.length() > 0)
        _strupr(
          &shortcut[0]); // not safe, but we already handled zero lenght string
...
static LRESULT CALLBACK GUIKeyboadProc(int nCode, WPARAM wParam, LPARAM lParam)
{
    ...
    if (nCode == HC_ACTION && (lParam & 0xc0000000) == 0) {
        ...
        if (wcsncmp(className, L"Edit", 4) != 0 && // Don't process for edit box
            ...
            inputWasProcessed =
              GUI::Manager::instance().processInput(&inputDevice);
        }
    }
...
void Win32InputDevice::install()
{
    ...
    s_hook =
      SetWindowsHookEx(WH_KEYBOARD, GUIKeyboadProc, NULL, GetCurrentThreadId());
}
