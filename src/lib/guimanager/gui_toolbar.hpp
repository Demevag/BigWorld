...
// basically, we doesn't manage the toolbar resource, the application should do
// that we just fill it with different buttons
class Toolbar : public Subscriber
{
    ...
    static LRESULT                  subclassProc(HWND   hwnd,
                                                 UINT   msg,
                                                 WPARAM wparam,
                                                 LPARAM lparam);
  ...
  protected:
    ...
    virtual void    updateSeparator(unsigned int& index,
                                    ItemPtr       item,
                                    TBBUTTONINFO& info);
    virtual void    updateGroup(unsigned int& index,
                                ItemPtr       item,
                                TBBUTTONINFO& info);
    virtual void    updateAction(unsigned int& index,
                                 ItemPtr       item,
                                 TBBUTTONINFO& info);
    virtual void    updateToggle(unsigned int& index,
                                 ItemPtr       item,
                                 TBBUTTONINFO& info);
    virtual void    updateChoice(unsigned int& index,
                                 ItemPtr       item,
                                 TBBUTTONINFO& info);
    virtual void    updateExpandedChoice(unsigned int& index,
                                         ItemPtr       item,
                                         TBBUTTONINFO& info);
  ...
  public:
    ...
    static bool              createToolbars(const BW::string  appTbsSection,
