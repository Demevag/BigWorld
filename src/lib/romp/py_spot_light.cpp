...
namespace BW {
     ...
     * PySpotLight does not require this to be called.
     *  @return None.
     */
     ...
     *  The direction of the light source. This is overwritten with the output
     * of the source attribute if it has been specified.
     *  @type Read-Write Vector3
     */
     ...
     *  Creates a new PySpotLight. This is a script controlled spot light which
    ...
    {
        pLightEmbodiment_ =
          SpaceManager::instance().createSpotLightEmbodiment(*this);
    }
