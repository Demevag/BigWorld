 ...
 */
void StarDome::init(void)
{
#error("DONT USE STAR DOME NO MORE" )
    BW::string visualName =
      "objects/models/level/general/Gen_StarDome.static.visual";
    ...
    if (visual_) {
        texture_ = Moo::TextureManager::instance()->get(
          "maps/fx/environment/star_one.bmp");
        ...
        CRITICAL_MSG(
          "StarDome::init - Could not load Gen_StarDome.static.visual");
