...
static ResourceRef getIfLoaded_dsect(const BW::string& id)
{
    ...
    return ResourceRef(
      &*pDS, ResourceRef::stdModRef<DataSection>, id, pyInstance_dsect);
}
...
static ResourceRef::ResourceFns s_RFns_dsect = { &getIfLoaded_dsect,
                                                 &getOrLoad_dsect };
...
static ResourceRef getIfLoaded_model(const BW::string& id)
{
    ...
    return ResourceRef(
      &*pModel, ResourceRef::stdModRef<Model>, id, pyInstance_model);
}
...
static ResourceRef::ResourceFns s_RFns_model = { &getIfLoaded_model,
                                                 &getOrLoad_model };
...
{
    BW_GUARD;
    Moo::VisualPtr pVisual = Moo::VisualManager::instance()->get(id, false);
    return ResourceRef(
      &*pVisual, ResourceRef::stdModRef<Moo::Visual>, id, NULL);
}

static ResourceRef getOrLoad_visual(const BW::string& id)
{
    BW_GUARD;
    Moo::VisualPtr pVisual = Moo::VisualManager::instance()->get(id);
    return ResourceRef(
      &*pVisual, ResourceRef::stdModRef<Moo::Visual>, id, NULL);
}

static ResourceRef::ResourceFns s_RFns_visual = { &getIfLoaded_visual,
                                                  &getOrLoad_visual };
...
static ResourceRef getIfLoaded_texture(const BW::string& id)
{
    ...
    return ResourceRef(&*pTex,
                       ResourceRef::stdModRef<Moo::BaseTexture>,
                       id,
                       &pyInstance_texture);
}
...
{
    BW_GUARD;
    Moo::BaseTexturePtr pTex = Moo::TextureManager::instance()->get(id);
    return ResourceRef(&*pTex,
                       ResourceRef::stdModRef<Moo::BaseTexture>,
                       id,
                       &pyInstance_texture);
...
static ResourceRef::ResourceFns s_RFns_texture = { &getIfLoaded_texture,
                                                   &getOrLoad_texture };
...
static ResourceRef::ResourceFns s_RFns_font = { &getIfLoaded_font,
                                                &getOrLoad_font };
...
static ResourceRef getIfLoaded_particle(const BW::string& id)
{
    ...
    return ResourceRef(&*pSystem,
                       ResourceRef::stdModRef<MetaParticleSystem>,
                       id,
                       &pyInstance_particle);
}
...
{
    BW_GUARD;
    MetaParticleSystemPtr pSystem =
      ParticleSystemManager::instance().loader().load(id);
    return ResourceRef(&*pSystem,
                       ResourceRef::stdModRef<MetaParticleSystem>,
                       id,
                       pyInstance_particle);
...
static ResourceRef::ResourceFns s_RFns_particle = { &getIfLoaded_particle,
                                                    &getOrLoad_particle };
...
static ResourceRef::ResourceFns s_RFns_lensEffect = { &getIfLoaded_lensEffect,
                                                      &getOrLoad_lensEffect };
...
static ResourceRef getIfLoaded_fx(const BW::string& id)
{
    ...
    return ResourceRef(
      NULL, ResourceRef::stdModRef<Moo::EffectMaterial>, id, &pyInstance_fx);
}
...
static ResourceRef getOrLoad_fx(const BW::string& id)
{
    ...
    return ResourceRef(pMat.getObject(),
                       ResourceRef::stdModRef<Moo::EffectMaterial>,
                       id,
                       pyInstance_fx);
}

static ResourceRef::ResourceFns s_RFns_fx = { &getIfLoaded_fx, &getOrLoad_fx };
