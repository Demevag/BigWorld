...
namespace BW {
     ...
     *  the PyOmniLight. If the distance is less than innerRadius, then the
     ...
     */
    /**
     * The intention of the PyOmniLight class is to wrap both chunk-based
      ...
      , public IOmniLight
    {
        Py_Header(PyOmniLight, PyObjectPlusWithVD)
          ...
          public : PyOmniLight(PyTypeObject* pType = &s_type_);
        virtual ~PyOmniLight();
    ...
    {
        Py_Header(PyChunkLight, PyOmniLight) public
