...
namespace Math {
    ...
    /**
     *  This templated class implements a simple polygon container. At the
     * moment, it's useful for Vector2 polygon intersection.
     */
    ...
    class Polygon
    {
      ...
      private:
        ...
        /**
         *  This helper method projects all points from the poly onto the
         * separation line, and returns the minimum and maximum position after
         * projection. Used when testing intersection in 'intersects', using the
         ...
         *  @see intersects
         */
        std::pair<float, float> calcMinMax(
          const PointType& separationLine) const
        {
