...
TEST(StatWithRatesOfChange)
{
    ...
    CHECK_CLOSE(
      stat.getRateOfChange(0), 0.95f * CHANGE_SIZE / TICK_SIZE, 0.001f);
    ...
    CHECK_CLOSE(
      stat.getRateOfChange(1), 0.95f * CHANGE_SIZE / TICK_SIZE, 0.001f);
    ...
    CHECK_CLOSE(
      stat.getRateOfChange(2), 0.95f * CHANGE_SIZE / TICK_SIZE, 0.001f);
}
