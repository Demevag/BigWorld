...
namespace {
    ...
    /**
     *	This class helps with the creation of Watchers for StatWithRatesOfChange
     *instances.
     */
    class StatWatcherCreatorImpl
    {
      ...
      protected:
        /**
         *	This method is used to add a rate of change. Stats that are
         *initialised with this instance will have an appropriate rate added
         *with the watcher appropriately named.
         *
        ...
        void addAvgWatchers(WatcherPtr pWatcher, const char* name, TYPE& stat)
        {
            ...
            for (Entries::size_type i = 0; i < entries_.size(); ++i) {
                ...
                bw_snprintf(buf,
                            ...
                            entry.first.c_str(),
                            name);
                pWatcher->addChild(buf, makeWatcher(stat, fns[i]));
            }
        }
    ...
    /**
     *	This class is the standard for initialising StatWithRatesOfChange
     *instances.
     */
    class StandardWatcherCreator : public StatWatcherCreatorImpl
    {
      public:
        StandardWatcherCreator()
        {
            ...
            this->initRateOfChange("averages/medium",
                                   600.0f); // 10 minutes at 95%
            this->initRateOfChange("averages/long",
                                   3600.0f); // 60 minutes at 95%
        }
    };
