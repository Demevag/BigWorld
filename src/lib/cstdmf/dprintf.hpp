...
CSTDMF_DLL void dprintf(DebugMessagePriority messagePriority,
                        const char*          category,
                        const char*          format,
...
CSTDMF_DLL void vdprintf(const char* format,
                         va_list     argPtr,
...
inline void vdprintf(const char* format,
                     va_list     argPtr,
                     const char* pPriorityName = NULL,
                     const char* pCategory     = NULL)
{
