    ...
    class StackAllocator : public IAllocator
    {
      public:
        struct SourceBuffer
        {
            ...
            {
                if (pMemory > &buffer_[CAPACITY] || pMemory < &buffer_[0]) {
                    return false;
                }
      ...
      public:
        ...
        void setCanAllocate(bool canAllocate) { canAllocate_ = canAllocate; }

        bool canAllocate() { return canAllocate_; }

        size_t getMaxSize() const { return CAPACITY + 1; }
