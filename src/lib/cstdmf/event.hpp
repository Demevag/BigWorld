...
class Event
{
  ...
  public:
    ...
    class EventDelegateList
    {
      public:
        ...
        void add(TargetType* pTarget)
        {
            ...
            EventDelegate del =
              EventDelegate::template fromMethod<TargetType, pMemberFunc>(
                pTarget);
        ...
        void remove(TargetType* pTarget)
        {
            ...
            EventDelegate del =
              EventDelegate::template fromMethod<TargetType, pMemberFunc>(
                pTarget);
            delegates_.erase(
              std::remove(delegates_.begin(), delegates_.end(), del),
              delegates_.end());
        }
      ...
      private:
        ...
        void beginIteration() const { isIterating_ = true; }

        void endIteration() const { isIterating_ = false; }
     ...
     * call 'invoke'.
     */
    EventDelegateList& delegates() { return list_; }
