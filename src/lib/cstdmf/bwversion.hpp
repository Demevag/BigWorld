...
#define BW_COPYRIGHT_NOTICE                                                    \
    "(c) 1999 - 2014, BigWorld Pty. Ltd. All Rights Reserved"

#define STRINGIFY(X) #X
#define TOSTRING(X) STRINGIFY(X)

#define BW_VERSION_MSVC_RC BW_VERSION_MAJOR, BW_VERSION_MINOR, BW_VERSION_PATCH
#define BW_VERSION_MSVC_RC_STRING                                              \
    TOSTRING(BW_VERSION_MAJOR.BW_VERSION_MINOR.BW_VERSION_PATCH)
