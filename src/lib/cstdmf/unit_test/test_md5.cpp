...
TEST(MD5_message_digest)
{
    ...
    hash.append("message digest", static_cast<int>(strlen("message digest")));
    MD5::Digest digest = hash;
...
TEST(
  MD5_12345678901234567890123456789012345678901234567890123456789012345678901234567890)
{
    MD5 hash;

    const char TEST_STR[] = "123456789012345678901234567890"
