...
namespace {
    ...
    class OverloadedNewWithArgClass
    {
      public:
        ...
        static bool overloadNewCalled() { return s_overloadNewCalled_; }

        static bool overloadDelCalled() { return s_overloadNewCalled_; }
...
#pragma warning(disable : 4291)
    ...
    /*static */ bool OverloadedWithArgClassDisableWarn::s_overloadNewCalled_ =
      false;
    /*static */ bool OverloadedWithArgClassDisableWarn::s_overloadDelCalled_ =
      false;
...
TEST(MemoryDebug_testCounts)
{
    ...
    OverloadedNewNoArgClass* obj3 = new OverloadedNewNoArgClass(); // 8 bytes
...
TEST(MemoryDebug_testSmartPointerCounts)
{
    ...
    BW::Allocator::readSmartPointerStats(overallBaseLine);
    {
        ...
        pObj->incRef();
        spObjA = TestObjectPtr(
          pObj, TestObjectPtr::STEAL_REFERENCE); // +3 assign, +1 current (2
                                                 // temp assigns included)
