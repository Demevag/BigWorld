...
namespace BW {
    ...
    class unordered_set
      : public std::tr1::unordered_set<Key, Hash, KeyEqual, Allocator>
    {
        typedef std::tr1::unordered_set<Key, Hash, KeyEqual, Allocator>
          type_base;
    ...
    class unordered_multiset
      : public std::tr1::unordered_multiset<Key, Hash, KeyEqual, Allocator>
    {
        typedef std::tr1::unordered_multiset<Key, Hash, KeyEqual, Allocator>
          type_base;
      ...
      public:
        ...
        template <class InputIt>
        unordered_multiset(InputIt          first,
                           InputIt          last,
                           size_type        bucket_count,
                           const Hash&      hash  = Hash(),
                           const KeyEqual&  equal = KeyEqual(),
