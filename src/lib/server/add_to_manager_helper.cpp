 ...
 *  Constructor.
 */
AddToManagerHelper::AddToManagerHelper(Mercury::EventDispatcher& dispatcher)
 ...
 */
void AddToManagerHelper::handleMessage(const Mercury::Address&         source,
                                       ...
                                       void*                           arg)
{
    if (data.remainingLength()) {
        ...
        resendTimerHandle_ = dispatcher_.addOnceOffTimer(
          1000000, this, reinterpret_cast<void*>(TIMEOUT_RESEND));
    }
}
 ...
 */
void AddToManagerHelper::handleException(const Mercury::NubException& exception,
                                         void*                        arg)
{
...
{
    fatalTimerHandle_.cancel();
    fatalTimerHandle_ = dispatcher_.addOnceOffTimer(
      5000000, this, reinterpret_cast<void*>(TIMEOUT_FATAL));
