...
class MiniBackupHash
{
  ...
  private:
    ...
    friend BinaryIStream& operator>>(BinaryIStream& b, MiniBackupHash& hash);
};
...
class BackupHash : public MiniBackupHash
{
  ...
  private:
    ...
    friend BinaryOStream& operator<<(BinaryOStream& b, const BackupHash& hash);
...
inline BinaryOStream& operator<<(BinaryOStream& b, const MiniBackupHash& hash)
{
