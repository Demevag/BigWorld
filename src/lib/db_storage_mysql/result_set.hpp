...
inline bool getValueFromString(const char* str, int len, BW::string& value)
{
...
template <class VALUE_TYPE>
bool getValueFromString(const char*              str,
                        int                      len,
...
class ResultSet
{
  public:
    ...
    bool getResult(ARG0& arg0, ARG1& arg1, ARG2& arg2, ARG3& arg3)
    {
    ...
    bool getResult(ARG0& arg0, ARG1& arg1, ARG2& arg2, ARG3& arg3, ARG4& arg4)
    {
...
class ResultRow
{
  public:
    ...
    bool getField(int fieldNum, TYPE& value) const
    {
        ...
        return getValueFromString(row_[fieldNum], lengths_[fieldNum], value);
    }
...
class ResultStream
{
  public:
    ...
    bool eof() const
    {
        return !error_ && (currField_ == resultRow_.numFields());
    }
