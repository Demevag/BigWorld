...
class LoginRequestProtocol : public ReferenceCount
{
  public:
     ...
     */
    virtual const Mercury::Address& address(LoginHandler& handler) const = 0;
     ...
     */
    virtual void onReply(LoginRequest& request, BinaryIStream& data) const = 0;
