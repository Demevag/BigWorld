                                 ...
                                 BinaryOStream* pSignature) const
{
    ...
    ChecksumOStream stream(rawStream,
                           pChecksumScheme_,
                           /* shouldReset */ false);
...
{
    ChecksumIStream stream(rawStream,
                           pChecksumScheme_,
                           /* shouldReset */ false);
...
void ReplayMetaData::add(const BW::string& key, const BW::string& value)
{
    ...
    streamSize_ +=
      static_cast<StreamSize>(this->calculateStringPackedSize(key) +
 ...
 */
bool ReplayMetaData::checkSufficientLength(const void* data,
                                           size_t      length,
