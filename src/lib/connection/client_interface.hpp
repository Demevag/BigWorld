...
#define MF_EMPTY_CLIENT_MSG(NAME)                                              \
    MERCURY_HANDLED_EMPTY_MESSAGE(                                             \
      NAME, ClientMessageHandler<void>, &ServerConnection::NAME)
...
#define MF_VARLEN_CLIENT_MSG(NAME)                                             \
    MERCURY_HANDLED_VARIABLE_MESSAGE(                                          \
      NAME, 2, ClientVarLenMessageHandler, &ServerConnection::NAME)

#undef MF_VARLEN_CLIENT_MSG_EX
#define MF_VARLEN_CLIENT_MSG_EX(NAME)                                          \
    MERCURY_HANDLED_VARIABLE_MESSAGE(                                          \
      NAME, 2, ClientVarLenMessageHandlerEx, &ServerConnection::NAME)

#undef MF_CALLBACK_MSG
#define MF_CALLBACK_MSG(NAME)                                                  \
    MERCURY_HANDLED_CALLBACK_MESSAGE(                                          \
      NAME,                                                                    \
