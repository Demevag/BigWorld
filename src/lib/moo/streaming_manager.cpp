...
namespace Moo {
      ...
      , numConcurrentTasks_(0)
    {
        ...
        diskBandwidthMonitor_.setQuotaPerSecond(diskBandwidthMB_ * 1024.0f *
                                                1024.0f);
    ...
    void StreamingManager::reportCompletion(BaseStreamingTask* pTask)
    {
        ...
        diskBandwidthMonitor_.reportQuotaUsage(bandwidthUsed -
                                               bandwidthEstimate);
    }
    ...
    void StreamingManager::queueTask(BaseStreamingTask* pTask)
    {
        ...
        if (remainingQuota > 0.0f &&
            numConcurrentTasks_ < maxConcurrentTasks_ && queue_.empty()) {
    ...
    void StreamingManager::tick()
    {
        ...
        diskBandwidthUsedMB_ =
          diskBandwidthMonitor_.currentUsage() * bytesToMegaBytesConversion;
    ...
    StreamingManager::QuotaMonitor::QuotaMonitor()
      : quotaPerSecond_(1024.0f * 1024.0f * 1024.0f)
      , // 1 TB
      lastTickTime_(0.0f)
      , usedQuota_(0.0f)
    {
