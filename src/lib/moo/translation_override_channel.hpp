...
namespace Moo {
    ...
    {
      public:
        TranslationOverrideChannel(const Vector3&      translation,
                                   bool                override,
                                   AnimationChannelPtr pBaseChannel,
                                   AnimationPtr        pBaseAnim);
        ...
        void                pBaseChannel(AnimationChannelPtr pChannel)
        {
            pBaseChannel_ = pChannel;
