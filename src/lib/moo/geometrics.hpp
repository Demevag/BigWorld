...
class Geometrics
{
  public:
    ...
    // Always use texturedWorldLoftSegment by enclosing many lines in a
    // begin/end block
    static bool beginLoft(uint32 nSegments = 0);
    static void texturedWorldLoftSegment(const Vector3&           shapeRay,
    ...
    static void drawLinesInClip(
      Vector2*           points,
      uint               count,
      const Moo::Colour& colour = Moo::Colour(1, 0, 0, 0));

    static void drawLinesInWorld(
      Vector3*           points,
      uint               count,
      const Moo::Colour& colour = Moo::Colour(1, 0, 0, 0));
  ...
  public:
    ...
    static void addLineWorld(const Vector3&     start,
                             const Vector3&     end,
                             const Moo::Colour& colour,
                             bool               alwaysDraw = true);
