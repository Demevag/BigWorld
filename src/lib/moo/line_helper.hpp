...
class LineHelper
{
  public:
    ...
    void drawLine(const Vector3&    start,
                  const Vector3&    end,
    ...
    void drawStar(const Vector3&    centre,
                  float             radius       = 1.0f,
    ...
    void drawLineStrip(const Vector3*    points,
                       uint32            length,
                       Moo::PackedColour colour = Moo::PackedColours::WHITE,
                       uint32            life   = 0);

    // draw a triangle
    void drawTriangle(const Vector3&    v0,
                      const Vector3&    v1,
                      const Vector3&    v2,
                      Moo::PackedColour colour = Moo::PackedColours::WHITE,
                      uint32            life   = 0);
