...
namespace Moo {
    ...
    {
      public:
        LightContainer(const LightContainerPtr& pLC,
                       const BoundingBox&       bb,
                       bool                     limitToRenderable = false);
        LightContainer();
        ~LightContainer();
        ...
        void init(const LightContainerPtr& pLC,
                  const BoundingBox&       bb,
                  bool                     limitToRenderable);

        void addToSelfOnlyVisibleLights(const LightContainerPtr& pLC,
                                        const Matrix&            camera);
        void addToSelf(const LightContainerPtr& pLC,
                       bool                     addOmnis        = true,
                       bool                     addSpots        = true,
                       bool                     addDirectionals = true);
        void addToSelf(const LightContainerPtr& pLC,
                       const BoundingBox&       bb,
                       bool                     limitToRenderable);
        ...
        bool   addDirectional(const DirectionalLightPtr& pDirectional,
        ...
        bool addLight(const DirectionalLightPtr& pDir,
                      bool                       checkExisting = false);
