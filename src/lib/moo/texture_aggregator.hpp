...
namespace Moo {
     ...
     *
     *	Currently, the TextureAggregator is limited to tiles of power of two
     *size and, although supported, non-square tiles are stretched to be square
     *and may present some visual artifacts.
     */
