      ...
      public:
        ...
        bool reset(int bufferSize)
        {
            ...
            if (bufferSize == 0) {
                ...
                HRESULT hr   = this->ibuffer_.create(bufferSize,
                                                   D3DFMT_INDEX16,
                                                   0,
                                                   D3DPOOL_MANAGED,
        ...
        bool dump(unsigned short* dst)
        {
            ...
            if (ir.valid()) {
                memcpy(dst,
                       ir.indices(),
                       this->bufferSize_ * sizeof(unsigned short));
                this->ibuffer_.unlock();
                result = true;
            }
            return result;
         ...
         */
        const_iterator begin() const { return this->cdata_; }

        /**
         *	Returns an iterator to one past last element in buffer.
         */
        iterator end() { return this->data_ + this->bufferSize_; }

        /**
         *	Returns an iterator to one past last element in buffer (const
         *version).
         */
        const_iterator end() const { return this->cdata_ + this->bufferSize_; }
         ...
         */
        int size() const { return this->bufferSize_; }
         ...
         */
        bool isValid() const { return this->ibuffer_.valid(); }
         ...
         */
        static void deactivate() { IndexBuffer().set(); }
