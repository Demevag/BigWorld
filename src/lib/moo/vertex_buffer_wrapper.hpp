    ...
    class VertexBufferWrapper : public SafeReferenceCount
    {
      public:
        ...
        bool lock()
        {
            ...
            bool    result = true;
            HRESULT hr     = this->vbuffer_.lock(
              0, 0, reinterpret_cast<void**>(&this->data_), 0);
            if (FAILED(hr)) {
                this->data_ = NULL;
                result      = false;
            }
        ...
        bool lock() const
        {
            ...
            HRESULT      hr =
              this->vbuffer_.lock(0, 0, reinterpret_cast<void**>(&cdata), 0);
            if (FAILED(hr)) {
                cdata  = NULL;
                result = false;
            }
         ...
         */
        bool isLocked() const { return this->cdata_ != NULL; }
