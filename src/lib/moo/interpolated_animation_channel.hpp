...
namespace Moo {
    ...
    class InterpolatedAnimationChannel : public AnimationChannel
    {
      public:
        ...
        InterpolatedAnimationChannel(bool canCompress            = true,
                                     bool readCompressionFactors = false);
        InterpolatedAnimationChannel(const InterpolatedAnimationChannel& other);
        ~InterpolatedAnimationChannel();

        virtual bool compareChannel(
        ...
        void reduceKeyFrames(float cosAngleError,
                             float scaleError,
                             float positionError);
        /* Factors specify the amount of frames to keep: 1 = all, 0 = none */
        void reduceKeyFramesTo(float rotationFactor,
                               float scaleFactor,
        ...
        float positionCompressionError() const
        {
            return positionCompressionError_;
        }
        void positionCompressionError(float f)
        {
            positionCompressionError_ = f;
        }
        float rotationCompressionError() const
        {
            return rotationCompressionError_;
        }
        void rotationCompressionError(float f)
        {
            rotationCompressionError_ = f;
        }
      ...
      private:
        ...
        InterpolatedAnimationChannel& operator=(
          const InterpolatedAnimationChannel&);
