...
namespace Moo {
    ...
    //-- Represents full-screen quad, which is commonly used for
    //post-processing's tasks.
    //-- It was automatically adjusted by a half pixel offset for the current
    //screen resolution.
    //----------------------------------------------------------------------------------------------
    class FullscreenQuad : public DeviceCallback
    {
      ...
      public:
        ...
        void clearChannel(const Vector4& color,
