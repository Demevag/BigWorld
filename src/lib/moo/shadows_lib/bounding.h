...
namespace math_helpers {
    ...
    struct ConvexHull2D
    {
        ...
        static float isLeft(const D3DXVECTOR2& p0,
    ...
    struct BoundingBox
    {
        ...
        explicit BoundingBox(const BW::vector<D3DXVECTOR3>* points)
          : minPt(1e33f, 1e33f, 1e33f)
          , maxPt(-1e33f, -1e33f, -1e33f)
        {
        ...
        explicit BoundingBox(const BW::vector<BoundingBox>* boxes)
          : minPt(1e33f, 1e33f, 1e33f)
          , maxPt(-1e33f, -1e33f, -1e33f)
        {
        ...
        bool Intersect(float*             hitDist,
                       const D3DXVECTOR3* origPt,
                       const D3DXVECTOR3* dir);

        D3DXVECTOR3 Point(int i) const
        {
            return D3DXVECTOR3((i & 1) ? minPt.x : maxPt.x,
                               (i & 2) ? minPt.y : maxPt.y,
                               (i & 4) ? minPt.z : maxPt.z);
        }
    };
    ...
    struct BoundingCone
    {
        ...
        BoundingCone(const BW::vector<BoundingBox>* boxes,
                     const D3DXMATRIX*              projection,
                     const D3DXVECTOR3*             _apex);
        BoundingCone(const BW::vector<BoundingBox>* boxes,
                     const D3DXMATRIX*              projection,
                     const D3DXVECTOR3*             _apex,
                     const D3DXVECTOR3*             _direction);
        BoundingCone(const BW::vector<D3DXVECTOR3>* points,
                     const D3DXVECTOR3*             _apex,
                     const D3DXVECTOR3*             _direction);
    };
