...
namespace Moo {
    ...
    class Material
    {
      public:
        ...
        {
            return (channelFlags_ & channelMask_) | channelOn_;
        }
        ...
        void diffuseTexture(BaseTexturePtr texture)
        {
        ...
        void readTextureStageSection(Moo::TextureStage& t,
                                     DataSectionPtr     spSection);
        void initTextureStagesFromSingleTextureName(
          const BW::string& textureFile);
        BW::vector<class TextureStage>& textureStages()
        {
