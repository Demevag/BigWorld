...
#pragma pack(push, 1)
    ...
    struct VertexXYZNUVPC
    {
        ...
        VertexXYZNUVPC(const VertexXYZNUV& in) { *this = in; }
    ...
    struct VertexXYZNUV2PC
    {
        ...
        VertexXYZNUV2PC(const VertexXYZNUV2& in) { *this = in; }
    ...
    struct VertexXYZNUVIPC
    {
        ...
        VertexXYZNUVIPC(const VertexXYZNUVI& in) { *this = in; }
    ...
    struct VertexXYZNUVTBPC
    {
        ...
        VertexXYZNUVTBPC(const VertexXYZNUVTB& in) { *this = in; }
        ...
        VertexXYZNUVTBPC(const VertexXYZNUV& in) { *this = in; }
        VertexXYZNUVTBPC() {}
    };
    ...
    struct VertexXYZNUV2TBPC
    {
        ...
        VertexXYZNUV2TBPC(const VertexXYZNUV2TB& in) { *this = in; }
        ...
        VertexXYZNUV2TBPC(const VertexXYZNUV2& in) { *this = in; }
        VertexXYZNUV2TBPC() {}
    };
    ...
    /**
     * Position, packed Normal, packed UV, Index, packed Tangent, packed
     * Binormal
     */
    struct VertexXYZNUVITBPC
    {
        ...
        VertexXYZNUVITBPC(const VertexXYZNUVITB& in) { *this = in; }
        VertexXYZNUVITBPC() {}
    };
    ...
    struct VertexXYZNUVIIIWWPC
    {
        ...
        VertexXYZNUVIIIWWPC(const VertexXYZNUVIIIWW& in) { *this = in; }
        VertexXYZNUVIIIWWPC() {}
    };

    /**
     * Position, Normal, UV1, UV2, index3, index2, index, padding, weight2,
     *weight1, padding.
     */
    struct VertexXYZNUV2IIIWWPC
    {
        ...
        VertexXYZNUV2IIIWWPC(const VertexXYZNUV2IIIWW& in) { *this = in; }
    ...
    struct VertexXYZNUVIIIWWTBPC
    {
        ...
        VertexXYZNUVIIIWWTBPC(const VertexXYZNUVIIIWWTB& in) { *this = in; }
    ...
    struct VertexTex7
    {
        ...
        static BW::string decl() { return "xyznuv8tb"; }
    };
...
#define DECLARE_VERTEX_TYPE_DEFINITION_NAME(VertexType, definitionName)        \
     ...
     *
     * This indirection lets us add new packing choices and types with
     * corresponding XML definitions without having to change existing XML
     * definitions and not tying down to a particular naming scheme.
     *
     ...
     * to make requests that use vertex format definitions. Accesses to vertex
     * format definitions via hard-coded format name strings (e.g. "xyznuv")
    ...
    DECLARE_VERTEX_TYPE_DEFINITION_NAME(VertexXYZNUVIIIWWTB_v2,
                                        xyznuviiiwwtb_v2);
    ...
    BW_STATIC_ASSERT(
      false,
      Vertex_format_definitions_not_defined_for_selected_vertex_packing_set);

#endif

    //-----------------------------------------------------------------------------

    // Purposely not undefined since macro is used in other files e.g. vertex
    // streams
