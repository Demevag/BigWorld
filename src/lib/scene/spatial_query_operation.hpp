...
namespace BW {
    ...
    {
      public:
        void getWorldTransform(const SceneObject& obj, Matrix* xform);
        void getWorldVisibilityBoundingBox(const SceneObject& obj, AABB* bb);
        void accumulateWorldVisibilityBoundingBoxes(const IntersectionSet& objs,
                                                    AABB*                  bb);
