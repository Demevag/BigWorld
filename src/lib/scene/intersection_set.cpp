...
namespace BW {
    ...
    IntersectionSet::SceneObjectList& IntersectionSet::objectsOfType(
      SceneObjectType typeID)
    {
        return buckets_[typeID];
    }

    const IntersectionSet::SceneObjectList& IntersectionSet::objectsOfType(
      SceneObjectType typeID) const
    {
        return buckets_[typeID];
    }
