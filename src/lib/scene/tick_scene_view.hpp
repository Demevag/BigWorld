...
namespace BW {
    ...
    class TickSceneView : public SceneView<ITickSceneProvider>
    {
      public:
    ...
    class TickOperation : public SceneObjectOperation<ITickOperationTypeHandler>
    {
      public:
        ...
        void updateAnimations(SceneObject* pObjects,
                              size_t       objectCount,
                              float        dTime);
