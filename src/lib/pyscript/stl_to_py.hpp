...
namespace PySTLObjectAid {
     ...
     */
    template <>
    struct Releaser<PyObject*>
    {
        static void release(PyObject*& pObject) { Py_XDECREF(pObject); }
    };
...
class PySTLSequence : public PyObjectPlus
{
    Py_Header(PySTLSequence, PyObjectPlus)
      ...
      public
      : PySTLSequence(PySTLSequenceHolderBase& holder,
                      PyObject*                pOwner,
 ...
 */
template <class SEQ>
class PySTLSequenceHolder : public PySTLSequenceHolderBase
{
  public:
