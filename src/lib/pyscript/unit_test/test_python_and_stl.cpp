...
namespace BW {
    ...
    TEST_F(PyScriptUnitTestHarness, PassSTLVectorToPython)
    {
        ...
        // calc sum of all elements
        {
            ...
            PyObject* res =
              Script::ask(PyObject_GetAttrString(module, "sumVector"),
                          args,
    ...
    TEST_F(PyScriptUnitTestHarness, RecieveSTLVectorFromPython)
    {
        PyObject* module = PyImport_ImportModule("test_stl");
        CHECK(module);
        // build a range vector for given min and max values including min and
        // max values itself
        {
            ...
            PyObject* res =
              Script::ask(PyObject_GetAttrString(module, "buildRangeVector"),
                          args,
                          "Python_ImportCustomModule",
                          false);
    ...
    TEST_F(PyScriptUnitTestHarness, PassAndModifySTLVector)
    {
        ...
        PySTLSequenceHolder<BW::vector<float>> pyVecHolder(
          inputVec, NULL, true);
        ...
        // modifies passed array of floats
        {
            ...
            PyObject* res =
              Script::ask(PyObject_GetAttrString(module, "clampVec"),
                          args,
                          "Python_ImportCustomModule",
                          false);
