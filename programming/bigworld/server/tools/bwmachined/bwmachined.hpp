...
class BWMachined : public Singleton<BWMachined>
{
  ...
  private:
    ...
    bool handleCreateMessage(Endpoint&            ep,
                             sockaddr_in&         sin,
  ...
  protected:
    ...
    bool handleMessage(Endpoint&            ep,
                       sockaddr_in&         sin,
                       MachineGuardMessage& mgm,
                       MGMPacket&           replies);
    ...
    const char* findOption(const char* optionName, const char* oldOptionName);
    ...
    {
      public:
        UpdateHandler(BWMachined& machined)
          : machined_(machined)
        {
        }
        void handleTimeout(TimerHandle handle, void* pUser);
