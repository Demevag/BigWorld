...
PyEntity::PyEntity(Entity& entity)
  ...
  , cell_(new PyServer(this, /* isProxyCaller */ false),
          ScriptObject::FROM_NEW_REFERENCE)
  , base_(new PyServer(this, /* isProxyCaller */ true),
          ScriptObject::FROM_NEW_REFERENCE)
...
/**
 *	This method is exposed to scripting. It is used by an entity to remove a
