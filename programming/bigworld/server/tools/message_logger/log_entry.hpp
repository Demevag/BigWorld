...
class LogEntry
{
  ...
  public:
    ...
    const LogTime& time() const { return time_; }

    MessageLogger::CategoryID categoryID() const { return categoryID_; }

    DebugMessageSource messageSource() const { return messageSource_; }
    ...
    uint32 argsOffset() const { return argsOffset_; }
    ...
    uint16 metadataLength() const { return metadataLen_; }
