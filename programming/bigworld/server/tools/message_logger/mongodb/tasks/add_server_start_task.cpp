...
namespace MongoDB {
    ...
    /**
     *  The creation of this task consumes the passed-in log buffer, making it
     * so that the contained BSON objects should belong only to this task.
     */
     ...
     *
     */
    void AddServerStartTask::performBackgroundTask(
      TaskManager&          mgr,
