  ...
  , public LogStorage
{
  ...
  private:
    ...
    // Both LogStorageMLDB and LogReaderMLDB need a UserLog list, however they
    // both handle the descruction of these lists differently so are kept in
