...
class CommandLineParser
{
  public:
    ...
    bool shouldList() const { return shouldList_; }

    bool shouldIgnoreSqliteErrors() const { return shouldIgnoreSqliteErrors_; }

    const BW::string& resPath() const { return resPath_; }

    bool hadNonOptionArgs() const { return hadNonOptionArgs_; }
