...
namespace CM {
    ...
    class InternalNode : public BSPNode
    {
      ...
      private:
        ...
        /**
         *	This helper method returns the limit to move to based on the
         *direction of movment.
         */
        static float closestLimit(float            position,
                                  float            limit1,
                                  float            limit2,
        ...
        bool addCellToChildTree(BSPNode*& rpChild,
                                CellData* pNewCell,
                                CellData* pCellToSplit);
