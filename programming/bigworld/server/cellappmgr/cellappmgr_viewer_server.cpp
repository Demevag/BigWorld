  ...
  , cellAppMgr_(cellAppMgr)
{
    ...
    dispatcher_.registerFileDescriptor(
      this->fileno(), this, "CellAppMgrViewerConnection");
}

namespace {
    /**
     *	This is a helper function used by handleInputNotification to satisfy the
     *	GET_CELLS request. This is done as a static function because we do not
     *know about CellAppMgr::Cells in the header file.
     */
 ...
 *
 *	@param dispatcher		A Mercury Dispatcher with which to register file
 *descriptors.
                                     ...
                                     uint16                    port)
{
    ...
    pDispatcher_->registerFileDescriptor(
      listener_.fileno(), this, "CellAppMgrViewerConnection");
