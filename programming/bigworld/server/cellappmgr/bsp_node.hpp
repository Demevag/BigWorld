...
namespace CM {
    ...
    /**
     *	This interface is used as a base class of objects that will be used in
     *the BSPNode::visit method.
     */
    class CellVisitor
    {
      public:
    ...
    /**
     *	This class is the base class for nodes in the BSP tree. The leaves of
     *the tree are the cells of a space. The internal nodes are the partitioning
    ...
    class BSPNode : public WatcherProvider
    {
      public:
        ...
        virtual BSPNode* addCellTo(CellData* pNewCell,
        ...
        const EntityBoundLevels& entityBoundLevels() const
        {
            return entityBoundLevels_;
        }
        ...
        virtual float calculateNewAreaNotLoaded(bool changeY,
                                                bool changeMax,
                                                bool moveLeft) const = 0;
