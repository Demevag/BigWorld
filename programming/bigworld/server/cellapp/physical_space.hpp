...
class IPhysicalSpace : public ReferenceCount
{
  public:
    ...
    /**
     *  This method fills the list of Rects with loadable bounds of all
     * mappings.
     *  @param rects reference to list of Rects to be filled with loadable
     * bounds of all mappings.
