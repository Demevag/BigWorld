...
class HistoryEvent
{
  public:
    ...
    class Level
    {
      public:
        ...
        {
            return isDetail_ ? (detailLevel <= detail_)
                             : (threshold < priority_);
        }
    ...
    void recreate(Mercury::MessageID       msgID,
                  EventNumber              number,
                  void*                    msg,
                  int                      msgLen,
                  Level                    level,
  ...
  private:
    ...
    HistoryEvent(Mercury::MessageID       msgID,
                 EventNumber              number,
                 void*                    msg,
                 int                      msgLen,
                 Level                    level,
...
class EventHistory
{
  ...
  public:
    ...
    void lastTrimmedEventNumber(EventNumber v) { lastTrimmedEventNumber_ = v; }
