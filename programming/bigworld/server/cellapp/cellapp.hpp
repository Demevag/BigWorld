  ...
  , public Singleton<CellApp>
{
  ...
  public:
    ...
    PyObject*    newClassInstance(PyObject* pyClass, PyObject* pDictionary);
    ...
    void detectDeadCellApps(const BW::vector<Mercury::Address>& addrs);
    //@}
  ...
  private:
    ...
    void checkTickWarnings(double persistentLoadTime,
                           double tickTime,
                           double spareTime);
