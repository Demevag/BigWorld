...
class PyCellData : public PyObjectPlus
{
    Py_Header(PyCellData, PyObjectPlus)
      ...
      public
      : PyCellData(EntityTypePtr  pEntityType,
                   BinaryIStream& data,
                   bool           persistentDataOnly,
                   PyTypeObject*  pType = &PyCellData::s_type_);

    bool addToStream(BinaryOStream& stream,
                     bool           addPosAndDir,
    ...
    static bool addToStream(BinaryOStream& stream,
                            EntityTypePtr  pType,
                            PyObject*      pCellData,
                            bool           addPosAndDir,
                            bool           addPersistentOnly);
    ...
    static void        addSpatialData(PyObjectPtr        pCellData,
                                      const Vector3&     pos,
