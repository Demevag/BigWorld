 ...
 *  lists of Base Entities available to Python.  They cannot be created via
 *script, nor can they be modified.
 *
 ...
 *  @components{ base }
 *  items returns a list of the items, as (ID, Base Entity) pairs, that are
