...
class BWConfigLoginChallengeConfig : public LoginChallengeConfig
{
  public:
    ...
    virtual LoginChallengeConfigPtr getChild(const BW::string& childName) const
      /* override */;
    ...
    long getLong(const BW::string& path, long defaultValue = 0) const
      /* override */;

    double getDouble(const BW::string& path, double defaultValue = 0.0) const
      /* override */;
