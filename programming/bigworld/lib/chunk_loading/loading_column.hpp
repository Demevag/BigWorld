...
class LoadingColumn
{
  public:
    ...
    bool stepLoad(EdgeGeometryMapping* pMapping,
                  int                  perpPos,
                  bool                 isVerticalEdge,
                  bool&                rAnyColumnsLoaded);
    bool stepUnload(EdgeGeometryMapping* pMapping,
                    int                  perpPos,
                    bool                 isVerticalEdge);
  ...
  private:
    ...
    void trimClientOnlyBoundaries(Chunk* pChunk, EdgeGeometryMapping* pMapping);
