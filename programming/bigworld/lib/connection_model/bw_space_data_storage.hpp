...
class BWSpaceDataStorage
{
  public:
     ...
     */
    bool addNewSpace(SpaceID spaceID) { return this->addMapping(spaceID); }

    /**
     *	This method is used to notify the storage that the space data for the
     *	given SpaceID is no longer needed, and should be cleaned up.
     */
    void deleteSpace(SpaceID spaceID) { this->clearMapping(spaceID); }
     ...
     */
    void clearSpaces() { return this->clearAllMappings(); }
