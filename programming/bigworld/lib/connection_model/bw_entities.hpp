...
class BWEntities
{
  public: /// C++ Housekeeping
    ...
    void handleBasePlayerCreate(EntityID       id,
                                EntityTypeID   entityTypeID,
                                BinaryIStream& data);

    void handleCellPlayerCreate(EntityID          id,
                                SpaceID           spaceID,
                                EntityID          vehicleID,
    ...
    void handleEntityCreate(EntityID          id,
                            EntityTypeID      entityTypeID,
                            SpaceID           spaceID,
                            EntityID          vehicleID,
    ...
    void handleEntityMethod(EntityID       entityID,
                            int            methodID,
                            BinaryIStream& data);

    void handleEntityProperty(EntityID       entityID,
                              int            propertyID,
                              BinaryIStream& data);

    void handleNestedEntityProperty(EntityID       entityID,
                                    BinaryIStream& data,
                                    bool           isSlice);

    int getEntityMethodStreamSize(EntityID entityID,
                                  int      methodID,
                                  bool     isFailAllowed = false) const;

    int getEntityPropertyStreamSize(EntityID entityID,
                                    int      propertyID,
                                    bool     isFailAllowed = false) const;
    ...
    void handleRestoreClient(EntityID           entityID,
                             SpaceID            spaceID,
                             EntityID           vehicleID,
                             const Position3D&  pos,
