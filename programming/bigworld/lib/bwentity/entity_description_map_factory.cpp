 ...
 */
EntityDescriptionMap* EntityDescriptionMapFactory::create(
  const char** pathsToEntityDef)
{
    ...
    BW::EntityDescriptionMap* pBWEntityDescrMap =
      new BW::EntityDescriptionMap();
    ...
    EntityDescriptionMap* pEntityDescrMap =
      new EntityDescriptionMap(pBWEntityDescrMap);
    if (!pEntityDescrMap) {
 ...
 */
void EntityDescriptionMapFactory::destroy(
  EntityDescriptionMap*& pEntityDescriptionMap)
{
