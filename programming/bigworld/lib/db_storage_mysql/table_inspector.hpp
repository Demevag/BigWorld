...
class TableInspector : public TableVisitor
{
  ...
  protected:
     ...
     */
    virtual bool onExistingTable(const BW::string& tableName) { return true; }
     ...
     */
    virtual bool onNeedUpdateTable(
      const BW::string&                         tableName,
...
{
  public:
    TableValidator(MySql& connection)
      : TableInspector(connection)
    {
    }
...
{
  public:
    TypesCollector(MySql& connection)
      : metaData_(connection)
      , types_()
    {
    }
