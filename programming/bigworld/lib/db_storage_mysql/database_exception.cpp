...
{
    return (errNum_ == ER_LOCK_DEADLOCK) || (errNum_ == ER_LOCK_WAIT_TIMEOUT);
}
...
{
    return (errNum_ == CR_SERVER_GONE_ERROR) || (errNum_ == CR_SERVER_LOST) ||
           (errNum_ == CR_CONNECTION_ERROR) || (errNum_ == CR_CONN_HOST_ERROR);
}
