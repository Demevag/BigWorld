...
void MySql::connect(const DBConfig::ConnectionInfo& connectInfo)
{
    ...
    try {
        ...
        if (!mysql_real_connect(sql_,
                                ...
                                connectInfo.username.c_str(),
                                connectInfo.password.c_str(),
                                connectInfo.database.c_str(),
                                connectInfo.port,
                                NULL,
 ...
 *						entries fails.
 */
bool getEngineSupportState(MYSQL_RES*  pMySqlResult,
                           BW::string& engine,
