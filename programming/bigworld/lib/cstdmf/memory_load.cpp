...
namespace Memory {
    ...
    // on 64 bit machines we are running out of video memory under we can fix
    // this limit amount of system memory to prevent exceeding the limit.
    ...
    MemSize maxAvailableMemory()
    {
        ...
        MemSize cap =
          memoryStatus.ullTotalVirtual - FRAGMENTATION_MEMORY_BUFFER_SIZE;
