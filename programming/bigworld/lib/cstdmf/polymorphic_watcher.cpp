                                     ...
                                     Mode&       mode) const
{
    ...
    return watcher->getAsString(
      this->getProvider(base), path, result, desc, mode);
}
                                     ...
                                     Mode&       mode) const
{
    ...
    return watcher->getAsString(this->getProvider(base), path, result, mode);
}
                                       ...
                                       const char* valueStr)
{
    ...
    return watcher->setFromString(this->getProvider(base), path, valueStr);
}
                                       ...
                                       WatcherPathRequestV2& pathRequest)
{
    ...
    return watcher->setFromStream(this->getProvider(base), path, pathRequest);
}

/*
 *	Override from Watcher.
 */
bool PolymorphicWatcher::visitChildren(const void*         base,
                                       const char*         path,
                                       WatcherPathRequest& pathRequest)
{
    ...
    return watcher->visitChildren(this->getProvider(base), path, pathRequest);
}
