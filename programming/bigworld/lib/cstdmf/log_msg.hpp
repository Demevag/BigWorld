...
class LogMsg
{
  public:
     ...
     */
    CSTDMF_DLL void write(const char* pFormat, ...) BW_FORMAT_ATTRIBUTE;
    CSTDMF_DLL void operator()(const char* pFormat, ...) BW_FORMAT_ATTRIBUTE;
    ...
    static bool hasSeenCriticalMsg() { return s_hasSeenCriticalMsg_; }
