...
#include <ittnotify.h>
    namespace ITT_ProfilerHooks {
        ...
        ExternalProfiler::ProfilerStringHandle createStringHandle(
          const char* string)
        {
        ...
        void initialize()
        {
            ...
            intelGPAHooks.createStringHandle_ =
              &ITT_ProfilerHooks::createStringHandle;
...
#include <nvToolsExt.h>
    ...
    void ExternalProfiler::initialize()
    {
        ...
        // Use the command line to determine what external profiler to
        // initialize
