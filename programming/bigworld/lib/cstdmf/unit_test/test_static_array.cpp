...
TEST(DynamicEmbeddedArray_testGrow)
{
    ...
    size_t expectedSize = sizeof(size_t) * testArray.capacity() +
...
TEST(DynamicEmbeddedArray_testRuntimeWarning)
{
    ...
    size_t expectedSize2 = sizeof(size_t) * testArray5.capacity() +
                           2 * sizeof(size_t) + sizeof(size_t*);
    ...
    // please check the log, ExpandableStaticArrayWithWarning will print a
    // warning saying that heap allocations happened
...
TEST(DynamicEmbeddedArray_testEmtpyPushback)
{
    ...
    size_t expectedSize2 = sizeof(PosStruct) * testArray5.capacity() +
                           2 * sizeof(size_t) + sizeof(size_t*);
    CHECK_EQUAL(sizeof(testArray5), expectedSize2);
