...
namespace BW {
    ...
    class LookUpTable
    {
      public:
        ...
        LookUpTable(size_t reserveSize) { table_.reserve(reserveSize); }
        ...
        ValueT& operator[](IndexType idxT) { return this->at(idxT); }

        IndexType size() const { return static_cast<IndexType>(table_.size()); }

        ContainerT& storage() { return table_; }
