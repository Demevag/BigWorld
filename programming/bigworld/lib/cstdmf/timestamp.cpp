...
{
    static double stampsPerSecondCacheD =
      double(stampsPerSecond_gettimeofday());
    return stampsPerSecondCacheD;
}
...
{ // see comments for the unix version
    ...
    HANDLE thread =
      CreateThread(NULL, 0, &busyIdleThread, NULL, 0, &busyIdleThreadID);
