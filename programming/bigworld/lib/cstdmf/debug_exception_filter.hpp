...
CSTDMF_DLL DWORD ExceptionFilter(DWORD                       exceptionCode,
...
R CallWithExceptionFilter(R (*method)(P1 p1, P2 p2, P3 p3, P4 p4),
                          P1 p1,
                          P2 p2,
                          P3 p3,
                          P4 p4)
...
template <typename R,
          ...
          typename P4,
          typename P5>
R CallWithExceptionFilter(R (*method)(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5),
                          P1 p1,
                          P2 p2,
                          P3 p3,
                          P4 p4,
