...
namespace BW {
    ...
    /// simple grow only allocator, very fast but all elements must be free'd
    /// together and be pod type. this is useful when there are many small
    /// allocations and few deallocations.
