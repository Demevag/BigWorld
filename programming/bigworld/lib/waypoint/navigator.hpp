...
class Navigator
{
  public:
    ...
    NavLoc createPathNavLoc(ChunkSpace*    pSpace,
                            const Vector3& pos,
                            float          girth) const;

    bool findPath(const NavLoc& src,
                  const NavLoc& dst,
                  float         maxDistance,
    ...
    bool findFullPath(ChunkSpace*    space,
    ...
    bool findRandomNeighbourPointWithRange(ChunkSpace* space,
                                           Vector3     position,
                                           float       minRadius,
                                           float       maxRadius,
                                           float       girth,
