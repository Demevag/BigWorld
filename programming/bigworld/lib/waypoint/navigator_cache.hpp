...
class NavigatorCache : public ReferenceCount
{
  public:
     ...
     */
    const ChunkWaypointStatePath& wayPath() const { return wayPath_; }
     ...
     */
    void clearWayPath() { wayPath_.clear(); }
    ...
    bool findWaySetPath(const ChunkWPSetState& src, const ChunkWPSetState& dst);
     ...
     *	false.
     */
    void clearWaySetPath() { waySetPath_.clear(); }
