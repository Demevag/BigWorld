  ...
  : public SearchPathBase<ChunkWaypointState, ChunkWaypointState::SearchData>
{
  public:
    ...
    ChunkWaypointStatePath()
      : SearchPathBase<ChunkWaypointState, ChunkWaypointState::SearchData>()
    ...
    const BW::vector<ChunkWaypointState>& fullPath() const { return fullPath_; }
  ...
  private:
    ...
    static bool processCorridorPoint(const BW::vector<Vector2>& corridorPoints,
                                     uint32&                    root,
                                     uint32&                    funnelLeft,
                                     uint32&                    funnelRight,
                                     uint32&                    current);

    static bool funnel(const Corridor&                         corridor,
