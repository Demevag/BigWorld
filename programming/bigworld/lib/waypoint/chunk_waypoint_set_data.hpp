  ...
  , public ChunkWaypointVertexProvider
{
  ...
  public:
    ...
    WaypointIndex find(const Chunk*                chunk,
    ...
    void girth(float girth) { girth_ = girth; }

    ChunkWaypoints& waypoints() { return waypoints_; }

    const ChunkWaypoints& waypoints() const { return waypoints_; }
