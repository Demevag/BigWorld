 ...
 *
 *	This class is used to wrap different OpenAutomate enum values and global
 *values.
 */
/**
 *	This class is used to wrap different OpenAutomate enum values and global
 ...
 *
 *	This class wraps a oaVersionStruct which gives version information about
 *OpenAutomate
 */
/**
 *	This class wraps a oaVersionStruct which gives version information about
...
class OAVersionStructWrapper : public PyObjectPlus
{
    Py_Header(OAVersionStructWrapper, PyObjectPlus)
      ...
      public : OAVersionStructWrapper(PyTypeObject* pType = &s_type_);
...
class OACommandWrapper : public PyObjectPlus
{
    Py_Header(OACommandWrapper, PyObjectPlus)
      ...
      public : OACommandWrapper(PyTypeObject* pType = &s_type_);
 ...
 *
 *	This class wraps an oaNamedOptionStruct which send information about a named
 *option to the OpenAutomate program
 */
/**
 *	This class wraps an oaNamedOptionStruct which send information about a named
 *option to the OpenAutomate program
...
class OANamedOptionWrapper : public PyObjectPlus
{
    Py_Header(OANamedOptionWrapper, PyObjectPlus)
      ...
      public : OANamedOptionWrapper(PyTypeObject* pType = &s_type_);
    OANamedOptionWrapper(oaNamedOptionStruct* option,
    ...
    void setComparison(BWOpenAutomate::eOAOptionDataType optionType,
