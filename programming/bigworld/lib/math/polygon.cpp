...
namespace Math {
    ...
    /**
     *  This method is a 2D (Vector2) specialisation of the 'intersects'
     * template method. It performs intersection using the separation of axes
     * theorem. This implementation doesn't assume any particular ordering of
