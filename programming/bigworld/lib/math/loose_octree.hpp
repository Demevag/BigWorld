...
class LooseOctree_DynamicTypes : public LooseOctree_DataTypes
{
  public:
...
class LooseOctree_StaticTypes : public LooseOctree_DataTypes
{
  public:
...
struct LooseOctreeStorage
{
    ...
    typedef typename StorageTypes::RuntimeNodeDataReferences
...
class LooseOctree
{
  public:
    ...
    typedef
      typename StorageType::RuntimeNodeDataReferences RuntimeNodeDataReferences;
    ...
    void intersect(const ConvexHull&          hull,
                   RuntimeNodeDataReferences& dataReferences) const;
    void intersect(const Vector3&             start,
                   const Vector3&             stop,
                   RuntimeNodeDataReferences& dataReferences) const;
    ...
    void intersect(IntersectShape&            shape,
                   RuntimeNodeDataReferences& dataReferences) const;

    template <class Visitor>
    void traverse(Visitor&  visitor,
                  NodeIndex nodeIndex = ROOT_NODE,
                  size_t    level     = 0u);
