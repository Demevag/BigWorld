...
namespace Math {
    ...
    {
        create(BoundingBox(Vector3(0, 0, 0), Vector3(0, 0, 0)),
               Matrix::identity);
    }
    ...
    void OrientedBBox::create(const BoundingBox& bb, const Matrix& matrix)
    {
        ...
        points_.push_back(matrix.applyPoint(
          Vector3(bb.minBounds()[0], bb.minBounds()[1], bb.minBounds()[2])));
        points_.push_back(matrix.applyPoint(
          Vector3(bb.minBounds()[0], bb.minBounds()[1], bb.maxBounds()[2])));
        points_.push_back(matrix.applyPoint(
          Vector3(bb.maxBounds()[0], bb.minBounds()[1], bb.maxBounds()[2])));
        points_.push_back(matrix.applyPoint(
          Vector3(bb.maxBounds()[0], bb.minBounds()[1], bb.minBounds()[2])));
        points_.push_back(matrix.applyPoint(
          Vector3(bb.minBounds()[0], bb.maxBounds()[1], bb.minBounds()[2])));
        points_.push_back(matrix.applyPoint(
          Vector3(bb.minBounds()[0], bb.maxBounds()[1], bb.maxBounds()[2])));
        points_.push_back(matrix.applyPoint(
          Vector3(bb.maxBounds()[0], bb.maxBounds()[1], bb.maxBounds()[2])));
        points_.push_back(matrix.applyPoint(
          Vector3(bb.maxBounds()[0], bb.maxBounds()[1], bb.minBounds()[2])));
