...
/**
 *	This class is used to linearly interpolate between two blends. The
 *BlendTransform is primarly used for blending from one animation to another
 *smoothly.
 */
class BlendTransform
{
  ...
  public:
     ...
     */
    const Quaternion& rotation() const { return rotate_; };
     ...
     */
    const Vector3& translation() const { return translate_; };

    /**
     *	Set the translation.
     *	@param translation The translation as a Vector3.
     */
    void translation(const Vector3& translation) { translate_ = translation; };
    ...
    BlendTransform(const Quaternion& irotate,
     ...
     */
    inline void normaliseRotation() { rotate_.normalise(); }

    /**
     *  This function blends between this BlendTransform and the given
     *BlendTransform by the supplied amount
     *
    ...
    /**
     *	This function outputs the rotation, scale and translation information
     *into the input matrix.
     *
     *	@param mOut The matrix to insert the rotation, scale and translation
     *information into.
     */
