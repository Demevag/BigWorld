...
class CImeUiFont_Base
{
  public:
    ...
    virtual void GetTextExtent(LPCTSTR szText,
                               DWORD*  puWidth,
                               DWORD*  puHeight) = 0;
...
extern void(CALLBACK* ImeUiCallback_DrawRect)(int   x1,
                                              int   y1,
                                              int   x2,
                                              int   y2,
                                              DWORD color);
...
extern void(CALLBACK* ImeUiCallback_DrawFans)(const IMEUI_VERTEX* paVertex,
                                              UINT                uNum);
