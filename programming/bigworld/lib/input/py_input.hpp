...
class PyKeyEvent : public PyObjectPlus
{
    Py_Header(PyKeyEvent, PyObjectPlus)
      ...
      public
      : PyKeyEvent(const KeyEvent& event,
                   PyTypeObject*   pType = &PyKeyEvent::s_type_)
      : PyObjectPlus(pType)
    {
        event_.fill(event);
    }
...
class PyMouseEvent : public PyObjectPlus
{
    Py_Header(PyMouseEvent, PyObjectPlus)
      ...
      public
      : PyMouseEvent(const MouseEvent& event,
                     PyTypeObject*     pType = &PyMouseEvent::s_type_)
      : PyObjectPlus(pType)
    {
        event_.fill(event);
    }
...
class PyAxisEvent : public PyObjectPlus
{
    Py_Header(PyAxisEvent, PyObjectPlus)
      ...
      public
      : PyAxisEvent(const AxisEvent& event,
                    PyTypeObject*    pType = &PyAxisEvent::s_type_)
      : PyObjectPlus(pType)
    {
        event_.fill(event);
    }
...
class PyIMEEvent : public PyObjectPlus
{
    Py_Header(PyIMEEvent, PyObjectPlus)
      ...
      public
      : PyIMEEvent(const IMEEvent& event,
                   PyTypeObject*   pType = &PyIMEEvent::s_type_)
      : PyObjectPlus(pType)
      , event_(event)
    {
    }
