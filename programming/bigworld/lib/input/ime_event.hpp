...
class IMEEvent
{
  public:
    ...
    IMEEvent(const IMEEvent& other)
      ...
      , compositionCursorPositionChanged_(
          other.compositionCursorPositionChanged_)
    ...
    /**
     *	This method determines whether the reading string visibility has
     *changed.
     */
     ...
     */
    bool candidatesVisibilityChanged() const
    {
        return candidatesVisibilityChanged_;
    }
    void candidatesVisibilityChanged(bool b)
    {
        candidatesVisibilityChanged_ = b;
    }

    /**
     *	This method determines whether or not the list of candidates has
     *changed.
     */
    ...
    /**
     *	This method determines whether or not the candidate selection index has
     *changed.
     */
    ...
    /**
     *	This method determines whether or not the composition string has
     *changed.
     */
    ...
    /**
     *	This method determines whether or not the composition cursor position
     *has changed.
     */
    bool compositionCursorPositionChanged() const
    {
        return compositionCursorPositionChanged_;
    }
    void compositionCursorPositionChanged(bool b)
    {
        compositionCursorPositionChanged_ = b;
    }
    ...
    bool dirty() const
    {
        return stateChanged() || candidatesVisibilityChanged() ||
               candidatesChanged() || readingChanged() ||
               selectedCandidateChanged() || compositionChanged() ||
