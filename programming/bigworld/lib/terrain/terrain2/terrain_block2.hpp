...
namespace Terrain {
    ...
    class TerrainBlock2 : public CommonTerrainBlock2
    {
      public:
        ...
        virtual void getTexturesAndVertices(BW::map<void*, int>& textures,
      ...
      protected:
        bool initVerticesResource(BW::string* error = NULL);
        ...
        void   depthPassMark(uint32 depthPassMark)
        {
            depthPassMark_ = depthPassMark;
        }
      ...
      protected:
        ...
        class PostLoadProcessTask : public BackgroundTask
        {
          public:
            ...
            // normal map must be valid on the terrain block after init is
            // called as it will call evaluate on it, possibly before it has
            // finished async generation.
            //			TerrainNormalMap2Ptr		pNormalMap_;
            HorizonShadowMap2Ptr pHorizonMap_;
            TerrainLodMap2Ptr    pLodMap_;
