...
namespace Terrain {
    ...
    class TerrainVertexLod : public BW::vector<float>
    {
      public:
        ...
        void getDistanceForLod(uint32 lodLevel,
                               float& o_MinDistance,
      ...
      private:
        ...
        //-- scale factors for lod distances in case if we change FOV angle of
        //the camera.
        //--	 This may be useful for instance for sniper mode where we need
        //zooming main camera.
