...
namespace Terrain {
    struct TerrainVertexLodConsts
    {
        ...
        // The minimum distance from the corner of a block to the first
        // neighbour sub-block that can influence the degenerates
        ...
        TerrainVertexLodConsts(float size)
          ...
          , minNeighbourDistance(
              sqrtf(blockSize * blockSize + blockSize * blockSize))
