...
namespace Terrain {
    ...
    /*
     *	This method creates a token for the map from the two grid resolution
     *values. This token contains the x resolution in the upper 16 bits and the
     *z resolution in the lower 16 bits.
     *	@param resolutionX the x resolution
     *	@param resolutionZ the Z resolution
     *	@return the token
     */
    ...
    /**
     *	This static method returns the grid vertex buffer for the supplied
     *resolution.
     *	@param resolutionX the x resolution
     *	@param resolutionZ the z resolution
     *
     */
    GridVertexBuffer* GridVertexBuffer::get(uint16 resolutionX,
                                            uint16 resolutionZ)
    {
        BW_GUARD;
