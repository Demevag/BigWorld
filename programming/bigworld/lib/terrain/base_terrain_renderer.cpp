...
namespace Terrain {
    ...
    /**
     *	This method is a wrapper for the manager's currentRenderer setter
     *method.
     *
     *	@param newInstance	The new current renderer
     *	@see Terrain::Manager::currentRenderer
     */
    /*static*/ void BaseTerrainRenderer::instance(
      BaseTerrainRenderer* newInstance)
    {
        Manager::instance().currentRenderer(newInstance);
    }

    /**
     *	This method is a wrapper for the manager's currentRenderer getter
     *method.
     *
     *	@param newInstance	The new current renderer
     *	@see Terrain::Manager::currentRenderer
    ...
    /**
     *  This method sets a flag that indicates whether or not hole map is used
