...
namespace Terrain {
...
#endif
    /**
     *  This class keeps the current terrain settings, usually read from the
     * file space.settings, keeps track of other runtime settings, and inits the
    ...
    class TerrainSettings : public SafeReferenceCount
    {
      public:
        ...
        {
            return m_lodTextureParams.m_start * s_invZoomFactor_;
        }
        void  lodTextureStart(float value);
        float lodTextureDistance() const
        {
            return m_lodTextureParams.m_distance;
        }
        void  lodTextureDistance(float value);
        float blendPreloadDistance() const
        {
            return m_lodTextureParams.m_blendPreloadDistance * s_invZoomFactor_;
        }
        void blendPreloadDistance(float value);

        float lodNormalStart() const
        {
            return m_lodNormalParams.m_start * s_invZoomFactor_;
        }
        ...
        {
            return m_lodNormalParams.m_normalPreloadDistance * s_invZoomFactor_;
        }
        void normalPreloadDistance(float value);

        bool  bumpMapping() const { return m_bumpParams.m_enabled; }
        void  bumpMapping(bool value);
        float bumpFadingStart() const
        {
            return m_bumpParams.m_fadingStart * s_invZoomFactor_;
        }
        void  bumpFadingStart(float value);
        float bumpFadingDistance() const
        {
            return m_bumpParams.m_fadingDistance;
        }
        ...
        void   serverHeightMapLod(uint32 serverHeightMapLod)
        {
            serverHeightMapLod_ = serverHeightMapLod;
        }
      ...
      private:
        ...
        // Detail height map will be loaded when less than this distance from
        // camera.
    ...
    {
        return lodTextureStart() + lodTextureDistance() +
