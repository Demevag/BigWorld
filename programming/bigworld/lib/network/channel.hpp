...
namespace Mercury {
      ...
      public ReferenceCount
    {
      public:
         ...
         *	This method may return false when the channel is destroyed, or is
         *being shut down.
         */
         ...
         *	message filter, releasing any reference to any previous message
         *filter.
         *
         ...
         */
        MessageFilterPtr pMessageFilter() { return pMessageFilter_; }

        /**
         *	This method returns the timestamp of the last time data was received
         *on this channel.
         *
         ...
         */
        ChannelListener* pChannelListener() { return pListener_; }
        ...
        /**
         *	This method returns the number of packets sent on this channel. It
         *does not include resends.
         */
        ...
        /**
         *	This method returns the number of bytes sent on this channel. It
         *does not include bytes sent by resends.
         */
      ...
      protected:
        ...
        /**
         *	This method is called when the given bundle is about to be
         *finalised. Subclasses can use this to manipulate the bundle before it
         *is finalised for sending.
         *
        ...
        /**
         *	This method implements the sending of the given bundle on this
         *channel.
         *
