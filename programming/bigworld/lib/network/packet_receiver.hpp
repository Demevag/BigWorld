...
namespace Mercury {
      ...
      , private TimerHandler
    {
      public:
        ...
        Reason processPacket(const Address&            addr,
                             Packet*                   p,
                             ProcessSocketStatsHelper* pStatsHelper);
        Reason processFilteredPacket(const Address&            addr,
                                     Packet*                   p,
                                     ProcessSocketStatsHelper* pStatsHelper);
         ...
         *
         *	@return		The maximum time (in seconds) allowed for socket
         *processing when notified of available input before relinquishing
         *				control.
         */
      ...
      private:
        ...
        Reason processOrderedPacket(const Address&            addr,
                                    Packet*                   p,
                                    UDPChannel*               pChannel,
                                    ProcessSocketStatsHelper* pStatsHelper);
        void   processEarlyPacket(const Address&            addr,
                                  Packet*                   p,
                                  UDPChannel*               pChannel,
                                  ProcessSocketStatsHelper* pStatsHelper);
