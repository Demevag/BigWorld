...
namespace Mercury {
                                      ...
                                      ReliableType            reliable)
    {
        ...
        DeferredMessage message(
          pData_->size(), ie, reliable, pRequestHandler, arg, timeout);
        messages_.push_back(message);
    }
    ...
    void DeferredBundle::startReply(ReplyID id, ReliableType reliable)
    {
        ...
        DeferredMessage message(
          pData_->size(), Mercury::InterfaceElement::REPLY, reliable);
        messages_.push_back(message);
    }
     ...
     *	@param pRequestHandler 		The request handler, or NULL for
     *non-request.
     ...
     *								requests.
     */
    DeferredBundle::DeferredMessage::DeferredMessage(
      int                     offset,
     ...
     *
     *	@param newOffset 	The new offset, indicating the end of the data
     *payload.
     */
                                                ...
                                                BinaryIStream& stream)
    {
        ...
        if (!pRequestHandler_) {
            ...
            bundle.startRequest(
              ie_, pRequestHandler_, arg_, timeout_, reliable_);
        }
