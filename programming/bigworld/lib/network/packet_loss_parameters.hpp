...
namespace Mercury {
    ...
    /**
     *	This class is used to store the artificial loss parameters in a value
     *type.
     */
    class PacketLossParameters
    {
      public:
         ...
         *
         */
        PacketLossParameters(float lossRatioValue  = 0.f,
      ...
      private:
        ...
        /**
         * Adding the following three integers is an optimisation so that a
         * floating point multiplication wouldn't have to be done each time a
         * packet is sent.
         */
