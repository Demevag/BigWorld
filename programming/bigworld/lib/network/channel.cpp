...
namespace Mercury {
    ...
    namespace // (anonymous)
    {
        ...
        /**
         *	This class is responsible for checking for inactivity on a channel,
         *and informing the channel.
         */
        class InactivityTimeoutChecker : public TimerHandler
        {
          public:
             ...
             *	@param inactivityExceptionPeriod	How long since the last
             *received time before a channel is declared to have timed out.
             */
     ...
     *	@param addr 				The address of the peer this channel
     *connects to.
     */
    ...
    /**
     *  This method clears the bundle on this channel and gets it ready to have
     * a new set of messages added to it.
     */
    ...
    /**
     *	This method starts detection of inactivity on this channel. If nothing
     *is received for the input period amount of time, an INACTIVITY error is
     *	generated.
     *
     *	@param period		The number of seconds without receiving a packet
     *before the channel is considered inactive.
     *	@param checkPeriod 	The number of seconds between checking for
     *inactivity.
     */
...
#if ENABLE_WATCHERS
    /**
     *	This method creates a new directory watcher with the standard
     *Channel-level watchers.
     */
