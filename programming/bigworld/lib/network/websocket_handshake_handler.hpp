...
namespace Mercury {
    ...
    /**
     *	This interface class is used to validate WebSocket requests from the
     *client.
     */
    class WebSocketHandshakeHandler
    {
      public:
         ...
         *
         *	Basic checks as per RFC 6455 have already been carried out,
         *overriding methods should validate the URI, Origin header value and/or
         *the HTTP method.
         *
         ...
         *
         *	@param filter	The WebSockets stream filter receiving the
         *handshake.
         *	@param request	The WebSockets upgrade request.
         *	@param subprotocols The subprotocols that will be supported.
         *Initially set to what was reported by the client (possibly empty), the
         *WebSocketHandshakeHandler should choose which of these subprotocols
         *are supported and remove those that are unsupported. It should never
         *add its own subprotocols.
         *
      ...
      protected:
        /**
         *	This method is a helper for adjusting the subprotocols output
         *parameter in shouldAcceptHandshake() for Emscripten's expectations.
         *
