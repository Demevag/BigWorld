...
namespace Mercury {
    ...
    class TCPServer : public InputNotificationHandler
    {
      public:
        ...
        /**
         *	This method returns the stream filter factory used for new
         *connections.
         */
        ...
        /**
         *	This method sets the stream filter factory that will be used to
         *create stream filters for new connections when they are created.
         */
