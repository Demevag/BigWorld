...
#define BW_MESSAGE_FORWARDER3(                                                 \
  NAME, CONFIG_PATH, ENABLED, DISPATCHER, INTERFACE)                           \
    BWMessageForwarder BW_forwarder__(                                         \
      NAME, CONFIG_PATH, ENABLED, DISPATCHER, INTERFACE);                      \
                                                                               \
 ...
 */
#define BW_MESSAGE_FORWARDER2(                                                 \
  NAME, CONFIG_PATH, ENABLED, DISPATCHER, INTERFACE)                           \
    BW_MESSAGE_FORWARDER3(#NAME, #CONFIG_PATH, ENABLED, DISPATCHER, INTERFACE)
