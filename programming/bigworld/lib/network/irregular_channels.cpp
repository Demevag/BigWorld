...
namespace Mercury {
    ...
    {
        if (!channel.isLocalRegular() && channel.hasUnackedPackets()) {
    ...
    /**
     *	This method handles the timer event. It checks whether irregular
     *channels need to resend unacked packets.
     */
