...
namespace Mercury {
    ...
    class NetworkInterface : public TimerHandler
    {
      public:
        ...
        IndexedChannelFinderResult findIndexedChannel(
          ChannelID               channelID,
          const Mercury::Address& srcAddr,
          Packet*                 pPacket,
          UDPChannelPtr&          pChannel) const;
        ...
        void            pOffChannelFilter(PacketFilterPtr pFilter)
        {
            pOffChannelFilter_ = pFilter;
        }
        ...
        {
            return verbosityLevel_ > VERBOSITY_LEVEL_QUIET;
        }
        ...
        {
            verbosityLevel_ =
              (value ? VERBOSITY_LEVEL_DEBUG : VERBOSITY_LEVEL_QUIET);
        }
        ...
        // This property is so that data can be associated with a interface.
        // Message handlers get access to the interface that received the
        // message and can get access to this data. Bots use this so that they
        // know which ServerConnection should handle the message.
        ...
        void sendPacket(const Address& address,
                        Packet*        pPacket,
                        UDPChannel*    pChannel,
                        bool           isResend);
