    ...
    class WebSocketStreamFilter : public StreamFilter
    {
      public:
        ...
        void rejectHandshake(
          const BW::string& errorCode    = BW::string("400"),
          const BW::string& reasonPhrase = BW::string("Bad Request"));
      ...
      private:
        ...
        bool sendCloseFrame(uint16 statusCode, const BW::string& reasonPhrase);
