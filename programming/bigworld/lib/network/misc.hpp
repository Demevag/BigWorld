...
namespace Mercury {
    ...
    /**
     *  The type of sequence numbers that are used to order and identify
     * packets.
     */
    ...
    class SeqNumAllocator
    {
      public:
         ...
         */
        SeqNumAllocator(SeqNum firstSeqNum)
          : nextNum_(firstSeqNum)
        {
        }
     ...
     *  advantage of the wrapping logic already implemented in seqLessThan()
     * etc.
     */
    ...
    {
        const char* reasons[] = { "REASON_SUCCESS",
