...
namespace Mercury {
     ...
     *
     */
    void PacketLossParameters::set(float lossRatioValue,
                                   float minLatencyValue,
                                   float maxLatencyValue)
    {
    ...
    /**
     * 	This method sets the ratio of packets to drop. If non-zero, packets will
     *be randomly dropped, and not sent.
     *
     * 	@param lossRatio	The ratio of packets to drop. Setting to 0.0
     *disables artificial packet dropping. 1.0 means all packets are dropped.
     */
     ...
     *
     * 	@param dropPerMillion	The number of packets to drop per million.
     *Setting to 0 disables artificial packet dropping. 1000000 means all
     *packets are dropped.
     */
    ...
    /**
     *	This method sets the minimum latency associated. If non-zero, packets
     *will be randomly delayed before they are sent.
     *
    ...
    void PacketLossParameters::minLatency(float value)
    {
        ...
        if (value != 0.f) {
            WARNING_MSG(
              "PacketLossParameters::latencyMin: "
    ...
    /**
     *	This method sets the maximum latency associated. If non-zero, packets
     *will be randomly delayed before they are sent.
     *
    ...
    void PacketLossParameters::maxLatency(float value)
    {
        ...
        if (value != 0.f) {
            WARNING_MSG(
              "PacketLossParameters::maxLatency: "
              "Latency enabled. In range from %.2f to %.2f milliseconds.\n",
              minLatency_,
              maxLatency_);
        }
