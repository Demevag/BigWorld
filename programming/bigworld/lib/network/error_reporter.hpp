...
namespace Mercury {
    ...
    /**
     *  Accounting structure for keeping track of the number of exceptions
     ...
     *
     */
    typedef BW::map<AddressAndReason, ErrorReportAndCount> ErrorsAndCounts;

    /**
     *	This class is responsible for handling error messages that may be
     *delayed and aggregated.
     */
    class ErrorReporter : public TimerHandler
    {
      public:
        ...
        void reportException(Reason         reason,
                             const Address& addr = Address::NONE);
