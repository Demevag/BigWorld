  ...
  : SimpleGUIComponent(backgroundTextureName, pType)
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        corners_[i]->horizontalPositionMode(
          SimpleGUIComponent::POSITION_MODE_LEGACY);
        corners_[i]->verticalPositionMode(
          SimpleGUIComponent::POSITION_MODE_LEGACY);
        ...
        edges_[i]->horizontalPositionMode(
          SimpleGUIComponent::POSITION_MODE_LEGACY);
        edges_[i]->verticalPositionMode(
          SimpleGUIComponent::POSITION_MODE_LEGACY);
    }
 ...
 *	@todo Comment
 */
void FrameGUIComponent::draw(Moo::DrawContext& drawContext,
                             bool              reallyDraw,
                             bool              overlay)
{
    BW_GUARD;
 ...
 *	Load
 */
bool FrameGUIComponent::load(DataSectionPtr    pSect,
