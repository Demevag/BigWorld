 ...
 *	function is required to do anything with it, including adding it to a
 *previous line of the screen.  Once the callback function has completed, the
 *console clears the edit line.
 *
...
class ConsoleGUIComponent : public SimpleGUIComponent
{
    Py_Header(ConsoleGUIComponent, SimpleGUIComponent)
      ...
      public : ConsoleGUIComponent(PyTypeObject* pType = &s_type_);
    ~ConsoleGUIComponent();
