 ...
 *	then use this class as a container for your attachment, and attach the
 *desired object onto it.
 *	@{
 ...
 *	is more appropriate to use a PyModelRenderer or PySceneRenderer.
 */
class MeshGUIAdaptor
  : public SimpleGUIComponent
  , MatrixLiaison
{
    Py_Header(MeshGUIAdaptor, SimpleGUIComponent)

      public : MeshGUIAdaptor(PyTypeObject* pType = &s_type_);
    ...
    PY_RW_ACCESSOR_ATTRIBUTE_DECLARE(SmartPointer<PyAttachment>,
                                     attachment,
                                     attachment)
