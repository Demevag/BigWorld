...
{
  public:
    GenPositionProperty(const Name&    name,
                        MatrixProxyPtr pMatrix,
                        float          size = 1000000.f);
...
{
  public:
    GenRotationProperty(const Name&    name,
                        MatrixProxyPtr pMatrix,
...
{
  public:
    GenScaleProperty(const Name&    name,
                     MatrixProxyPtr pMatrix,
...
class FloatProxy : public ReferenceCount
{
  public:
    ...
    virtual void  set(float f, bool transient, bool addBarrier = true) = 0;
    virtual bool  getRange(float& min, float& max, int& digits) const
    {
        return false;
    }
    virtual bool getDefault(float& def) const { return false; }
...
class Vector4Proxy : public ReferenceCount
{
  public:
    ...
    virtual void    set(Vector4 v, bool transient, bool addBarrier = true) = 0;
};
...
class Vector3Proxy : public ReferenceCount
{
  public:
    ...
    virtual void    set(Vector3 v, bool transient, bool addBarrier = true) = 0;
};
...
class Vector2Proxy : public ReferenceCount
{
  public:
    ...
    virtual void    set(Vector2 v, bool transient, bool addBarrier = true) = 0;
...
class ColourProxy : public ReferenceCount
{
  public:
    ...
    virtual void set(Moo::Colour v, bool transient, bool addBarrier = true) = 0;
};

typedef SmartPointer<ColourProxy> ColourProxyPtr;

/**
 *	This is a colour property that can come from either a ColourProxy or a
 *Vector4Proxy
 */
...
/**
 *	This class wraps up a colour and a scalar with virtual functions to get and
 *set it. The scalar part can be clamped to whatever range you like.
 *
 *	@see Vector4Proxy
 */
...
{
  public:
    ColourScalarProperty(const Name&          name,
...
class StringProxy : public ReferenceCount
{
  public:
    ...
    virtual void set(BW::string v, bool transient, bool addBarrier = true) = 0;
};
...
{
  public:
    StaticTextProperty(const Name&    name,
                       StringProxyPtr text,
                       bool           isDate = false);
...
{
  public:
    TextLabelProperty(const Name& name,
...
class TextProperty : public GeneralProperty
{
  public:
    ...
    void textureFeed(const BW::wstring& textureFeed)
    {
        textureFeed_ = textureFeed;
    }
...
{
  public:
    ListTextProperty(const Name&                    name,
                     StringProxyPtr                 text,
...
class ResourceProperty : public GeneralProperty
{
  public:
    ...
    ResourceProperty(const Name&       name,
...
class BoolProxy : public ReferenceCount
{
  public:
    ...
    virtual void set(bool v, bool transient, bool addBarrier = true) = 0;
};
...
class IntProxy : public ReferenceCount
{
  public:
    ...
    virtual void set(Data v, bool transient, bool addBarrier = true) = 0;
    virtual bool getRange(Data& min, Data& max) const { return false; }
};
...
{
  public:
    ChoiceProperty(const Name&    name,
                   IntProxyPtr    pInt,
    ...
    {
        return pInt_ ? pInt_->set(int(v), transient, addBarrier)
                     : pUInt_->set(v, transient, addBarrier);
    }
...
class PythonProxy : public ReferenceCount
{
  public:
    ...
    virtual void              set(PythonProxy::Data value,
                                  bool              transient,
 ...
 */
template <class DT>
class DataProxyOperation : public UndoRedo::Operation
{
  public:
  ...
  private:
    ...
    virtual bool iseq(const UndoRedo::Operation& oth) const
    {
        return pProxy_.getObject() ==
               static_cast<const DataProxyOperation<DT>&>(oth)
                 .pProxy_.getObject();
    }
 ...
 */
template <class DT>
class UndoableDataProxy : public DT
{
  public:
  ...
  private:
    virtual void set(typename DT::Data f,
                     bool              transient,
                     bool              addBarrier = true)
    {
        ...
        if (transient) {
            UndoRedo::instance().add(
              new DataProxyOperation<UndoableDataProxy<DT>>(this, oVal));
            this->setTransient(f);
            return;
        }
...
class GetterSetterProxy : public UndoableDataProxy<DT>
{
  public:
    ...
    virtual typename DT::Data get() const { return ((*pItem_).*getFn_)(); }

    virtual void setTransient(typename DT::Data v) { ((*pItem_).*setFn_)(v); }
    ...
    virtual BW::string opName() { return "Set " + propDesc_; }
 ...
 */
template <class DT>
class ConstantDataProxy : public DT
{
  public:
    typedef typename DT::Data DT_Data;
    ConstantDataProxy(const DT_Data& val)
      : val_(val)
    {
    }

    virtual DT_Data get() const { return val_; }
    virtual void    set(DT_Data v, bool transient, bool addBarrier = true) {}
