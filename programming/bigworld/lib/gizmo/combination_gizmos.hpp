...
{
  public:
    VectorGizmo(int            disablerModifiers = MODIFIER_ALT,
                MatrixProxyPtr matrix            = NULL,
                Moo::Colour    arrowColor        = 0xFFFFFF00,
...
{
  public:
    BoxGizmo(MatrixProxyPtr matrix1,
...
{
  public:
    LineGizmo(MatrixProxyPtr matrix1,
              MatrixProxyPtr matrix2,
...
{
  public:
    CylinderGizmo(MatrixProxyPtr matrix1,
                  MatrixProxyPtr matrix2,
