...
{
  public:
    PropertyCollator(PROPERTY& prop)
      : prop_(prop)
    {
    }
    ...
    virtual void expel()
    {
        ...
        properties_.erase(
          std::find(properties_.begin(), properties_.end(), &prop_));
    }

    virtual void select() {}

    static BW::vector<PROPERTY*> properties() { return properties_; }
...
{
  public:
    CurrentPositionProperties(GenPositionProperty& prop)
      : PropertyCollator<GenPositionProperty>(prop)
    {
    }
 ...
 */
class CurrentRotationProperties
  : public PropertyCollator<GenRotationProperty> //: public
                                                 //: GeneralProperty::View
{
  public:
    CurrentRotationProperties(GenRotationProperty& prop)
      : PropertyCollator<GenRotationProperty>(prop)
    {
    }
...
{
  public:
    CurrentScaleProperties(GenScaleProperty& prop)
      : PropertyCollator<GenScaleProperty>(prop)
    {
    }
