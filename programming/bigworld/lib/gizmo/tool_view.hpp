...
#define VIEW_FACTORY_DECLARE(CONSTRUCT)                                        \
    ...
    virtual ViewFactory& factory()                                             \
    {                                                                          \
        return s_factory;                                                      \
    }                                                                          \
    static ToolView* s_create()                                                \
    {                                                                          \
...
{
    Py_Header(ToolView, PyObjectPlus) public
...
{
    Py_Header(MeshToolView, ToolView) public
      : MeshToolView(const BW::string& resourceID_ =
                       "res/objects/models/billboard.static.visual",
...
{
    Py_Header(ModelToolView, ToolView) public
      : ModelToolView(
          const BW::string& resourceID_ = "resources/models/omni_light.model",
          PyTypeObject*     pType       = &s_type_);
    ~ModelToolView();
...
{
    Py_Header(FloatVisualiser, ToolView) public
      : FloatVisualiser(
...
{
    Py_Header(Vector2Visualiser, ToolView) public
      : Vector2Visualiser(
          MatrixProxyPtr         pCenter,
