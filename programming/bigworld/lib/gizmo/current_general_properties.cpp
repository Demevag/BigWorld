...
BW::vector<GenPositionProperty*>
  PropertyCollator<GenPositionProperty>::properties_;
CurrentPositionProperties::ViewEnroller
  CurrentPositionProperties::s_viewEnroller;
...
BW::vector<GenRotationProperty*>
  PropertyCollator<GenRotationProperty>::properties_;
CurrentRotationProperties::ViewEnroller
  CurrentRotationProperties::s_viewEnroller;
