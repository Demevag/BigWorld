...
class Font : public ReferenceCount
{
  public:
    ...
    virtual float drawIntoMesh(VectorNoDestructor<Moo::VertexXYZDUV2>& mesh,
    ...
    // specified
    virtual void drawIntoMesh(VectorNoDestructor<Moo::VertexXYZDUV2>& mesh,
                              const BW::wstring&                      str,
                              float                                   clipX,
                              float                                   clipY,
                              float                                   w,
    ...
    void drawConsoleString(const BW::string& str,
                           int               col,
                           int               row,
                           int               x = 0,
                           int               y = 0);
    // draws immediately to the screen at the griven character block
    void drawWConsoleString(const BW::wstring& str,
                            int                col,
                            int                row,
                            int                x = 0,
                            int                y = 0);
  ...
  protected:
    Font(FontMetrics& fm);
    virtual float makeCharacter(Moo::VertexXYZDUV2* vert,
                                wchar_t             c,
                                const Vector2&      pos);
