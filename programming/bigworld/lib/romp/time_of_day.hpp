...
class TimeOfDay
{
  public:
    ...
    static float             gameTimeFromString(const BW::string& newTime,
                                                float             defaultTime);
    ...
    const LinearAnimation<Vector3>& sunAnimation() const
    {
        return sunAnimation_;
    }
    const LinearAnimation<Vector3>& ambientAnimation() const
    {
        return ambientAnimation_;
    }
    const LinearAnimation<Vector3>& fogAnimation() const
    {
        return fogAnimation_;
    }
