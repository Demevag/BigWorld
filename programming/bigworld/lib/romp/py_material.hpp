...
{
    Py_Header(PyMaterial, PyObjectPlus) public
      : PyMaterial(Moo::EffectMaterialPtr pMaterial,
    ...
    PY_FACTORY_DECLARE()
  private:
    bool                   findPropertyAndDesc(const char*             name,
                                               Moo::EffectPropertyPtr& prop,
                                               D3DXHANDLE&             handle,
                                               D3DXPARAMETER_DESC&     desc);
    Moo::EffectMaterialPtr pMaterial_;

    typedef BW::map<Moo::EffectPropertyPtr, Vector4ProviderPtr>
                                                               Vector4Providers;
