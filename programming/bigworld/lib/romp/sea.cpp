...
void Sea::load(DataSectionPtr pSect)
{
    ...
    this->surfaceTopColour(Colour::getUint32(pSect->readVector4(
      "surfaceTopColour", Colour::getVector4(surfaceTopColour_))));

    this->surfaceBotColour(Colour::getUint32(pSect->readVector4(
      "surfaceBotColour", Colour::getVector4(surfaceBotColour_))));

    this->underwaterColour(Colour::getUint32(pSect->readVector4(
      "underwaterColour", Colour::getVector4(underwaterColour_))));
...
void Sea::save(DataSectionPtr pSect)
{
    ...
    pSect->writeVector4("surfaceTopColour",
                        Colour::getVector4(surfaceTopColour_));
    pSect->writeVector4("surfaceBotColour",
                        Colour::getVector4(surfaceBotColour_));
    pSect->writeVector4("underwaterColour",
...
void Sea::draw(float dTime, float timeOfDay)
{
    ...
    waveTime_ += dTime;
    if (waveTime_ > wavePeriod_)
        waveTime_ -= wavePeriod_;
}
