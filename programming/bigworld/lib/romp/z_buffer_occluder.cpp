...
void ZBufferOccluder::setDeviceState()
{
    ...
    Moo::rc().setRenderState(D3DRS_COLORWRITEENABLE,
                             s_viewFlareSources ? D3DCOLORWRITEENABLE_RED : 0);
 ...
 */
float ZBufferOccluder::collides(const Vector3&    photonSourcePosition,
...
void ZBufferOccluder::writePixel(const Vector3& source)
{
    ...
    Moo::rc().drawPrimitiveUP(
      D3DPT_POINTLIST, 1, &vert, sizeof(Moo::VertexXYZ));
}
