...
#define IMPLEMENT_FILTER_QUAD(CLASS, LABEL)                                    \
    ...
    class FilterQuadCreators
      : public BW::map<BW::string, FilterQuadCreator>
      , public Singleton<FilterQuadCreators>
    {};

    /**
     *	This class implements a single filter quad factory and static storage of
     *all filter quad factories.
     */
    class FilterQuadFactory
    {
      public:
        static void       registerType(const BW::string& label,
                                       FilterQuadCreator creator = NULL);
