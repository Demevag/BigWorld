...
#define SAFE_GET(handle, pTheEffect, type, name, result)                       \
    ...
    class EffectMaterial : public SafeReferenceCount
    {
      public:
        ...
        bool initFromEffect(const BW::StringRef& effect,
        ...
        bool textureProperty(BW::string&          result,
        ...
        bool setProperty(const BW::StringRef& name,
                         const bool           value,
                         bool                 create);
      ...
      private:
        template <class T>
        bool setPropertyType(const BW::StringRef& name,
                             const T&             value,
                             bool                 create,
                             const BW::StringRef& typeName);

        bool loadInternal(DataSectionPtr          pSection,
                          EffectPropertyMappings& outProperties);

        void loadProperties(EffectPropertyMappings& effectProperties,
                            bool                    addDefault) const;

        void loadPropertyHandles(const EffectPropertyMappings& effectProperties,
