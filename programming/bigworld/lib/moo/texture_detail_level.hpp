...
namespace Moo {
    ...
    /**
     * This class represents the global texture detail filters. Each detail
     * level specifies a string that texture should match to have that detail
     * level. See bigworld\res\system\data\texture_detail_levels.xml for example
     * detail levels.
     */
    class TextureDetailLevel : public SafeReferenceCount
    {
      public:
        ...
        void      formatCompressed(D3DFORMAT formatCompressed)
        {
            formatCompressed_ = formatCompressed;
        }
        ...
        {
            return formatCompressed() != D3DFMT_UNKNOWN;
        }
