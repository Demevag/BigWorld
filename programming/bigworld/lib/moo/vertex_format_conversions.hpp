...
namespace Moo { namespace VertexConversions {
    ...
    void convertPackedNormalUbyte4_8_8_8_to_11_11_10(void*       dst,
                                                     const void* src,
                                                     size_t);
    void convertPackedNormalUbyte4_11_11_10_to_8_8_8(void*       dst,
                                                     const void* src,
                                                     size_t);
    ...
    /// Conversion Functors so we can supply conversion policy at compile time
    /// as template params. This is useful for the declarations in the
    /// implementation. Converts per component. Uses truncation/fill feature of
    /// ElementValue. Passes on component type template params to actual
    /// conversion function
