...
namespace Moo {
      ...
      , public ResourceModificationListener
    {
      public:
        ...
        TextureStreamingManager* streamingManager()
        {
            return streamingManager_.get();
        }
        ...
        BaseTexturePtr get(DataSectionPtr       data,
                           const BW::StringRef& resourceID,
                           bool                 mustExist     = true,
                           bool                 loadIfMissing = true,
                           bool                 refresh       = true,
                           const char* allocator = "texture/unknown texture");
        void           getAnimationSet(const BW::string&     pathWithPrefix,
        ...
        BaseTexturePtr getUnique(const BW::StringRef& resourceID,
                                 ...
                                 bool                 mustExist      = true,
                                 const char* = "texture/unknown texture");
        bool           isTextureFile(const BW::StringRef& resourceID,
                                     bool                 checkExists = true) const;
