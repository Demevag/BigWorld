...
namespace Moo {
      ...
      , public SafeReferenceCount
    {
      public:
        ...
        HRESULT __stdcall SetPixelShaderConstantB(UINT        reg,
                                                  CONST BOOL* pData,
                                                  UINT        count);
        HRESULT __stdcall SetPixelShaderConstantF(UINT         reg,
                                                  CONST FLOAT* pData,
                                                  UINT         count);
        HRESULT __stdcall SetPixelShaderConstantI(UINT       reg,
                                                  CONST INT* pData,
                                                  UINT       count);
        HRESULT __stdcall SetVertexShader(LPDIRECT3DVERTEXSHADER9 pShader);
        HRESULT __stdcall SetVertexShaderConstantB(UINT        reg,
                                                   CONST BOOL* pData,
                                                   UINT        count);
        HRESULT __stdcall SetVertexShaderConstantF(UINT         reg,
                                                   CONST FLOAT* pData,
                                                   UINT         count);
        HRESULT __stdcall SetVertexShaderConstantI(UINT       reg,
                                                   CONST INT* pData,
                                                   UINT       count);
        HRESULT __stdcall SetRenderState(D3DRENDERSTATETYPE state, DWORD value);
        HRESULT __stdcall SetSamplerState(DWORD               sampler,
