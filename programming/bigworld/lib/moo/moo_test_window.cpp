...
namespace {
    ...
    LRESULT CALLBACK testWindowWndProc(HWND   hWnd,
                                       UINT   msg,
                                       WPARAM wParam,
                                       LPARAM lParam)
    {
    ...
    WNDCLASS TEST_WINDOW_CLASS = {
        0,    &testWindowWndProc, 0, 0, NULL, NULL, NULL, NULL,
...
namespace Moo {
    ...
    bool TestWindow::init()
    {
        ...
        HWND newHwnd = CreateWindow(L"Moo::TestWindow",
                                    L"Moo::TestWindow",
                                    WS_OVERLAPPEDWINDOW,
                                    CW_USEDEFAULT,
                                    CW_USEDEFAULT,
        ...
        if (newHwnd == NULL) {
            ...
            if (!Moo::rc().createDevice(
                  newHwnd, 0, 0, true, false, Vector2::ZERO, true, forceRef)) {
