...
#define D3DTABLE_DONE()                                                        \
    ...
    // Filling modes.
    //
    D3DStateTableEntry d3DFillModeTable[] = { D3DTABLE_ENTRY(D3DFILL_POINT),
    ...
    // Shade modes.
    //
    D3DStateTableEntry d3DShadeModeTable[] = { D3DTABLE_ENTRY(D3DSHADE_FLAT),
    ...
    // Cull state.
    //
    D3DStateTableEntry d3dCullTable[] = { D3DTABLE_ENTRY(D3DCULL_NONE),
    ...
    //
    D3DStateTableEntry d3dCmpFuncTable[] = { D3DTABLE_ENTRY(D3DCMP_NEVER),
    ...
    // Fog formula state.
    //
    D3DStateTableEntry d3dFogTable[] = { D3DTABLE_ENTRY(D3DFOG_NONE),
    ...
    D3DStateTableEntry d3dWrapTable[] = {
        D3DTABLE_ENTRY(D3DWRAPCOORD_0), D3DTABLE_ENTRY(D3DWRAPCOORD_1),
        D3DTABLE_ENTRY(D3DWRAPCOORD_2), D3DTABLE_ENTRY(D3DWRAPCOORD_3),
        D3DTABLE_ENTRY(D3DWRAP_U),      D3DTABLE_ENTRY(D3DWRAP_V),
        D3DTABLE_ENTRY(D3DWRAP_W),      D3DTABLE_DONE()
    };
    ...
    //
    D3DStateTableEntry d3dDebugMonitorTable[] = { D3DTABLE_ENTRY(D3DDMT_ENABLE),
                                                  D3DTABLE_ENTRY(
                                                    D3DDMT_DISABLE),
                                                  D3DTABLE_DONE() };
    ...
    // Patch degree table.
    //
    D3DStateTableEntry d3dDegreeTable[] = { D3DTABLE_ENTRY(D3DDEGREE_LINEAR),
    ...
    enum D3DStateType
    {
        ...
        STATE_HEXNUMBER, // The state is a hexadecimal 32-bit number (e.g.
                         // colour)
