...
namespace Moo {
    ...
    /**
     * This class represents a collection of grouped indices. The file format
     * for this is a .primitive file.
     */
    class Primitive
      ...
      ,
         ...
         *Primitive, A needs be registered as a listener of this pPrimitive and
         *A::onReloaderReloaded(..) needs be implemented which re-pulls info out
         *from pPrimitive after pPrimitive is reloaded. A::onReloaderPreReload()
        ...
        public Reloader
    {
      public:
        ...
        virtual HRESULT drawInstancedPrimitiveGroup(uint32 groupIndex,
