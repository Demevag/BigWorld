...
{
    D3DKMT_QUERYSTATISTICS_QUEUE_PACKET_TYPE_INFORMATION
      QueuePacket[D3DKMT_QueuePacketTypeMax];
    D3DKMT_QUERYSTATISTICS_DMA_PACKET_TYPE_INFORMATION
      DmaPacket[D3DKMT_DmaPacketTypeMax];
...
typedef struct _D3DKMT_QUERYSTATISTICS_NODE_INFORMATION
{
    ...
    D3DKMT_QUERYSTATISTICS_PROCESS_NODE_INFORMATION
            SystemInformation; // system thread
    ULONG64 Reserved[8];
...
// typedef __checkReturn NTSTATUS (APIENTRY
// *PFND3DKMT_OPENADAPTERFROMDEVICENAME)(__inout
// D3DKMT_OPENADAPTERFROMDEVICENAME *); typedef __checkReturn NTSTATUS (APIENTRY
// *PFND3DKMT_CLOSEADAPTER)(__in const D3DKMT_CLOSEADAPTER *); typedef
// __checkReturn NTSTATUS (APIENTRY *PFND3DKMT_QUERYSTATISTICS)(__in const
// D3DKMT_QUERYSTATISTICS *);

typedef NTSTATUS(WINAPI* PFND3DKMT_OPENADAPTERFROMDEVICENAME)(
  __inout D3DKMT_OPENADAPTERFROMDEVICENAME*);
typedef NTSTATUS(WINAPI* PFND3DKMT_CLOSEADAPTER)(
  __in const D3DKMT_CLOSEADAPTER*);
typedef NTSTATUS(WINAPI* PFND3DKMT_QUERYSTATISTICS)(
  __in const D3DKMT_QUERYSTATISTICS*);
