...
namespace Moo {
     ...
     */
    EffectMacroSetting::EffectMacroSetting(const BW::string& label,
     ...
     *						option is active.
     */
    void EffectMacroSetting::addOption(const BW::string& label,
                                       const BW::string& desc,
                                       bool              isSupported,
    ...
    {
        BW_GUARD;
        EffectCompiler::setMacroDefinition(this->macro_,
