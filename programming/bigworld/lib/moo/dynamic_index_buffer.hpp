...
namespace Moo {
    ...
    class DynamicIndexBufferBase : public DeviceCallback
    {
      public:
         ...
         */
        uint32 lockIndex() const { return lockIndex_; }
    ...
    /**
     *	Most commonly used 16 bit index buffer. Hardware based (video memory
     *resident)
     */
    class DynamicIndexBuffer16 : public DynamicIndexBufferBase
    {
      public:
        DynamicIndexBuffer16()
          : DynamicIndexBufferBase(D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY,
                                   D3DFMT_INDEX16)
        {
        }
    };
    ...
    /**
     *	Most commonly used 32 bit index buffer. Hardware based (video memory
     *resident)
     */
    class DynamicIndexBuffer32 : public DynamicIndexBufferBase
    {
      public:
        DynamicIndexBuffer32()
          : DynamicIndexBufferBase(D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY,
                                   D3DFMT_INDEX32)
        {
        }
