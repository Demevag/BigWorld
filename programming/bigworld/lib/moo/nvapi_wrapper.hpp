...
namespace Moo {
    ...
    //--	   of any interface function will be valid even if we were failed to
    //initialize.
    //----------------------------------------------------------------------------------------------
    class NvApiWrapper : public DeviceCallback
    {
      ...
      public:
        ...
        //-- Interface for everyone who wants to receive state changes from the
        //nvapi library.
      ...
      public:
        ...
        RECT    get3DSurroundSafeUIRegion() const
        {
            return m_3DSurroundSafeUIRegion;
        }
        DX::BaseTexture* stereoParamsMap()
        {
            return m_stereoParamsTexture.getStereoParamMapTexture();
        }
        ...
        // Used to prevent copying resources from one AFR froup to another on
        // change.
      ...
      private:
        ...
        //-- use built-in nvidia's approach to receive messages about stereo
        //changes.
        bool                    initWindow();
