...
namespace Moo {
    ...
    /**
     *	Classes which implement this interface will receive notification of
     *device loss/destruction through the various delete/create calls. This
     *class should be inherited/implemented by any object utilising D3D
     *resources. For examples of it's use, see the various texture / render
     *target classes.
     */
    ...
    class GenericUnmanagedCallback : public DeviceCallback
    {
      public:
        ...
        GenericUnmanagedCallback(Function* createFunction,
                                 Function* destructFunction);
