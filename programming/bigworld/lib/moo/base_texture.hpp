...
namespace Moo {
    ...
    class BaseTexture : public SafeReferenceCount
    {
      public:
        ...
        /**
         * The failure policy specifies the behaviour when a texture fails to
         * load.
         */
        enum FailurePolicy
        {
            ...
            FAIL_RETURN_NULL = 0,
            /**
             *	Attempt to load the "not found" texture to replace the texture
        ...
        explicit BaseTexture(
          const BW::StringRef& allocator = "texture/unknown base texture");
        ...
        virtual Moo::Colour samplePoint(const Vector2& uv)
        {
