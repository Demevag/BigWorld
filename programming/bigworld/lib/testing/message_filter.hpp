...
namespace Testing {
     ...
     * process just the message payloads.  The actual processing is handled by
     * the methods contained within the FilterFunctionTable that must be passed
     * to the MessageFilter when constructed.
     */
    ...
    /**
     * A table that maps message IDs to a FilterFunction and an
     * InterfaceElement.
     */
    class FilterFunctionTable
    {
