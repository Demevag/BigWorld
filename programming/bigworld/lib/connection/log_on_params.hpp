...
class LogOnParams : public SafeReferenceCount
{
  public:
    ...
    LogOnParams(const BW::string& username,
    ...
    bool operator==(const LogOnParams& other)
    {
        return username_ == other.username_ && password_ == other.password_ &&
               encryptionKey_ == other.encryptionKey_ && nonce_ == other.nonce_;
    }
 ...
 */
inline BinaryOStream& operator<<(BinaryOStream& out, const LogOnParams& params)
{
