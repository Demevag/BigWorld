...
/**
 *  Returns true if this piece of DataDownload is complete and ready to be
 * returned back into onStreamComplete().
 */
...
/**
 *  Write the contents of this DataDownload into a BinaryOStream.  This
 * DataDownload must be complete() before calling this.
 */
