...
namespace BW {
    ...
    float ClientSpace::collide(const Vector3&     start,
                               const Vector3&     end,
    ...
    /**
     *	This method performs a collision test down the Y axis to find the
     *nearest possible location. This is intended primarily for use with
     *dropping navigation onto the ground.
     */
    Vector3 ClientSpace::findDropPoint(const Vector3& position) const
    {
        ...
        // Raise the entity position slightly in case they are right on the
        // ground.
