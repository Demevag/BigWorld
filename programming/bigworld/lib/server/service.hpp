...
class CService
{
  public:
    ...
    DWORD GetControlsAccepted() { return m_dwControlsAccepted; }

    LPCTSTR GetName() { return m_pServiceName; }

    LPCTSTR GetDisplayName() { return m_pServiceDisplayName; }

    BOOL isService() { return m_isService; }

    BOOL isInteractive() { return m_isInteractive; }
...
#define SERVICE_RUNNING 0
    inline DWORD ServiceCheckpoint(DWORD dwWaitHint)
    {
        return 0;
    }
    inline DWORD ServiceUpdateStatus(DWORD dwState,
                                     DWORD dwWaitHint,
                                     DWORD dwError)
    {
        return 0;
