    ...
    for (uint32 i = 0; i < other.addrs_.size(); ++i) {
        ...
        if (findIter != srcHash.end()) {
            if ((i != findIter->second) ||
                ...
                primeChanged) {
                visitor.onChange(
                  otherAddr, i, other.virtualSizeFor(i), other.prime());
            }
            srcHash.erase(findIter);
        } else {
            visitor.onAdd(otherAddr, i, other.virtualSizeFor(i), other.prime());
        }
    }
...
uint32 BackupHash::choosePrime()
{
    static const uint32 primes[] = {
        ...
        0x9e377e55, 0x9e377e53, 0x9e377e43, 0x9e377e41, 0x9e377e37, 0x9e377e11,
        0x9e377e07, 0x9e377de1, 0x9e377db7, 0x9e377da5, 0x9e377d99, 0x9e377d8f,
        0x9e377d8d, 0x9e377d81, 0x9e377d65, 0x9e377d5f, 0x9e377d53, 0x9e377d47,
        0x9e377d21, 0x9e377d03, 0x9e377cff, 0x9e377cd3, 0x9e377c97, 0x9e377c75,
        0x9e377c6d, 0x9e377c3d, 0x9e377c33, 0x9e377c01, 0x9e377bcb, 0x9e377bbb,
        0x9e377b91, 0x9e377b85, 0x9e377b55, 0x9e377b0b, 0x9e377ae9, 0x9e377ae3,
        0x9e377aab, 0x9e377aa7, 0x9e377a9f, 0x9e377a6f, 0x9e377a5d, 0x9e377a45,
        0x9e377a0b, 0x9e3779f3, 0x9e3779ed, 0x9e3779e5, 0x9e3779e1, 0x9e3779db,
        0x9e3779cd, 0x9e3779b1,
    };
...
WatcherPtr BackupHash::pWatcher()
{
    ...
    if (pWatcher == NULL) {
        ...
        Watcher* pAddresses = new SequenceWatcher<Container>(pNull->addrs_);
