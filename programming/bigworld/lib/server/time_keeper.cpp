...
bool TimeKeeper::inputMasterReading(double reading)
{
    ...
    */
    ...
    int64 threshold = int64(nominalIntervalStamps_ / 20 + roundTripStamps / 2);
...
void TimeKeeper::scheduleSyncCheck()
{
    ...
    double deliveryIn =
      double(int64(this->dispatcher().timerDeliveryTime(trackingTimerHandle_) -
                   timestamp()));
 ...
 */
void TimeKeeper::handleException(const Mercury::NubException& exception, void*)
{
