 ...
 *  print "All available fragments for MyService are", services.allFragmentsFor(
 * "MyService" ) print "There are", len( services ), "services."
 *  @}
 */
/**
...
{
    Py_Header(PyServicesMap, PyObjectPlus) public
