...
bool DataSectionFunctor::text(const BW::string& textor,
                              ItemPtr           item,
                              BW::string&       result)
{
    BW_GUARD;
...
bool DataSectionFunctor::update(const BW::string& updater,
                                ItemPtr           item,
                                unsigned int&     result)
{
    BW_GUARD;
...
bool DataSectionFunctor::act(const BW::string& action,
                             ItemPtr           item,
                             bool&             result)
{
    BW_GUARD;
