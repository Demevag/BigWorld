...
class SoundManager : public Singleton<SoundManager>
{
  ...
  public:
    ...
    // if data is empty, register will queue the load in a background thread and
    // then call back with the data
    void registerSoundBank(const BW::string& filename,
                           DataSectionPtr    data,
    ...
    void getSoundGroups(const BW::string&     project,
                        BW::list<BW::string>& soundGroups);
    void getSoundNames(const BW::string&     project,
  ...
  private:
    ...
    bool parsePath(const BW::string&    path,
