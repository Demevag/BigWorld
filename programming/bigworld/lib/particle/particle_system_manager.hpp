...
class ParticleSystemManager
  : public InitSingleton<ParticleSystemManager>
  , public Moo::DeviceCallback
{
  public:
    ...
    // Provide our own fini() method since both our parent classes have their
    // own fini() method, which is ambiguous
     ...
     *
     *	@return	The flag indicating whether all particle systems are active or
     *not.
     */
