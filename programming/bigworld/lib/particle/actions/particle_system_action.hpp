 ...
 *
 *	Each PyParticleSystemAction has a typeID integer attribute to represent its
...
{
    Py_Header(PyParticleSystemAction, PyObjectPlus) public
      : PyParticleSystemAction(ParticleSystemActionPtr pAction,
                               PyTypeObject*           pType = &s_type_);
    virtual ~PyParticleSystemAction(){};

    ParticleSystemActionPtr pAction() { return pA_; }

    static PyParticleSystemActionPtr createPyAction(
