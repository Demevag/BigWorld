 ...
 *	Factory function to create and return a new PyStreamPSA object. StreamPSA is
 *a ParticleSystemAction the converges particles to the velocity of the stream.
