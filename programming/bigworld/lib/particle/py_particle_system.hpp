...
class PyParticleSystem : public PyAttachment
{
    Py_Header(PyParticleSystem, PyAttachment)
      ...
      //@{
      PyParticleSystem(ParticleSystemPtr pSystem,
    ...
    virtual void worldBoundingBox(BoundingBox&  bb,
                                  const Matrix& world,
                                  bool          skinny = false);
    virtual void worldVisibilityBox(BoundingBox&  vbb,
                                    const Matrix& world,
                                    bool          skinny = false);
    ...
    {
        return PyParticleSystemRenderer::createPyRenderer(
          pSystem_->pRenderer());
    }
    ...
    PY_RW_ACCESSOR_ATTRIBUTE_DECLARE(PyParticleSystemRendererPtr,
                                     pRenderer,
                                     renderer)
...
namespace PySTLObjectAid {
    ...
    template <>
    struct Releaser<ParticleSystemAction*>
    {
