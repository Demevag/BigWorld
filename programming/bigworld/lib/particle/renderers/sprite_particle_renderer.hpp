...
class SpriteParticleRenderer : public ParticleSystemRenderer
{
  public:
    ...
    {
        return sizeof(SpriteParticleRenderer);
    }
    ...
    virtual const Vector3& explicitOrientation() const
    {
        return explicitOrientation_;
    }
    virtual void explicitOrientation(const Vector3& newVal)
    {
        explicitOrientation_ = newVal;
    }
  ...
  protected:
    ...
    virtual void setMaterial(Moo::EffectMaterialPtr& material);
    ...
    Vector3
      explicitOrientation_; ///< Explicit orientation of the sprite particles.
...
class PySpriteParticleRenderer : public PyParticleSystemRenderer
{
    ...
    /// @name Constructor(s) and Destructor.
    //@{
    PySpriteParticleRenderer(SpriteParticleRendererPtr pR,
    ...
    void       materialFX(MaterialFX newMaterialFX)
    {
        pR_->materialFX((SpriteParticleRenderer::MaterialFX)newMaterialFX);
    }
