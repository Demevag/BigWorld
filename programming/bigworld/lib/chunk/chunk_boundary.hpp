...
struct ChunkBoundary : public ReferenceCount
{
    ...
    ChunkBoundary(const PlaneEq& plane, Portal* portal);
    ...
    struct Portal
    {
        ...
        void save(DataSectionPtr pSection, GeometryMapping* pOwnMapping) const;
      ...
      public:
        ...
        void resetCollisionState() { this->setCollisionState(NULL, true, 0); }
        ...
        Portal2DRef traverse(const Matrix&        world,
