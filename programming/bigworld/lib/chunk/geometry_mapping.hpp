...
{
  public:
    GeometryMapping(ChunkSpacePtr     pSpace,
                    const Matrix&     m,
    ...
    void boundsToGrid(const BoundingBox& bb,
                      ...
                      int&               maxGridX,
                      int&               maxGridZ) const;
    void gridToBounds(int          minGridX,
                      int          minGridY,
                      int          maxGridX,
                      int          maxGridY,
    ...
    BW::string          outsideChunkIdentifier(int  x,
                                               int  z,
                                               bool checkBounds = true) const;
    static bool         gridFromChunkName(const BW::string& chunkName,
                                          int16&            x,
                                          int16&            z);
