...
namespace ScaleformBW {
     ...
     *
     *	The FlashTextGUIComponent is a GUI component used to display text on the
     *screen. It inherits from SimpleGUIComponent.
     *
    ...
    class FlashTextGUIComponent : public SimpleGUIComponent
    {
        Py_Header(FlashTextGUIComponent, SimpleGUIComponent)
          ...
          public
          : FlashTextGUIComponent(const BW::string& font  = "",
        ...
        // GRectF member has 16 bit alignment requirements, thus need to do an
        // aligned alloc
      ...
      private:
        ...
        void textureName(
          const BW::string&
            name){}; // hide textureName, this is invalid for text components.
