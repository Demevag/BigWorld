...
namespace ScaleformBW {
    ...
    {
        BW_GUARD;
        GFx::IME::GFxIMEManagerWin32* ime =
          new GFx::IME::GFxIMEManagerWin32(Moo::rc().windowHandle());
    ...
    bool IME::handleIMMMessage(HWND   hWnd,
                               UINT   msg,
                               WPARAM wParam,
                               LPARAM lParam)
    {
    ...
    bool IME::handleIMEMessage(HWND   hWnd,
                               UINT   msg,
                               WPARAM wParam,
                               LPARAM lParam)
    {
        ...
        GFx::IMEWin32Event ev(
          GFx::IMEWin32Event::IME_Default, (UPInt)hWnd, msg, wParam, lParam);
