...
#if defined(WIN32)
    std::replace(
      path.begin(), path.end(), UNIX_PATH_SEPARATOR, WINDOWS_PATH_SEPARATOR);
#else  // defined( WIN32 )
    std::replace(
      path.begin(), path.end(), WINDOWS_PATH_SEPARATOR, UNIX_PATH_SEPARATOR);
#endif // defined( WIN32 )
}
...
TEST(ResManagerPath_Chopping)
{
    ...
    CHECK(
      checkStripResult("../../../../bigworld/tools/exporter/resources/test",
                       "../../../../bigworld/tools/exporter/resources/test"));
    ...
    CHECK(
      checkStripResult("D:/wales 1.0.0/res/test", "D:/wales 1.0.0/res/test"));
    ...
    CHECK(checkStripResult(
      ...
      "..\\..\\..\\..\\bigworld\\tools\\exporter\\resources\\test"));
    CHECK(
      checkStripResult("D:\\Bigworld\\fantasydemo\\res\\spaces\\test.visual",
...
{
    CHECK(
      checkExtensionResult("../../../fantasydemo/res/test.visual", "visual"));
    CHECK(checkExtensionResult("../../../fantasydemo/res/test", ""));
    CHECK(
      checkExtensionResult("../../../wales 1.0.0/res/test.visual", "visual"));
    CHECK(checkExtensionResult("../../../wales 1.0.0/res/test", ""));
    CHECK(checkExtensionResult(
      "../../../../bigworld/tools/exporter/resources/test.visual", "visual"));
    CHECK(checkExtensionResult(
      "../../../../bigworld/tools/exporter/resources/test", ""));
    ...
    CHECK(checkExtensionResult(
      "..\\..\\..\\..\\bigworld\\tools\\exporter\\resources\\test", ""));
    CHECK(checkExtensionResult(
      "D:\\Bigworld\\fantasydemo\\res\\spaces\\test.visual", "visual"));
    CHECK(
      checkExtensionResult("D:\\Bigworld\\fantasydemo\\res\\spaces\\test", ""));
...
{
    CHECK(checkCaseResult("../../../fantasydemo/res/test.visual",
                          "../../../fantasydemo/res/test.visual"));

    CHECK(checkCaseResult("../../../fantasydemo/res/test",
                          "../../../fantasydemo/res/test"));

    CHECK(checkCaseResult("../../../wales 1.0.0/res/test.visual",
                          "../../../wales 1.0.0/res/test.visual"));

    CHECK(checkCaseResult("../../../wales 1.0.0/res/test",
                          "../../../wales 1.0.0/res/test"));
    ...
    CHECK(
      checkCaseResult("../../../../bigworld/tools/exporter/resources/test",
                      "../../../../bigworld/tools/exporter/resources/test"));

    CHECK(checkCaseResult("D:/Bigworld/fantasydemo/res/spaces/test.visual",
                          "D:/Bigworld/fantasydemo/res/spaces/test.visual"));

    CHECK(checkCaseResult("D:/Bigworld/fantasydemo/res/spaces/test",
                          "D:/Bigworld/fantasydemo/res/spaces/test"));

    CHECK(checkCaseResult("D:/wales 1.0.0/res/test.visual",
                          "D:/wales 1.0.0/res/test.visual"));

    CHECK(
      checkCaseResult("D:/wales 1.0.0/res/test", "D:/wales 1.0.0/res/test"));

    CHECK(checkCaseResult("..\\..\\..\\fantasydemo\\res\\test.visual",
                          "../../../fantasydemo/res/test.visual"));

    CHECK(checkCaseResult("..\\..\\..\\fantasydemo\\res\\test",
                          "..\\..\\..\\fantasydemo\\res\\test"));

    CHECK(checkCaseResult("..\\..\\..\\wales 1.0.0\\res\\test.visual",
                          "../../../wales 1.0.0/res/test.visual"));

    CHECK(checkCaseResult("..\\..\\..\\wales 1.0.0\\res\\test",
                          "../../../wales 1.0.0/res/test"));
    ...
    CHECK(checkCaseResult("D:\\Bigworld\\fantasydemo\\res\\spaces\\test.visual",
                          "D:/Bigworld/fantasydemo/res/spaces/test.visual"));

    CHECK(checkCaseResult("D:\\Bigworld\\fantasydemo\\res\\spaces\\test",
                          "D:/Bigworld/fantasydemo/res/spaces/test"));

    CHECK(checkCaseResult("D:\\wales 1.0.0\\res\\test.visual",
                          "D:/wales 1.0.0/res/test.visual"));

    CHECK(
      checkCaseResult("D:\\wales 1.0.0\\res\\test", "D:/wales 1.0.0/res/test"));
