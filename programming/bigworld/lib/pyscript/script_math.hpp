...
#define PYAUTO_OPTARGC_PARSE_VALID_ANGLE_ARG(T, R)                             \
    (PYAUTO_OPTARGC_DO, ARG, U, R)
#define PYAUTO_OPTARGC_PARSE_OPTVALID_ANGLE_ARG(T, DEF, R)                     \
    (PYAUTO_OPTARGC_DO, END, U, U)

#define PYAUTO_OPTARGC_PARSE_VALID_ANGLE_VECTOR3_ARG(T, R)                     \
    (PYAUTO_OPTARGC_DO, ARG, U, R)
#define PYAUTO_OPTARGC_PARSE_OPTVALID_ANGLE_VECTOR3_ARG(T, DEF, R)             \
    (PYAUTO_OPTARGC_DO, END, U, U)

/// macros for arg count of all args
#define PYAUTO_ALLARGC_PARSE_VALID_ANGLE_ARG(T, R)                             \
    (PYAUTO_ALLARGC_DO, ARG, U, R)
#define PYAUTO_ALLARGC_PARSE_OPTVALID_ANGLE_ARG(T, DEF, R)                     \
    (PYAUTO_ALLARGC_DO, ARG, U, R)

#define PYAUTO_ALLARGC_PARSE_VALID_ANGLE_VECTOR3_ARG(T, R)                     \
    (PYAUTO_ALLARGC_DO, ARG, U, R)
#define PYAUTO_ALLARGC_PARSE_OPTVALID_ANGLE_VECTOR3_ARG(T, DEF, R)             \
    (PYAUTO_ALLARGC_DO, ARG, U, R)

/// macros for the types of arguments
#define PYAUTO_ARGTYPES_PARSE_VALID_ANGLE_ARG(T, R)                            \
    (PYAUTO_ARGTYPES_DO, ARG, T, R)
#define PYAUTO_ARGTYPES_PARSE_OPTVALID_ANGLE_ARG(T, DEF, R)                    \
    (PYAUTO_ARGTYPES_DO, ARG, T, R)

#define PYAUTO_ARGTYPES_PARSE_VALID_ANGLE_VECTOR3_ARG(T, R)                    \
    (PYAUTO_ARGTYPES_DO, ARG, T, R)
#define PYAUTO_ARGTYPES_PARSE_OPTVALID_ANGLE_VECTOR3_ARG(T, DEF, R)            \
    (PYAUTO_ARGTYPES_DO, ARG, T, R)

/// macros for writing the actual argument parsing code
#define PYAUTO_WRITE_PARSE_VALID_ANGLE_ARG(T, R)                               \
    (PYAUTO_WRITE_DO, VALID_ANGLE_ARG, T, R)
#define PYAUTO_WRITE_PARSE_OPTVALID_ANGLE_ARG(T, DEF, R)                       \
    (PYAUTO_WRITE_DO, OVALID_ANGLE_ARG, (T, DEF), R)

#define PYAUTO_WRITE_PARSE_VALID_ANGLE_VECTOR3_ARG(T, R)                       \
    (PYAUTO_WRITE_DO, VALID_ANGLE_VECTOR3_ARG, T, R)
#define PYAUTO_WRITE_PARSE_OPTVALID_ANGLE_VECTOR3_ARG(T, DEF, R)               \
    (PYAUTO_WRITE_DO, OVALID_ANGLE_VECTOR3_ARG, (T, DEF), R)
...
#define PYAUTO_CALLFN_PARSE_OPTVALID_ANGLE_ARG(T, DEF, R)                      \
    (PYAUTO_CALLFN_DO, ARG, U, R)

#define PYAUTO_CALLFN_PARSE_VALID_ANGLE_VECTOR3_ARG(T, R)                      \
    (PYAUTO_CALLFN_DO, ARG, U, R)
#define PYAUTO_CALLFN_PARSE_OPTVALID_ANGLE_VECTOR3_ARG(T, DEF, R)              \
    (PYAUTO_CALLFN_DO, ARG, U, R)

#define PYAUTO_CALLFN_PARSE1_VALID_ANGLE_ARG(T, R)                             \
    (PYAUTO_CALLFN_DO, ARG1, U, R)
#define PYAUTO_CALLFN_PARSE1_OPTVALID_ANGLE_ARG(T, DEF, R)                     \
    (PYAUTO_CALLFN_DO, ARG1, U, R)

#define PYAUTO_CALLFN_PARSE1_VALID_ANGLE_VECTOR3_ARG(T, R)                     \
    (PYAUTO_CALLFN_DO, ARG1, U, R)
#define PYAUTO_CALLFN_PARSE1_OPTVALID_ANGLE_VECTOR3_ARG(T, DEF, R)             \
    (PYAUTO_CALLFN_DO, ARG1, U, R)
...
class MatrixProvider : public PyObjectPlus
{
    Py_Header(MatrixProvider, PyObjectPlus)
      ...
      public : MatrixProvider(bool autoTick, PyTypeObject* pType);
  ...
  , public Matrix
{
    ...
    PY_AUTO_METHOD_DECLARE(RETVOID,
                           setRotateYPR,
                           VALID_ANGLE_VECTOR3_ARG(Vector3, END))
    ...
    PY_AUTO_METHOD_DECLARE(RETVOID, preMultiply, NZARG(MatrixProviderPtr, END))
    void postMultiply(MatrixProviderPtr mpp)
    {
        Matrix m;
        mpp->matrix(m);
        this->Matrix::postMultiply(m);
    }
    PY_AUTO_METHOD_DECLARE(RETVOID, postMultiply, NZARG(MatrixProviderPtr, END))
    PY_AUTO_METHOD_DECLARE(RETOK, invert, END)
    PY_AUTO_METHOD_DECLARE(RETVOID,
                           lookAt,
                           ARG(Vector3, ARG(Vector3, ARG(Vector3, END))))

    void setElement(int col, int row, float value)
    {
        (*this)[col & 3][row & 3] = value;
    }
    PY_AUTO_METHOD_DECLARE(RETVOID,
                           setElement,
                           ARG(uint, ARG(uint, ARG(float, END))))
 ...
 */
template <class V>
class PyVector : public PyObjectPlus
{
    Py_Header(PyVector<V>, PyObjectPlus)

      public : typedef V Member;
...
class PyVectorCopy : public PyVector<V>
{
  public:
    PyVectorCopy(bool          isReadOnly = false,
      ...
      : PyVector<V>(isReadOnly, pType)
      , v_(V::zero())
    {
    }

    PyVectorCopy(const V&      v,
    ...
    virtual V getVector() const { return v_; }
...
class PyVectorRef : public PyVector<V>
{
  public:
    ...
    virtual V getVector() const { return *pV_; }
...
{
    Py_Header(Vector4Provider, PyObjectPlusWithWeakReference) public
...
{
    Py_Header(Vector4Basic, Vector4Provider) public
      : Vector4Basic(const Vector4& val   = Vector4(0, 0, 0, 0),
