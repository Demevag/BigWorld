...
namespace BW {
    ...
    TEST_F(PyScriptUnitTestHarness, Python_ImportCustomModule)
    {
        ...
        {
            PyObject* res =
              Script::ask(PyObject_GetAttrString(module, "funcDoNothing"),
                          PyTuple_New(0),
                          "Python_ImportCustomModule",
                          false);
            CHECK(res);
            Py_XDECREF(res);
        }
        ...
        {
            PyObject* res =
              Script::ask(PyObject_GetAttrString(module, "funcReturnInt"),
                          PyTuple_New(0),
                          "Python_ImportCustomModule",
                          false);
        ...
        // test function which divides first input parameter by the second one
        // and returns result
        {
            ...
            PyObject* res =
              Script::ask(PyObject_GetAttrString(module, "funcDiv"),
                          args,
                          "Python_ImportCustomModule",
                          false);
            CHECK(PyInt_Check(res));
        ...
        // test function which concatenates two strings and returns result
        {
            ...
            PyObject* res =
              Script::ask(PyObject_GetAttrString(module, "funcSum"),
                          args,
                          "Python_ImportCustomModule",
                          false);
