...
/**
 * 	This class parses the UserDataObjects.xml file, and stores a map of
 * UserDataObject descriptions.  It provides access to udo descriptions by their
 * name.
 * 	@ingroup udo
 */
class UserDataObjectDescriptionMap
{
  public:
    ...
    int                              size() const;
    const UserDataObjectDescription& udoDescription(
      BW::string UserDataObjectName) const;
    void clear();
