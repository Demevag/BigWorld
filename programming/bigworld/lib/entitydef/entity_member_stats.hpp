...
class EntityMemberStats
{
  public:
    ...
    void countReceived(int bytes) { received_.count(bytes); }

    void countOversized(int bytes) { oversized_.count(bytes); }

    static void limitForBaseApp() { s_limitForBaseApp_ = true; }
    ...
    class Stat
    {
      ...
      public:
        ...
        Stat& operator=(const Stat& other) { return *this; }
