                                            ...
                                            bool            forceChange)
{
    ...
    bool changed = forceChange || dataType.hasChanged(rpOldValue, pNewValue);
  ...
  bool*          pIsSlice)
{
    ...
    if (isNested) {
        ...
        return pReader->readSimplePathAndApply(
          stream,
  ...
  ScriptList*    ppChangePath)
{
    ...
    return pReader->readCompressedPathAndApply(
      stream, this, ppOldValue, ppChangePath);
}
