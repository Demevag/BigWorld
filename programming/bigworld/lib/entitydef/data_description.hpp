...
#define DATA_DISTRIBUTION_FLAGS                                                \
    (DATA_GHOSTED | DATA_OTHER_CLIENT | DATA_OWN_CLIENT | DATA_BASE |          \
...
class DataDescription : public MemberDescription
{
  public:
    ...
    bool fromStreamToSection(BinaryIStream& stream,
    ...
    // Errors retain from this method
    bool insertItemInto(const ScriptMapping& map,
                        const ScriptObject&  newItem) const;
