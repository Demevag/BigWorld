...
{
    DataSectionPtr pMethodData1 = getDataSectionForXML("<methods>"
                                                       "<testEqualMethod>"
                                                       "	<Args/>"
                                                       "</testEqualMethod>"
                                                       "</methods>");
    ...
    DataSectionPtr pMethodData2 = getDataSectionForXML("<methods>"
                                                       "<testEqualMethod>"
                                                       "	<Args/>"
                                                       "</testEqualMethod>"
                                                       "</methods>");
    ...
    CHECK(methods.init(
      pMethodData1, MethodDescription::BASE, "iface", "component1"));
    CHECK(methods.init(
      pMethodData2, MethodDescription::BASE, "iface", "component2"));
}

TEST_F(EntityDefUnitTestHarness, MethodDescription_equal_simple)
{
    DataSectionPtr pMethodData1 =
      getDataSectionForXML("<methods>"
                           "<testEqualMethod>"
                           "	<Args>"
...
TEST_F(EntityDefUnitTestHarness, MethodDescription_equal_signature)
{
    DataSectionPtr pMethodData1 = getDataSectionForXML(
      ...
      "		<stupleParam>	ARRAY <of> FLOAT64 </of> <size> 4 </size> "
      "</stupleParam>"
...
TEST_F(EntityDefUnitTestHarness, MethodDescription_not_equal_component)
{
    ...
    CHECK(methods.init(
      pMethodData1, MethodDescription::BASE, "iface", "component1"));
    CHECK(!methods.init(
      pMethodData2, MethodDescription::CELL, "iface", "component2"));
}
...
TEST_F(EntityDefUnitTestHarness, MethodDescription_duplicate_in_component)
{
    ...
    CHECK(methods.init(
      pMethodData1, MethodDescription::BASE, "iface", "component1"));
    CHECK(!methods.init(
      pMethodData2, MethodDescription::BASE, "iface", "component1"));
}
