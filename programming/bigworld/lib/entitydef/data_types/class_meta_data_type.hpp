...
class ClassMetaDataType : public MetaDataType
{
  ...
  public:
    ...
    static typename METADATATYPE::DataType* buildType(
      ...
      METADATATYPE&  metaDataType)
    {
        ...
        for (DataSection::iterator it = pProps->begin(); it != pProps->end();
             ++it) {
        ...
        return new
          typename METADATATYPE::DataType(&metaDataType, fields, allowNone);
    }
};
