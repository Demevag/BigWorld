                              ...
                              unsigned int*     pNumLatestEventMembers)
{
    ...
    if (pVarLenHeaderSection.exists()) {
        ...
        varLenHeaderSize_ =
          pSection->readUInt("VariableLengthHeaderSize",
        ...
        BW::string warnLevelString =
          pVarLenHeaderSection->readString("WarnLevel", "log");
                                               ...
                                               EntityID entityID) const
{
    ...
    if (!Mercury::InterfaceElement::canHandleLength(
        ...
        if (entityID != NULL_ENTITY_ID) {
            bw_snprintf(
              entityBuffer, sizeof(entityBuffer), " for entity %d", entityID);
        }
 ...
 */
void MemberDescription::watcherOversizeWarnLevelFromString(BW::string warnLevel)
{
    if (!isForClient_) {
 ...
 */
bool MemberDescription::oversizeWarnLevelFromString(const BW::string& warnLevel)
{
    if (warnLevel == "none") {
