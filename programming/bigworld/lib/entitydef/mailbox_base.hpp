...
class PyEntityMailBox : public PyObjectPlus
{
    Py_Header(PyEntityMailBox, PyObjectPlus)
      ...
      public : PyEntityMailBox(PyTypeObject* pType = &PyEntityMailBox::s_type_);
    ...
    static void registerMailBoxComponentFactory(EntityMailBoxRef::Component c,
                                                FactoryFn                   fn,
                                                PyTypeObject* pType);
    ...
    PyObject* callMethod(const ScriptString& methodName,
                         const ScriptTuple&  arguments);

    PyObject* callMethod(const MethodDescription* methodDescription,
