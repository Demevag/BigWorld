...
bool SimpleVOIPDataDict::get(unsigned int index,
                             const char** key,
                             const char** value) const
{
    if (index >= dict_.size())
...
void VOIPClient::login(const char*         username,
                       const char*         password,
                       const VOIPDataDict* data)
{
}

void VOIPClient::logout(VOIPDataDict* data) {}

void VOIPClient::createChannel(const char*         channel,
                               const char*         password,
                               const VOIPDataDict* data)
{
}

void VOIPClient::joinChannel(const char*         channelID,
                             const char*         password,
                             const VOIPDataDict* data)
{
}
...
void VOIPClient::inviteUser(const char*         username,
                            const char*         channel,
                            const VOIPDataDict* data)
{
}

void VOIPClient::kickUser(const char*         username,
                          const char*         channel,
                          const VOIPDataDict* data)
{
}
...
void VOIPClient::enableActiveChannel(const char*         channelID,
                                     const VOIPDataDict* data)
{
}

void VOIPClient::disableActiveChannel(const char*         channelID,
                                      const VOIPDataDict* data)
{
}
...
void VOIPClient::setChannelVolume(const char*         channelName,
                                  float               attenuationDB,
                                  const VOIPDataDict* data)
{
}

void VOIPClient::setMicrophoneVolume(float               attenuationDB,
                                     const VOIPDataDict* data)
{
}
