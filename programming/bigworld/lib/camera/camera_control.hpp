...
class CameraControl
{
  public:
    ...
    /// @todo Comment
    static bool isControlledByMouse() { return isControlledByMouse_; }
    /// @todo Comment
    ...
    static void           velocity(const Vector3& value) { velocity_ = value; }

    static float orientationDamper() { return orientationDamper_; }

    static const Vector3& nudge() { return nudge_; }
    static void           nudge(const Vector3& value) { nudge_ = value; }

    static Vector3 axisNudge() { return Vector3(xNudge_, yNudge_, zNudge_); }
