...
{
    BW_GUARD;
    MF_WATCH("Client Settings/Strafe Rate",
             strafeRate_,
             Watcher::WT_READ_WRITE,
             "Base speed for cameras that use keyboard movement (e.g. the free "
             "camera)");
    ...
    MF_WATCH("Client Settings/Camera Mass",
             cameraMass_,
             Watcher::WT_READ_WRITE,
             "Mass of the camera.  Affects momentum of camera movement.");
    MF_WATCH("Client Settings/Orientation Damper",
             orientationDamper_,
             Watcher::WT_READ_WRITE,
             "Akin to inertial tensor of the camera.  Affects camera's angular "
             "momentum.");
}
