...
bool ExportSettings::readSettings(DataSectionPtr pSection)
{
    if (pSection) {
        ...
        keepExistingMaterials_ =
          pSection->readBool("keepExistingMaterials", keepExistingMaterials_);
        snapVertices_ = pSection->readBool("snapVertices", snapVertices_);

        boneCount_ = pSection->readInt("boneCount", boneCount_);
        visualCheckerEnable_ =
          pSection->readBool("visualCheckerEnable", visualCheckerEnable_);
        fixCylindrical_ = pSection->readBool("fixCylindrical", fixCylindrical_);
        useLegacyOrientation_ =
          pSection->readBool("useLegacyOrientation", useLegacyOrientation_);
