...
class ListColumnStates
{
  public:
    ...
    void sortingType(const ItemInfoDB::Type& newVal) { sortingType_ = newVal; }
    ...
    bool renamePreset(DataSectionPtr    pDS,
  ...
  private:
    ...
    DataSectionPtr findPresetSection(DataSectionPtr    pDS,
