...
class PageTerrainImport
  : public CFormView
  , public GUITABS::Content
{
  public:
    IMPLEMENT_BASIC_CONTENT(
      Localise(L"WORLDEDITOR/GUI/PAGE_TERRAIN_IMPORT/SHORT_NAME"),
      Localise(L"WORLDEDITOR/GUI/PAGE_TERRAIN_IMPORT/LONG_NAME"),
      298,
      390,
      NULL)
