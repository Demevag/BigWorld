...
BOOL PageTerrainMesh::OnInitDialog()
{
    ...
    sizeSlider_.setRangeLimit(
      Options::getOptionFloat("terrain/cutRepair/minsizelimit", 1),
      Options::getOptionFloat("terrain/cutRepair/maxsizelimit", 4000));
    sizeSlider_.setRange(
      Options::getOptionFloat("terrain/cutRepair/minsize", 1),
...
afx_msg LRESULT PageTerrainMesh::OnUpdateControls(WPARAM wParam, LPARAM lParam)
{
    ...
    Options::setOptionFloat("terrain/cutRepair/minsize",
                            sizeSlider_.getMinRange());
    Options::setOptionFloat("terrain/cutRepair/maxsize",
