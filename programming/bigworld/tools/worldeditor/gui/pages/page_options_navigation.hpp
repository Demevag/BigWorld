...
class OptionsLocationsTree : public CTreeCtrl
{
  ...
  public:
    ...
    afx_msg void OnTvnEndlabeleditOptionsLocationList(NMHDR*   pNMHDR,
                                                      LRESULT* pResult);
    afx_msg void OnNMDblclkOptionsLocationList(NMHDR* pNMHDR, LRESULT* pResult);
    afx_msg void OnTvnKeydownOptionsLocationList(NMHDR*   pNMHDR,
                                                 LRESULT* pResult);
};

class PageOptionsNavigation
  : public CFormView
  , public GUITABS::Content
{
    IMPLEMENT_BASIC_CONTENT(
      Localise(L"WORLDEDITOR/GUI/PAGE_OPTIONS_NAVIGATION/SHORT_NAME"),
      Localise(L"WORLDEDITOR/GUI/PAGE_OPTIONS_NAVIGATION/LONG_NAME"),
      263,
      442,
      NULL)
  ...
  public:
    ...
    enum
    {
        IDD = IDD_PAGE_OPTIONS_NAVIGATION
    };
