...
class PageTerrainHeight
  : public PageTerrainBase
  , public GUITABS::Content
{
    IMPLEMENT_BASIC_CONTENT(
      Localise(L"WORLDEDITOR/GUI/PAGE_TERRAIN_HEIGHT/SHORT_NAME"),
      Localise(L"WORLDEDITOR/GUI/PAGE_TERRAIN_HEIGHT/LONG_NAME"),
      290,
      280,
      NULL)
