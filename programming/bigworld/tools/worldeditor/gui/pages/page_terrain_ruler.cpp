...
ON_BN_CLICKED(IDC_TERRAIN_RULER_VERTICAL_MODE,
              &PageTerrainRuler::OnBnClickedCheckBoxVerticalMode)
END_MESSAGE_MAP()
...
void PageTerrainRuler::OnBnClickedCheckBoxVerticalMode()
{
    ...
    TerrainRulerToolView* toolView = TerrainRulerToolView::instance();
    if (toolView != NULL)
        toolView->verticalMode(ctlCheckBoxVerticalMode.GetCheck() ==
                               BST_CHECKED);
}
BW_END_NAMESPACE
