...
class PageOptionsEnvironment
  : public CFormView
  , public GUITABS::Content
{
    IMPLEMENT_BASIC_CONTENT(
      Localise(
        L"WORLDEDITOR/GUI/PAGE_OPTIONS_ENVIRONMENT/SHORT_NAME"), // short name
                                                                 // of page
      Localise(
        L"WORLDEDITOR/GUI/PAGE_OPTIONS_ENVIRONMENT/LONG_NAME"), // long name of
                                                                // page
      290,                                                      // default width
      500, // default height
      NULL // icon
  ...
  public:
    enum
    {
        IDD = IDD_PAGE_OPTIONS_ENVIRONMENT
    };
