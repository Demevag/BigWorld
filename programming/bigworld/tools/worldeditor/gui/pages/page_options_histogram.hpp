...
class PageOptionsHistogram
  : public CDialog
  , public GUITABS::Content
{
    IMPLEMENT_BASIC_CONTENT(
      Localise(L"WORLDEDITOR/GUI/PAGE_OPTIONS_HISTOGRAM/SHORT_NAME"),
      Localise(L"WORLDEDITOR/GUI/PAGE_OPTIONS_HISTOGRAM/LONG_NAME"),
      290,
      250,
      NULL)
  ...
  public:
    ...
    enum
    {
        IDD = IDD_PAGE_OPTIONS_HISTOGRAM
    };
  ...
  protected:
    ...
    afx_msg void    OnNMCustomdrawRangeratioslider(NMHDR*   pNMHDR,
                                                   LRESULT* pResult);
...
IMPLEMENT_CDIALOG_CONTENT_FACTORY(PageOptionsHistogram,
                                  PageOptionsHistogram::IDD)
