...
#define DeclareDataSectionProxy(t, T)                                          \
    ...
    {                                                                          \
      public:                                                                  \
        DataSection##T##Proxy(DataSectionPtr    pSect,                         \
                              const BW::string& tag,                           \
...
#define DeclareClampedDataSectionProxy(t, T)                                   \
    DeclareDataSectionProxy(t, T) class ClampedDataSection##T##Proxy           \
      : public DataSection##T##Proxy                                           \
    {                                                                          \
      public:                                                                  \
        ClampedDataSection##T##Proxy(DataSectionPtr    pSect,                  \
                                     const BW::string& tag,                    \
                                     const BW::string& callbackName,           \
                                     t                 defaultVal,             \
                                     t                 minVal,                 \
...
{
  public:
    DataSectionColourProxy(DataSectionPtr    pSect,
                           const BW::string& tag,
    ...
    Moo::Colour get() const
    {
        ...
        return Colour::getUint32FromNormalised(
          pSection_->readVector4(tag_, defaultVal_));
    }
