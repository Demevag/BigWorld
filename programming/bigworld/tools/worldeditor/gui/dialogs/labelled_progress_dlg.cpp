...
{
    // Progress bar in Windows 7 is crappy, have to do this to show a full
...
void LabelledProgressDlg::setStage(const BW::string& stage,
...
void LabelledProgressDlg::OnCancel()
{
    ...
    cancelled_ = true;
    stage_.SetWindowTextW(Localise(
