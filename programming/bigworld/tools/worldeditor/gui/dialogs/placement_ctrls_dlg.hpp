  ...
  , GUI::ActionMaker<PlacementCtrlsDlg, 2>
{
    IMPLEMENT_BASIC_CONTENT(
      Localise(L"WORLDEDITOR/GUI/PLACEMENT_CTRLS_DLG/SHORT_NAME"),
      Localise(L"WORLDEDITOR/GUI/PLACEMENT_CTRLS_DLG/LONG_NAME"),
      290,
      280,
      NULL)
  ...
  protected:
    ...
    {
      public:
        SliderContainer(controls::RangeSliderCtrl*   slider,
