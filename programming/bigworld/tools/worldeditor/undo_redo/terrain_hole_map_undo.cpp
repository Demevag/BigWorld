 ...
 */
TerrainHoleMapUndo::TerrainHoleMapUndo(Terrain::EditorBaseTerrainBlockPtr block,
                                       ChunkPtr                           chunk)
...
/*virtual*/ bool TerrainHoleMapUndo::iseq(const UndoRedo::Operation& oth) const
{
    ...
    const TerrainHoleMapUndo& othTHM =
      static_cast<const TerrainHoleMapUndo&>(oth);
    return block_ == othTHM.block_ && holes_ == othTHM.holes_;
}
BW_END_NAMESPACE
