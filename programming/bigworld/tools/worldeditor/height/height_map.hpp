...
class HeightMap
  ...
  , public Singleton<HeightMap>
{
  public:
    HeightMap();
    ~HeightMap();

    void spaceInformation(BW::string const& spaceName,
                          int32             localToWorldX,
                          int32             localToWorldY,
                          uint16            width,
                          uint16            height,
    ...
    void drawImportedTerrain(float               left,
                             float               top,
                             float               right,
                             float               bottom,
    ...
    void heightRange(Vector2 const& pos1,
                     Vector2 const& pos2,
                     float&         minv,
                     float&         maxv) const;
  ...
  protected:
    void extractSubimage(float               left,
                         float               top,
                         float               right,
                         float               bottom,
                         Moo::Image<uint16>& subImage) const;

    void restoreSubimage(float                     left,
                         float                     top,
                         float                     right,
                         float                     bottom,
                         Moo::Image<uint16> const& subImage);

    void addTerrain(float               left,
                    float               top,
                    float               right,
                    float               bottom,
                    ElevationBlit::Mode mode,
    ...
    bool chunkToHeightMap(int32 gx, int32 gy, bool force);

    bool drawSomeChunks(bool force);

    uint32 recommendHeightMapSize(uint32 x) const;

    bool toTexCoords(float  left,
                     float  top,
                     float  right,
                     float  bottom,
                     int32& texLeft,
                     ...
                     int32* itop    = NULL,
                     int32* iright  = NULL,
                     int32* ibottom = NULL) const;

    void blitAdditive(ImportImage const& image,
                      int32              left,
                      int32              top,
                      int32              right,
                      int32              bottom,
    ...
    void blitSubtractive(ImportImage const& image,
                         int32              left,
                         int32              top,
                         int32              right,
                         int32              bottom,
    ...
    void blitMin(ImportImage const& image,
                 int32              left,
                 int32              top,
                 int32              right,
                 int32              bottom,
    ...
    void blitMax(ImportImage const& image,
                 int32              left,
                 int32              top,
                 int32              right,
                 int32              bottom,
    ...
    void blitReplace(ImportImage const& image,
                     int32              left,
                     int32              top,
                     int32              right,
                     int32              bottom,
