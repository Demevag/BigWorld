  ...
  , pChunk_(pChunk)
{
    ...
    /**
     * BugFix: No longer using STATIC_LOCALISE_STRING() as this string has
     *formatting args. reverted back to original implementation. (13/2/2012 Evan
     *Z)
     */
    lastItemName_ = LocaliseUTF8(
      L"WORLDEDITOR/WORLDEDITOR/PROPERTIES/CHUNK_EDITOR/CHUNK_IDENTIFIER",
      pChunk->identifier());
