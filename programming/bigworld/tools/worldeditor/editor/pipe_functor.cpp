...
PipeFunctor::PipeFunctor(ToolFunctor* f1, ToolFunctor* f2, PyTypeObject* pType)
  :
...
PyObject* PipeFunctor::pyNew(PyObject* args)
{
    ...
    if (!PyArg_ParseTuple(args, "OO", &f1, &f2) || !ToolFunctor::Check(f1) ||
    ...
    return new PipeFunctor(static_cast<ToolFunctor*>(f1),
