 ...
 *	Constructor.
 */
TextureToolView::TextureToolView(const BW::string& resourceID,
                                 PyTypeObject*     pType)
  : ToolView(pType)
 ...
 */
void TextureToolView::viewResource(const BW::string& textureResource)
{
    BW_GUARD;

    DataSectionPtr pSection =
      BWResource::openSection("resources/materials/generic_tool.mfm");
    if (pSection) {
