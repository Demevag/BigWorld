...
class ChunkItemPlacer
{
  ...
  public:
    ...
    static bool hideChunkItems(const BW::vector<ChunkItemPtr>& items,
                               bool                            hide,
                               bool                            keepSelection);
    static bool freezeChunkItems(const BW::vector<ChunkItemPtr>& items,
                                 bool                            freeze,
                                 bool                            keepSelection);
  ...
  private:
    static PyObject* createChunkItem(Chunk*         pChunk,
