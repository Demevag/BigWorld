...
namespace ElevationBlit {
    ...
    size_t importUndoSize(float left, float top, float right, float bottom);

    bool saveUndoForImport(float             left,
                           float             top,
                           float             right,
                           float             bottom,
    ...
    bool import(ImportImage const& elevationImage,
                float              left,
                float              top,
                float              right,
                float              bottom,
    ...
    bool exportTo(ImportImage& image,
                  float        left,
                  float        top,
                  float        right,
                  float        bottom,
