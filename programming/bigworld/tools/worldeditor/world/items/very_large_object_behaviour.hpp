...
{
  public:
    static void updateLocalVars(VeryLargeObject& object,
                                const Matrix&    m,
                                Chunk*           pChunk);

    static BoundingBox calcVLOBoundingBox(const Matrix&      worldTransform,
                                          VeryLargeObject&   object,
                                          const BoundingBox& vloBB);

    static bool edTransform(VeryLargeObject& object,
                            Chunk*           pChunk,
                            BoundingBox&     vloBB,
