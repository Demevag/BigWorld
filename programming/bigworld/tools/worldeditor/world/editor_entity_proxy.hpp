...
class EntityIntProxy : public UndoableDataProxy<IntProxy>
{
  public:
    ...
    EntityIntProxy(BasePropertiesHelper* props,
                   int                   index,
                   int32                 min,
                   int32                 max);
...
class EntityUIntProxy : public UndoableDataProxy<UIntProxy>
{
  public:
    ...
    EntityUIntProxy(BasePropertiesHelper* props,
                    int                   index,
                    uint32                min,
                    uint32                max);
...
{
  public:
    EntityFloatEnumProxy(BasePropertiesHelper* props,
                         int                   index,
...
{
  public:
    EntityVector2EnumProxy(BasePropertiesHelper* props,
                           int                   index,
...
{
  public:
    EntityVector4EnumProxy(BasePropertiesHelper* props,
                           int                   index,
...
{
  public:
    EntityArrayProxy(BasePropertiesHelper* props,
...
{
  public:
    EntityArrayLinkProxy(EntityArrayProxy* arrayProxy,
...
{
  public:
    EntityStringEnumProxy(BasePropertiesHelper*    props,
                          int                      index,
