...
class ProgressBar
{
  public:
    ...
    virtual void startProgress(const BW::string& sMsg,
                               float             steps,
                               bool              escapable) = 0;
  ...
  public:
    static ProgressBar* getCurrentProgressBar()
    {
        return s_currentProgressBar_;
    }
    static void setCurrentProgressBar(ProgressBar* current)
    {
        s_currentProgressBar_ = current;
    }
