...
bool VisualPortal::init(Portal& portal)
{
    ...
    for (; it != portal.positions().end(); ++it) {
        ...
        // TODO check point positions, the Max code multiplies each point by the
        // portal but we are getting the world coords straight off
        pts_.push_back(Vector3(pt.x, pt.y, pt.z) *
