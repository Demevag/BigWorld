...
class ExportSettings
{
  public:
    ...
    void visualTypeIdentifier(const BW::string& s)
    {
        visualTypeIdentifier_ = s;
    }
    const BW::string& visualTypeIdentifier() const
    {
        return visualTypeIdentifier_;
    }
  ...
  private:
    ExportSettings();
    //~ static BOOL CALLBACK dialogProc(HWND hWnd, UINT msg, WPARAM wParam,
    //LPARAM lParam);
