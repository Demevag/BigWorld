...
struct ConverterInfo
{
  public:
    ...
    enum CONVERTER_FLAGS
    {
        ...
        CACHE_DEPENDENCIES =
          1 << 1, // should dependencies be read and written to the cache.
        CACHE_CONVERSION =
          1 << 2, // should conversion be read and written to the cache.
        UPGRADE_CONVERSION =
          1 << 3, // is the conversion an upgrade of the source asset.
