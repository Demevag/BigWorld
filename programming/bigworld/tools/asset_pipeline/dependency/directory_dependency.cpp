...
bool DirectoryDependency::serialiseIn(DataSectionPtr pSection)
{
    ...
    DataSectionPtr directoryPtr =
      pSection->findChild(DirectoryDependency_Locals::DIRECTORY_TAG);
    ...
    DataSectionPtr patternPtr =
      pSection->findChild(DirectoryDependency_Locals::PATTERN_TAG);
    ...
    DataSectionPtr regexPtr =
      pSection->findChild(DirectoryDependency_Locals::REGEX_TAG);
    ...
    DataSectionPtr recursivePtr =
      pSection->findChild(DirectoryDependency_Locals::RECURSIVE_TAG);
...
bool DirectoryDependency::serialiseOut(DataSectionPtr pSection) const
{
    ...
    DataSectionPtr directoryPtr =
      pSection->newSection(DirectoryDependency_Locals::DIRECTORY_TAG);
    ...
    DataSectionPtr patternPtr =
      pSection->newSection(DirectoryDependency_Locals::PATTERN_TAG);
    ...
    DataSectionPtr regexPtr =
      pSection->newSection(DirectoryDependency_Locals::REGEX_TAG);
    ...
    DataSectionPtr recursivePtr =
      pSection->newSection(DirectoryDependency_Locals::RECURSIVE_TAG);
