...
ConverterDependency::ConverterDependency(uint64            converterId,
...
bool ConverterDependency::serialiseIn(DataSectionPtr pSection)
{
    ...
    DataSectionPtr idPtr =
      pSection->findChild(ConverterDependency_Locals::ID_TAG);
    ...
    DataSectionPtr versionPtr =
      pSection->findChild(ConverterDependency_Locals::VERSION_TAG);
...
bool ConverterDependency::serialiseOut(DataSectionPtr pSection) const
{
    ...
    // and save out our id.
    DataSectionPtr idPtr =
      pSection->newSection(ConverterDependency_Locals::ID_TAG);
    ...
    DataSectionPtr versionPtr =
      pSection->newSection(ConverterDependency_Locals::VERSION_TAG);
