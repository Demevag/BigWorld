...
const uint64 TexFormatConverter::s_TypeId =
  Hash64::compute(TexFormatConverter::getTypeName());
#define TO_STRING(X) #X
const char* TexFormatConverter::s_Version =
  "2.7v" TO_STRING(TEXFORMAT_CONVERTER_VERSION);
#undef TO_STRING
                                 ...
                                 BW::vector<BW::string>& outputFiles)
{
    ...
    DataSectionPtr pSection =
      BWResource::instance().rootSection()->openSection(sourcefile);
    if (pSection == NULL) {
