...
const uint64 BSPConverter::s_TypeId =
  Hash64::compute(BSPConverter::getTypeName());
...
bool BSPConverter::convertBSPInPrimitives(const BW::string  sourcefile,
...
bool BSPConverter::convertBSPFile(const BW::string  sourcefile,
                                  const BW::string& outputfile)
{
