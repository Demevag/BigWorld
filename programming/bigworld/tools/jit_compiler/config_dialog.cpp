...
ConfigDialog::ConfigDialog(const AssetCompiler& compiler,
...
BW::string ConfigDialog::generateConfigString() const
{
    ...
    text.append(presentPath(ContentAddressableCache::getCachePath()))
      .append("\r\n");
    ...
    // Thread Count
    text.append("Threads: ")
      .append(std::to_string(compiler_.getThreadCount()).c_str())
      .append("\r\n");

    // Force Rebuild
    text.append("Force Rebuild: ")
      .append(presentBoolean(compiler_.getForceRebuild()))
      .append("\r\n");

    // Recursive
    text.append("Recursive: ")
      .append(presentBoolean(compiler_.getRecursive()))
      .append("\r\n");
