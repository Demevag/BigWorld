...
{
  public:
    EditorEffectProperty(const BW::StringRef& name,
                         ID3DXEffect*         pEffect,
    ...
    bool stringAnnotation(const BW::string& annotation,
...
class MaterialProxy : public BaseMaterialProxy
{
  public:
    ...
    void set(DT val)
    {
        ...
        for (BW::vector<SmartPointer<CL>>::iterator it = proxies_.begin();
             it != proxies_.end();
             it++)
            if (*it)
                (*it)->set(val, true);
...
class ProxyHolder
{
  public:
    class InnerProxy : public Parent
    {
      ...
      public:
        InnerProxy(Outer& outer)
          : outer_(outer)
        {
        }

        void set(typename Parent::Data value,
                 bool                  transient,
        ...
        bool commitState(bool revertToRecord = false,
        ...
        bool getRange(typename Parent::Data& min,
                      typename Parent::Data& max) const
        {
            BW_GUARD;
 ...
 *	Material Bool Proxy
 */
class MaterialBoolProxy
  : public EditorEffectProperty
  , public ProxyHolder<MaterialBoolProxy, BoolProxy>
{
  public:
    MaterialBoolProxy(const BW::StringRef& name,
 ...
 *	Material Int Proxy
 */
class MaterialIntProxy
  : public EditorEffectProperty
  , public ProxyHolder<MaterialIntProxy, IntProxy>
{
  public:
    MaterialIntProxy(const BW::StringRef& name,
                     ID3DXEffect*         pEffect   = NULL,
                     D3DXHANDLE           hProperty = NULL);
    bool  apply(ID3DXEffect* pEffect, D3DXHANDLE hProperty);
 ...
 */
class MaterialFloatProxy
  : public EditorEffectProperty
  , public ProxyHolder<MaterialFloatProxy, FloatProxy>
{
  public:
    MaterialFloatProxy(const BW::StringRef& name,
                       ID3DXEffect*         pEffect   = NULL,
                       D3DXHANDLE           hProperty = NULL)
      : EditorEffectProperty(name, pEffect, hProperty)
      , value_(0.f)
 ...
 */
class MaterialVector4Proxy
  : public EditorEffectProperty
  , public ProxyHolder<MaterialVector4Proxy, Vector4Proxy>
{
  public:
    MaterialVector4Proxy(const BW::StringRef& name,
                         ID3DXEffect*         pEffect   = NULL,
                         D3DXHANDLE           hProperty = NULL)
      : EditorEffectProperty(name, pEffect, hProperty)
 ...
 */
class MaterialMatrixProxy
  : public EditorEffectProperty
  , public ProxyHolder<MaterialMatrixProxy, MatrixProxy>
{
  public:
    MaterialMatrixProxy(const BW::StringRef& name,
                        ID3DXEffect*         pEffect   = NULL,
                        D3DXHANDLE           hProperty = NULL)
      : EditorEffectProperty(name, pEffect, hProperty)
    {
 ...
 */
class MaterialColourProxy
  : public EditorEffectProperty
  , public ProxyHolder<MaterialColourProxy, ColourProxy>
{
  public:
    MaterialColourProxy(const BW::StringRef& name,
                        ID3DXEffect*         pEffect   = NULL,
                        D3DXHANDLE           hProperty = NULL)
      : EditorEffectProperty(name, pEffect, hProperty)
      , value_(0.f, 0.f, 0.f, 0.f)
 ...
 */
class MaterialTextureProxy
  : public EditorEffectProperty
  , public ProxyHolder<MaterialTextureProxy, StringProxy>
{
  public:
    MaterialTextureProxy(const BW::StringRef& name,
                         ID3DXEffect*         pEffect   = NULL,
                         D3DXHANDLE           hProperty = NULL)
      : EditorEffectProperty(name, pEffect, hProperty)
    {
    ...
    bool       apply(ID3DXEffect* pEffect, D3DXHANDLE hProperty);
    void       set(BW::string value, bool transient, bool addBarrier = true);
 ...
 */
class MaterialTextureFeedProxy
  : public EditorEffectProperty
  , public ProxyHolder<MaterialTextureFeedProxy, StringProxy>
{
  public:
    MaterialTextureFeedProxy(const BW::StringRef& name,
                             ID3DXEffect*         pEffect   = NULL,
                             D3DXHANDLE           hProperty = NULL)
      : EditorEffectProperty(name, pEffect, hProperty)
    {
