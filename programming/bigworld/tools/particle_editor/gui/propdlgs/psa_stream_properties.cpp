...
void PsaStreamProperties::addPositionGizmo()
{
    ...
    positionMatrixProxy_ = new VectorGeneratorMatrixProxy<PsaStreamProperties>(
      this, &PsaStreamProperties::position, &PsaStreamProperties::position);
    generalsDaughter->addProperty(
      new GenPositionProperty(Name("vector"), positionMatrixProxy_));
