 ...
 */
void AvatarGameLogic::shonk(const BW::int32& opponentID,
 ...
 */
void AvatarGameLogic::handshake(const BW::int32& partnerID)
{
 ...
 */
void AvatarGameLogic::pullUp(const BW::int32& partnerID)
{
 ...
 */
void AvatarGameLogic::pushUp(const BW::int32& partnerID)
{
 ...
 */
void AvatarGameLogic::didGesture(const BW::uint8& actionID)
{
 ...
 */
void AvatarGameLogic::fireWeapon(const BW::int32& shotid, const BW::int8& lock)
{
 ...
 */
void AvatarGameLogic::castSpell(const BW::int32&   targetID,
 ...
 */
void AvatarGameLogic::fragged(const BW::int32& shooterID)
{
 ...
 */
void AvatarGameLogic::eat(const BW::int32& item)
{
 ...
 */
void AvatarGameLogic::salida(const BW::int8& result)
{
 ...
 */
void AvatarGameLogic::chat(const BW::string& msg)
{
 ...
 */
void AvatarGameLogic::onAddNote(const BW::uint32& id)
{
 ...
 */
void AvatarGameLogic::onGetNotes(const BW::SequenceValueType<Note>& noteList)
{
 ...
 */
void AvatarGameLogic::onAddedFriend(const BW::string& friendName,
 ...
 */
void AvatarGameLogic::setFriendStatus(const BW::uint8& index,
 ...
 */
void AvatarGameLogic::onReceiveMessageFromAdmirer(const BW::string& admirerName,
 ...
 */
void AvatarGameLogic::onRcvFriendInfo(const BW::string& friendName,
 ...
 */
void AvatarGameLogic::showMessage(const BW::uint8&  type,
 ...
 */
void AvatarGameLogic::tradeOfferItemNotify(const BW::int32& itemType)
{
 ...
 */
void AvatarGameLogic::tradeOfferItemDeny(const BW::int32& tradeItemLock)
{
 ...
 */
void AvatarGameLogic::tradeAcceptNotify(const BW::uint8& accepted)
{
 ...
 */
void AvatarGameLogic::itemsUnlockNotify(const BW::uint8& success,
                                        const BW::int32& lockHandle)
{
 ...
 */
void AvatarGameLogic::pickUpNotify(const BW::int32& droppedItemID)
{
 ...
 */
void AvatarGameLogic::pickUpResponse(const BW::uint8& success,
 ...
 */
void AvatarGameLogic::loadGenMeth1(const BW::string& strArg)
{
 ...
 */
void AvatarGameLogic::loadGenMeth2(const BW::uint32& intArg,
 ...
 */
void AvatarGameLogic::loadGenMeth3(const float& floatArg1,
 ...
 */
void AvatarGameLogic::entitySummoned(const BW::int32&  entityID,
 ...
 */
void AvatarGameLogic::teleportTo(const BW::string& spaceName,
 ...
 */
void AvatarGameLogic::addInfoMsg(const BW::string& msg)
{
 ...
 */
void AvatarGameLogic::onXmppRegisterWithTransport(const BW::string& transport)
{
 ...
 */
void AvatarGameLogic::onXmppDeregisterWithTransport(const BW::string& transport)
{
 ...
 */
void AvatarGameLogic::onXmppMessage(const BW::string& friendID,
 ...
 */
void AvatarGameLogic::onXmppPresence(const BW::string& friendID,
                                     const BW::string& transport,
 ...
 */
void AvatarGameLogic::onXmppRosterItemAdd(const BW::string& friendID,
                                          const BW::string& transport)
{
 ...
 */
void AvatarGameLogic::onXmppRosterItemDelete(const BW::string& friendID,
                                             const BW::string& transport)
{
 ...
 */
void AvatarGameLogic::onXmppError(const BW::string& message)
{
 ...
 */
void AvatarGameLogic::setNested_avatarModel(
 ...
 *	indices.
 */
void AvatarGameLogic::setSlice_avatarModel(
  const BW::NestedPropertyChange::Path& path,
  int                                   startIndex,
  int                                   endIndex,
  const PackedAvatarModel&              oldValue)
 ...
 */
void AvatarGameLogic::set_cellBounds(
 ...
 *	location of the element is described in the given change path.
 */
void AvatarGameLogic::setNested_cellBounds(
  const BW::NestedPropertyChange::Path& path,
  const BW::SequenceValueType<float>&   oldValue)
{
 ...
 *	indices.
 */
void AvatarGameLogic::setSlice_cellBounds(
  const BW::NestedPropertyChange::Path& path,
  int                                   startIndex,
  int                                   endIndex,
  const BW::SequenceValueType<float>&   oldValue)
