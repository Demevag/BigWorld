...
namespace PortalStateChanger {
    ...
    /**
     *	This class is responsible for repeatedly attempting to change the state
     *of a portal until success.
     */
    class PortalStateChange : public ReferenceCount
    {
      public:
        ...
        bool apply()
        {
            ...
            return pPortalScene->setClosestPortalState(
              point_, isPermissive_, collisionFlags_);
        }
    ...
    /**
     *	This method changes the state of a portal. If it does not succeed
     *initially because the chunk is not yet loaded, it retries periodically
     *until successful.
     */
    ...
    {
        // TODO: Should have a static method to try initially to avoid
        // allocation in the common case of initial success.
    ...
    /**
     *	This method should be called periodically to retry any outstanding
     *portal changes.
     */
    ...
    {
      public:
        virtual void fini() { g_pendingChanges.clear(); }
    };
