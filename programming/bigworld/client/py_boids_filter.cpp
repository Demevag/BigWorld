...
#define GET_SET_CACHED(TYPE, FIELDNAME)                                        \
    /**                                                                        \
     *	This method returns FIELDNAME for this object's managed BoidsFilter,    \
     *if it exists, and its cache of the value if not                                  \
     */                                                                        \
...
const BoidsFilter* PyBoidsFilter::pAttachedFilter() const
{
    ...
    return static_cast<const BoidsFilter*>(this->PyFilter::pAttachedFilter());
}
